...
const us = Oi() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function vn(t, e) {
  let n;
  return e.length === 0 ? n = t : n = t.replace(/\{(\d+)\}/g, (i, s) => {
    const o = s[0], a = e[o];
    let l = i;
    return typeof a == "string" ? l = a : (typeof a == "number" || typeof a == "boolean" || a === void 0 || a === null) && (l = String(a)), l;
  }), us && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function L(t, e, ...n) {
  return vn(typeof t == "number" ? cs(t, e) : e, n);
}
function cs(t, e) {
  const n = ls()?.[t];
  if (typeof n != "string") {
...
const Ye = "en";
let dt = !1, ft = !1, Et = !1, Ui = !1, hn = !1, Ii = !1, mt, xt = Ye, Ln = Ye, ds, ve;
const ye = globalThis;
let te;
typeof ye.vscode < "u" && typeof ye.vscode.process < "u" ? te = ye.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (te = process);
const fs = typeof te?.versions?.electron == "string", hs = fs && te?.type === "renderer";
if (typeof te == "object") {
  dt = te.platform === "win32", ft = te.platform === "darwin", Et = te.platform === "linux", Et && te.env.SNAP && te.env.SNAP_REVISION, te.env.CI || te.env.BUILD_ARTIFACTSTAGINGDIRECTORY || te.env.GITHUB_WORKSPACE, mt = Ye, xt = Ye;
  const t = te.env.VSCODE_NLS_CONFIG;
  if (t)
    try {
      const e = JSON.parse(t);
      mt = e.userLocale, Ln = e.osLocale, xt = e.resolvedLanguage || Ye, ds = e.languagePack?.translationsConfigFile;
    } catch {
    }
  Ui = !0;
} else typeof navigator == "object" && !hs ? (ve = navigator.userAgent, dt = ve.indexOf("Windows") >= 0, ft = ve.indexOf("Macintosh") >= 0, Ii = (ve.indexOf("Macintosh") >= 0 || ve.indexOf("iPad") >= 0 || ve.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Et = ve.indexOf("Linux") >= 0, ve?.indexOf("Mobi") >= 0, hn = !0, xt = Oi() || Ye, mt = navigator.language.toLowerCase(), Ln = mt) : console.error("Unable to resolve platform.");
var nt;
(function(t) {
  t[t.Web = 0] = "Web", t[t.Mac = 1] = "Mac", t[t.Linux = 2] = "Linux", t[t.Windows = 3] = "Windows";
})(nt || (nt = {}));
nt.Web;
ft ? nt.Mac : dt ? nt.Windows : Et && nt.Linux;
const it = dt, _s = ft, gs = Ui, ms = hn, bs = hn && typeof ye.importScripts == "function", ps = bs ? ye.origin : void 0, ge = ve, Se = xt;
var wn;
(function(t) {
  function e() {
    return Se;
...
const Es = typeof ye.postMessage == "function" && !ye.importScripts, xs = (() => {
  if (Es) {
    const t = [];
...
ft || Ii ? ut.Macintosh : dt ? ut.Windows : ut.Linux;
const vs = !!(ge && ge.indexOf("Chrome") >= 0);
ge && ge.indexOf("Firefox") >= 0;
!vs && ge && ge.indexOf("Safari") >= 0;
ge && ge.indexOf("Edg/") >= 0;
...
if (typeof zt < "u" && typeof zt.process < "u") {
...
} else typeof process < "u" && typeof process?.versions?.node == "string" ? Ve = {
  get platform() {
  ...
  get platform() {
    return it ? "win32" : _s ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
function At(t, e, n, i) {
  ...
  for (let c = 0; c <= t.length; ++c) {
    ...
    if (i(u)) {
      if (!(a === c - 1 || l === 1)) if (l === 2) {
        if (s.length < 2 || o !== 2 || s.charCodeAt(s.length - 1) !== Ge || s.charCodeAt(s.length - 2) !== Ge) {
          if (s.length > 2) {
            const g = s.lastIndexOf(n);
            g === -1 ? (s = "", o = 0) : (s = s.slice(0, g), o = s.length - 1 - s.lastIndexOf(n)), a = c, l = 0;
            continue;
          } else if (s.length !== 0) {
            s = "", o = 0, a = c, l = 0;
            continue;
        ...
        e && (s += s.length > 0 ? `${n}..` : "..", o = 2);
      } else
        s.length > 0 ? s += `${n}${t.slice(a + 1, c)}` : s = t.slice(a + 1, c), o = c - a - 1;
      a = c, l = 0;
    } else u === Ge && l !== -1 ? ++l : l = -1;
  }
  return s;
...
function Fi(t, e) {
  Ss(e, "pathObject");
  const n = e.dir || e.root, i = e.base || `${e.name || ""}${Rs(e.ext)}`;
...
const j = {
  resolve(...t) {
    ...
    for (let s = t.length - 1; s >= -1; s--) {
      let o;
      if (s >= 0) {
        if (o = t[s], B(o, `paths[${s}]`), o.length === 0)
          continue;
      } else e.length === 0 ? o = yt() : (o = Wt[`=${e}`] || yt(), (o === void 0 || o.slice(0, 2).toLowerCase() !== e.toLowerCase() && o.charCodeAt(2) === ee) && (o = `${e}\\`));
      const a = o.length;
      let l = 0, u = "", c = !1;
      const g = o.charCodeAt(0);
      if (a === 1)
        T(g) && (l = 1, c = !0);
      else if (T(g))
        if (c = !0, T(o.charCodeAt(1))) {
          let f = 2, x = f;
          for (; f < a && !T(o.charCodeAt(f)); )
            f++;
          if (f < a && f !== x) {
            const F = o.slice(x, f);
            for (x = f; f < a && T(o.charCodeAt(f)); )
              f++;
            if (f < a && f !== x) {
              for (x = f; f < a && !T(o.charCodeAt(f)); )
                f++;
              (f === a || f !== x) && (u = `\\\\${F}\\${o.slice(x, f)}`, l = f);
            }
          }
        } else
          l = 1;
      else Ee(g) && o.charCodeAt(1) === pe && (u = o.slice(0, 2), l = 2, a > 2 && T(o.charCodeAt(2)) && (c = !0, l = 3));
      if (u.length > 0)
        if (e.length > 0) {
      ...
      if (i) {
        if (e.length > 0)
          break;
      } else if (n = `${o.slice(l)}\\${n}`, i = c, c && e.length > 0)
        break;
    }
    return n = At(n, !i, "\\", T), i ? `${e}\\${n}` : `${e}${n}` || ".";
  },
  normalize(t) {
    B(t, "path");
    const e = t.length;
    ...
    if (e === 1)
      return Ht(o) ? "\\" : t;
    if (T(o))
      if (s = !0, T(t.charCodeAt(1))) {
        let l = 2, u = l;
        for (; l < e && !T(t.charCodeAt(l)); )
          l++;
        if (l < e && l !== u) {
          const c = t.slice(u, l);
          for (u = l; l < e && T(t.charCodeAt(l)); )
            l++;
          if (l < e && l !== u) {
            for (u = l; l < e && !T(t.charCodeAt(l)); )
              l++;
            if (l === e)
              return `\\\\${c}\\${t.slice(u)}\\`;
            l !== u && (i = `\\\\${c}\\${t.slice(u, l)}`, n = l);
          }
        }
      } else
        n = 1;
    else Ee(o) && t.charCodeAt(1) === pe && (i = t.slice(0, 2), n = 2, e > 2 && T(t.charCodeAt(2)) && (s = !0, n = 3));
    let a = n < e ? At(t.slice(n), !s, "\\", T) : "";
    if (a.length === 0 && !s && (a = "."), a.length > 0 && T(t.charCodeAt(e - 1)) && (a += "\\"), !s && i === void 0 && t.includes(":")) {
      if (a.length >= 2 && Ee(a.charCodeAt(0)) && a.charCodeAt(1) === pe)
        return `.\\${a}`;
      let l = t.indexOf(":");
      do
        if (l === e - 1 || T(t.charCodeAt(l + 1)))
          return `.\\${a}`;
  ...
  isAbsolute(t) {
    ...
    return T(n) || e > 2 && Ee(n) && t.charCodeAt(1) === pe && T(t.charCodeAt(2));
  },
  join(...t) {
    if (t.length === 0)
      return ".";
    ...
    for (let o = 0; o < t.length; ++o) {
      const a = t[o];
      B(a, "path"), a.length > 0 && (e === void 0 ? e = n = a : e += `\\${a}`);
    }
    if (e === void 0)
      return ".";
    let i = !0, s = 0;
    if (typeof n == "string" && T(n.charCodeAt(0))) {
      ++s;
      const o = n.length;
      o > 1 && T(n.charCodeAt(1)) && (++s, o > 2 && (T(n.charCodeAt(2)) ? ++s : i = !1));
    }
    if (i) {
      for (; s < e.length && T(e.charCodeAt(s)); )
        s++;
      s >= 2 && (e = `\\${e.slice(s)}`);
    }
    return j.normalize(e);
  },
  relative(t, e) {
    if (B(t, "from"), B(e, "to"), t === e)
      return "";
    const n = j.resolve(t), i = j.resolve(e);
    if (n === i || (t = n.toLowerCase(), e = i.toLowerCase(), t === e))
      return "";
    if (n.length !== t.length || i.length !== e.length) {
      const U = n.split("\\"), ae = i.split("\\");
      U[U.length - 1] === "" && U.pop(), ae[ae.length - 1] === "" && ae.pop();
      const be = U.length, Ue = ae.length, le = be < Ue ? be : Ue;
      let J;
      for (J = 0; J < le && U[J].toLowerCase() === ae[J].toLowerCase(); J++)
        ;
      return J === 0 ? i : J === le ? Ue > le ? ae.slice(J).join("\\") : be > le ? "..\\".repeat(be - 1 - J) + ".." : "" : "..\\".repeat(be - J) + ae.slice(J).join("\\");
    }
    let s = 0;
    for (; s < t.length && t.charCodeAt(s) === ee; )
      s++;
    let o = t.length;
    for (; o - 1 > s && t.charCodeAt(o - 1) === ee; )
      o--;
    const a = o - s;
    let l = 0;
    for (; l < e.length && e.charCodeAt(l) === ee; )
      l++;
    let u = e.length;
    for (; u - 1 > l && e.charCodeAt(u - 1) === ee; )
      u--;
    const c = u - l, g = a < c ? a : c;
    let f = -1, x = 0;
    for (; x < g; x++) {
      const U = t.charCodeAt(s + x);
      if (U !== e.charCodeAt(l + x))
        break;
      U === ee && (f = x);
    }
    if (x !== g) {
      ...
      if (c > g) {
        if (e.charCodeAt(l + x) === ee)
          return i.slice(l + x + 1);
        if (x === 2)
          return i.slice(l + x);
      }
      a > g && (t.charCodeAt(s + x) === ee ? f = x : x === 2 && (f = 3)), f === -1 && (f = 0);
    }
    let F = "";
    for (x = s + f + 1; x <= o; ++x)
      (x === o || t.charCodeAt(x) === ee) && (F += F.length === 0 ? ".." : "\\..");
    return l += f, F.length > 0 ? `${F}${i.slice(l, u)}` : (i.charCodeAt(l) === ee && ++l, i.slice(l, u));
  },
  toNamespacedPath(t) {
    ...
    } else if (Ee(e.charCodeAt(0)) && e.charCodeAt(1) === pe && e.charCodeAt(2) === ee)
      return `\\\\?\\${e}`;
    return e;
  },
  dirname(t) {
    ...
    } else Ee(s) && t.charCodeAt(1) === pe && (n = e > 2 && T(t.charCodeAt(2)) ? 3 : 2, i = n);
    let o = -1, a = !0;
    for (let l = e - 1; l >= i; --l)
      if (T(t.charCodeAt(l))) {
        if (!a) {
  ...
  basename(t, e) {
    e !== void 0 && B(e, "suffix"), B(t, "path");
    let n = 0, i = -1, s = !0, o;
    if (t.length >= 2 && Ee(t.charCodeAt(0)) && t.charCodeAt(1) === pe && (n = 2), e !== void 0 && e.length > 0 && e.length <= t.length) {
      if (e === t)
        return "";
      let a = e.length - 1, l = -1;
      for (o = t.length - 1; o >= n; --o) {
        ...
        if (T(u)) {
          ...
          l === -1 && (s = !1, l = o + 1), a >= 0 && (u === e.charCodeAt(a) ? --a === -1 && (i = o) : (a = -1, i = l));
      }
  ...
  extname(t) {
    B(t, "path");
    let e = 0, n = -1, i = 0, s = -1, o = !0, a = 0;
    t.length >= 2 && t.charCodeAt(1) === pe && Ee(t.charCodeAt(0)) && (e = i = 2);
    for (let l = t.length - 1; l >= e; --l) {
      ...
      s === -1 && (o = !1, s = l + 1), u === Ge ? n === -1 ? n = l : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
    return n === -1 || s === -1 || a === 0 || a === 1 && n === s - 1 && n === i + 1 ? "" : t.slice(n, s);
  },
  format: Fi.bind(null, "\\"),
  parse(t) {
    B(t, "path");
    ...
    if (t.length === 0)
      return e;
    const n = t.length;
    let i = 0, s = t.charCodeAt(0);
    if (n === 1)
      return T(s) ? (e.root = e.dir = t, e) : (e.base = e.name = t, e);
    if (T(s)) {
      if (i = 1, T(t.charCodeAt(1))) {
        let f = 2, x = f;
        for (; f < n && !T(t.charCodeAt(f)); )
          f++;
        if (f < n && f !== x) {
          for (x = f; f < n && T(t.charCodeAt(f)); )
            f++;
          if (f < n && f !== x) {
            for (x = f; f < n && !T(t.charCodeAt(f)); )
              f++;
    ...
    } else if (Ee(s) && t.charCodeAt(1) === pe) {
      if (n <= 2)
        return e.root = e.dir = t, e;
      if (i = 2, T(t.charCodeAt(2))) {
        if (n === 3)
          return e.root = e.dir = t, e;
        i = 3;
      }
    ...
    let o = -1, a = i, l = -1, u = !0, c = t.length - 1, g = 0;
    for (; c >= i; --c) {
      if (s = t.charCodeAt(c), T(s)) {
        if (!u) {
          a = c + 1;
          break;
        }
      ...
      l === -1 && (u = !1, l = c + 1), s === Ge ? o === -1 ? o = c : g !== 1 && (g = 1) : o !== -1 && (g = -1);
    }
    return l !== -1 && (o === -1 || g === 0 || g === 1 && o === l - 1 && o === a + 1 ? e.base = e.name = t.slice(a, l) : (e.name = t.slice(a, o), e.base = t.slice(a, l), e.ext = t.slice(o, l))), a > 0 && a !== i ? e.dir = t.slice(0, a - 1) : e.dir = e.root, e;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...t) {
    ...
    for (let i = t.length - 1; i >= 0 && !n; i--) {
      const s = t[i];
      B(s, `paths[${i}]`), s.length !== 0 && (e = `${s}/${e}`, n = s.charCodeAt(0) === $);
    }
    if (!n) {
      const i = ks();
      e = `${i}/${e}`, n = i.charCodeAt(0) === $;
    }
    return e = At(e, !n, "/", Ht), n ? `/${e}` : e.length > 0 ? e : ".";
  },
  normalize(t) {
    if (B(t, "path"), t.length === 0)
      return ".";
    const e = t.charCodeAt(0) === $, n = t.charCodeAt(t.length - 1) === $;
    return t = At(t, !e, "/", Ht), t.length === 0 ? e ? "/" : n ? "./" : "." : (n && (t += "/"), e ? `/${t}` : t);
  },
  isAbsolute(t) {
    return B(t, "path"), t.length > 0 && t.charCodeAt(0) === $;
  },
  join(...t) {
    if (t.length === 0)
      return ".";
    ...
    for (let n = 0; n < t.length; ++n) {
      const i = t[n];
      B(i, "path"), i.length > 0 && e.push(i);
    }
    return e.length === 0 ? "." : D.normalize(e.join("/"));
  },
  relative(t, e) {
    if (B(t, "from"), B(e, "to"), t === e || (t = D.resolve(t), e = D.resolve(e), t === e))
      return "";
    const n = 1, i = t.length, s = i - n, o = 1, a = e.length - o, l = s < a ? s : a;
    let u = -1, c = 0;
    for (; c < l; c++) {
      const f = t.charCodeAt(n + c);
      if (f !== e.charCodeAt(o + c))
        break;
      f === $ && (u = c);
    }
    if (c === l)
      if (a > l) {
        ...
        if (c === 0)
          return e.slice(o + c);
      } else s > l && (t.charCodeAt(n + c) === $ ? u = c : c === 0 && (u = 0));
    let g = "";
    for (c = n + u + 1; c <= i; ++c)
      (c === i || t.charCodeAt(c) === $) && (g += g.length === 0 ? ".." : "/..");
    return `${g}${e.slice(o + u)}`;
  },
  toNamespacedPath(t) {
    return t;
  },
  ...
  extname(t) {
    ...
    for (let a = t.length - 1; a >= 0; --a) {
      ...
      i === -1 && (s = !1, i = a + 1), l === "." ? e === -1 ? e = a : o !== 1 && (o = 1) : e !== -1 && (o = -1);
    }
    return e === -1 || i === -1 || o === 0 || o === 1 && e === i - 1 && e === n + 1 ? "" : t.slice(e, i);
  },
  format: Fi.bind(null, "/"),
  parse(t) {
    B(t, "path");
    ...
    let i;
    n ? (e.root = "/", i = 1) : i = 0;
    let s = -1, o = 0, a = -1, l = !0, u = t.length - 1, c = 0;
    for (; u >= i; --u) {
      const g = t.charCodeAt(u);
      if (g === $) {
        if (!l) {
          o = u + 1;
          break;
      ...
      a === -1 && (l = !1, a = u + 1), g === Ge ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    if (a !== -1) {
      const g = o === 0 && n ? 1 : o;
      s === -1 || c === 0 || c === 1 && s === a - 1 && s === o + 1 ? e.base = e.name = t.slice(g, a) : (e.name = t.slice(g, s), e.base = t.slice(g, a), e.ext = t.slice(s, a));
    }
    return o > 0 ? e.dir = t.slice(0, o - 1) : n && (e.dir = "/"), e;
  },
  sep: "/",
  delimiter: ":",
  win32: null,
...
D.win32 = j.win32 = j;
D.posix = j.posix = D;
const Os = fe ? j.normalize : D.normalize;
fe ? j.isAbsolute : D.isAbsolute;
const Us = fe ? j.join : D.join, Is = fe ? j.resolve : D.resolve, Ds = fe ? j.relative : D.relative, Fs = fe ? j.dirname : D.dirname;
fe ? j.basename : D.basename;
fe ? j.extname : D.extname;
fe ? j.parse : D.parse;
const vt = fe ? j.sep : D.sep, Ms = /^\w[\w\d+.-]*$/, Ps = /^\//, Bs = /^\/\//;
function zs(t, e) {
  if (!t.scheme && e)
    throw new Error(
      `[UriError]: Scheme is missing: {scheme: "", authority: "${t.authority}", path: "${t.path}", query: "${t.query}", fragment: "${t.fragment}"}`
    );
  if (t.scheme && !Ms.test(t.scheme))
...
class H {
  static isUri(e) {
    return e instanceof H ? !0 : !e || typeof e != "object" ? !1 : typeof e.authority == "string" && typeof e.fragment == "string" && typeof e.path == "string" && typeof e.query == "string" && typeof e.scheme == "string" && typeof e.fsPath == "string" && typeof e.with == "function" && typeof e.toString == "function";
  }
  constructor(e, n, i, s, o, a = !1) {
    typeof e == "object" ? (this.scheme = e.scheme || I, this.authority = e.authority || I, this.path = e.path || I, this.query = e.query || I, this.fragment = e.fragment || I) : (this.scheme = Vs(e, a), this.authority = n || I, this.path = Gs(this.scheme, i || I), this.query = s || I, this.fragment = o || I, zs(this, a));
  }
  get fsPath() {
    return Tt(this, !1);
  }
  with(e) {
    if (!e)
      return this;
    let { scheme: n, authority: i, path: s, query: o, fragment: a } = e;
    return n === void 0 ? n = this.scheme : n === null && (n = I), i === void 0 ? i = this.authority : i === null && (i = I), s === void 0 ? s = this.path : s === null && (s = I), o === void 0 ? o = this.query : o === null && (o = I), a === void 0 ? a = this.fragment : a === null && (a = I), n === this.scheme && i === this.authority && s === this.path && o === this.query && a === this.fragment ? this : new We(n, i, s, o, a);
  }
  static parse(e, n = !1) {
    const i = qs.exec(e);
    return i ? new We(
  ...
  static file(e) {
    let n = I;
    if (it && (e = e.replace(/\\/g, ce)), e[0] === ce && e[1] === ce) {
      const i = e.indexOf(ce, 2);
      i === -1 ? (n = e.substring(2), e = ce) : (n = e.substring(2, i), e = e.substring(i) || ce);
    }
    return new We("file", n, e, I, I);
  }
  static from(e, n) {
    return new We(
      e.scheme,
  ...
  static joinPath(e, ...n) {
    ...
    let i;
    return it && e.scheme === "file" ? i = H.file(j.join(Tt(e, !0), ...n)).path : i = D.join(e.path, ...n), e.with({ path: i });
  }
  toString(e = !1) {
    return jt(this, e);
  }
  ...
  static revive(e) {
    if (e) {
      ...
      {
        const n = new We(e);
        return n._formatted = e.external ?? null, n._fsPath = e._sep === Mi ? e.fsPath ?? null : null, n;
      }
    } else return e;
  }
...
class We extends H {
  ...
  toJSON() {
    ...
    return this._fsPath && (e.fsPath = this._fsPath, e._sep = Mi), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
  }
}
const Pi = {
  [m.Colon]: "%3A",
...
function yn(t, e, n) {
  ...
  for (let o = 0; o < t.length; o++) {
    ...
    if (a >= m.a && a <= m.z || a >= m.A && a <= m.Z || a >= m.Digit0 && a <= m.Digit9 || a === m.Dash || a === m.Period || a === m.Underline || a === m.Tilde || e && a === m.Slash || n && a === m.OpenSquareBracket || n && a === m.CloseSquareBracket || n && a === m.Colon)
      s !== -1 && (i += encodeURIComponent(t.substring(s, o)), s = -1), i !== void 0 && (i += t.charAt(o));
    else {
      i === void 0 && (i = t.substr(0, o));
      const l = Pi[a];
      l !== void 0 ? (s !== -1 && (i += encodeURIComponent(t.substring(s, o)), s = -1), i += l) : s === -1 && (s = o);
    }
  }
...
function $s(t) {
  ...
  for (let n = 0; n < t.length; n++) {
    ...
    i === m.Hash || i === m.QuestionMark ? (e === void 0 && (e = t.substr(0, n)), e += Pi[i]) : e !== void 0 && (e += t[n]);
  }
  return e !== void 0 ? e : t;
}
function Tt(t, e) {
  let n;
  return t.authority && t.path.length > 1 && t.scheme === "file" ? n = `//${t.authority}${t.path}` : t.path.charCodeAt(0) === m.Slash && (t.path.charCodeAt(1) >= m.A && t.path.charCodeAt(1) <= m.Z || t.path.charCodeAt(1) >= m.a && t.path.charCodeAt(1) <= m.z) && t.path.charCodeAt(2) === m.Colon ? e ? n = t.path.substr(1) : n = t.path[1].toLowerCase() + t.path.substr(2) : n = t.path, it && (n = n.replace(/\//g, "\\")), n;
}
function jt(t, e) {
  const n = e ? $s : yn;
  let i = "", { scheme: s, authority: o, path: a, query: l, fragment: u } = t;
  if (s && (i += s, i += ":"), (o || s === "file") && (i += ce, i += ce), o) {
    let c = o.indexOf("@");
    if (c !== -1) {
      const g = o.substr(0, c);
      o = o.substr(c + 1), c = g.lastIndexOf(":"), c === -1 ? i += n(g, !1, !1) : (i += n(g.substr(0, c), !1, !1), i += ":", i += n(g.substr(c + 1), !1, !0)), i += "@";
    }
  ...
  return l && (i += "?", i += n(l, !1, !1)), u && (i += "#", i += e ? u : yn(u, !1, !1)), i;
}
function Bi(t) {
  try {
    return decodeURIComponent(t);
  } catch {
    return t.length > 3 ? t.substr(0, 3) + Bi(t.substr(3)) : t;
  }
}
const An = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function bt(t) {
  return t.match(An) ? t.replace(An, (e) => Bi(e)) : t;
}
function Tn(t, e) {
  const n = Kt(t, e);
  return n === -1 ? void 0 : t[n];
}
function Kt(t, e, n = 0, i = t.length) {
  let s = n, o = i;
  for (; s < o; ) {
...
function Nn(t, e, n = 0, i = t.length) {
  let s = n, o = i;
  for (; s < o; ) {
    const a = Math.floor((s + o) / 2);
    e(t[a]) ? o = a : s = a + 1;
...
const zi = new Ws();
function Nt(t) {
  zi.onUnexpectedError(t);
}
function Ae(t) {
  Hs(t) || zi.onUnexpectedError(t);
}
function Yt(t) {
  if (t instanceof Error) {
    const { name: e, message: n, cause: i } = t, s = t.stacktrace || t.stack;
    return {
      $isError: !0,
      name: e,
      message: n,
...
const Xt = "Canceled";
function Hs(t) {
  return t instanceof js ? !0 : t instanceof Error && t.name === Xt && t.message === Xt;
}
...
const Ze = class Ze extends Error {
  static is(e) {
    return e instanceof Ze || e instanceof Error && e.name === Ze._name;
  }
  constructor(e) {
    super(e), this.name = Ze._name;
  }
};
Ze._name = "PendingMigrationError";
let Sn = Ze;
...
function Vi(t, e, n) {
  const i = t.slice(0, e), s = t.slice(e);
  return i.concat(n, s);
}
var Qt;
(function(t) {
...
const Ys = (t, e) => t - e, Je = class Je {
  ...
  filter(e) {
    return new Je((n) => this.iterate((i) => e(i) ? n(i) : !0));
  }
  map(e) {
    return new Je((n) => this.iterate((i) => n(e(i))));
  }
  some(e) {
    let n = !1;
    return this.iterate((i) => (n = e(i), !n)), n;
  }
  findFirst(e) {
    let n;
    return this.iterate((i) => e(i) ? (n = i, !1) : !0), n;
  }
  findLast(e) {
    let n;
  ...
  findLastMaxBy(e) {
    let n, i = !0;
    return this.iterate((s) => ((i || Qt.isGreaterThan(e(s, n))) && (i = !1, n = s), !0)), n;
  }
};
Je.empty = new Je((e) => {
});
...
const Pe = class Pe {
  constructor(e, n) {
    if (this[kn] = "ResourceMap", e instanceof Pe)
      this.map = new Map(e.map), this.toKey = n ?? Pe.defaultToKey;
    else if (Qs(e)) {
      this.map = /* @__PURE__ */ new Map(), this.toKey = n ?? Pe.defaultToKey;
      for (const [i, s] of e)
        this.set(i, s);
    } else
      this.map = /* @__PURE__ */ new Map(), this.toKey = e ?? Pe.defaultToKey;
  }
  set(e, n) {
    return this.map.set(this.toKey(e), new Xs(e, n)), this;
  }
  get(e) {
...
(function(t) {
  ...
  t.length = le;
  function* J(w, A, S = w.length) {
    for (A < -w.length && (A = 0), A < 0 && (A += w.length), S < 0 ? S += w.length : S > w.length && (S = w.length); A < S; A++)
      yield w[A];
  }
  t.slice = J;
  function Mt(w, A = Number.POSITIVE_INFINITY) {
    const S = [];
    if (A === 0)
      return [S, w];
...
const It = class It {
  ...
  add(e) {
    ...
    return this._isDisposed ? It.DISABLE_DISPOSED_WARNING || console.warn(new Error(
...
const Vt = "No TM Grammar registered for this language.";
class sr extends me {
  constructor(e, n, i, s) {
    super(), this._host = e, this._initialState = i.INITIAL, this._scopeRegistry = new ir(), this._injections = {}, this._injectedEmbeddedLanguages = {}, this._languageToScope = /* @__PURE__ */ new Map(), this._grammarRegistry = this._register(new i.Registry({
      onigLib: s,
      loadGrammar: async (o) => {
        const a = this._scopeRegistry.getGrammarDefinition(o);
        if (!a)
          return this._host.logTrace(`No grammar found for scope ${o}`), null;
        const l = a.location;
        try {
          const u = await this._host.readFile(l);
          return i.parseRawGrammar(u, l.path);
        } catch (u) {
          return this._host.logError(`Unable to load and parse grammar for scope ${o} from ${l}`, u), null;
        }
      },
      getInjections: (o) => {
        const a = o.split(".");
        ...
        for (let u = 1; u <= a.length; u++) {
          const c = a.slice(0, u).join(".");
          l = [...l, ...this._injections[c] || []];
        }
        return l;
      }
    }));
    for (const o of n) {
      if (this._scopeRegistry.register(o), o.injectTo) {
        for (const a of o.injectTo) {
          let l = this._injections[a];
          l || (this._injections[a] = l = []), l.push(o.scopeName);
        }
        if (o.embeddedLanguages)
          for (const a of o.injectTo) {
            let l = this._injectedEmbeddedLanguages[a];
            l || (this._injectedEmbeddedLanguages[a] = l = []), l.push(o.embeddedLanguages);
          }
      }
      o.language && this._languageToScope.set(o.language, o.scopeName);
    }
  }
  has(e) {
  ...
  setTheme(e, n) {
    this._grammarRegistry.setTheme(e, n);
  }
  getColorMap() {
    return this._grammarRegistry.getColorMap();
  }
  async createGrammar(e, n) {
    const i = this._languageToScope.get(e);
    if (typeof i != "string")
      throw new Error(Vt);
    const s = this._scopeRegistry.getGrammarDefinition(i);
    if (!s)
      throw new Error(Vt);
    const o = s.embeddedLanguages;
    if (this._injectedEmbeddedLanguages[i]) {
      const u = this._injectedEmbeddedLanguages[i];
      for (const c of u)
        for (const g of Object.keys(c))
          o[g] = c[g];
    }
    const a = Object.keys(o).length > 0;
    let l;
    try {
      l = await this._grammarRegistry.loadGrammarWithConfiguration(i, n, {
        embeddedLanguages: o,
      ...
      throw u.message && u.message.startsWith("No grammar provided for") ? new Error(Vt) : u;
    }
    return {
      languageId: e,
      grammar: l,
      ...
      sourceExtensionId: s.sourceExtensionId
    };
  }
}
const Ce = class Ce {
  constructor(e) {
    this.element = e, this.next = Ce.Undefined, this.prev = Ce.Undefined;
  }
};
Ce.Undefined = new Ce(void 0);
let Un = Ce;
const rr = globalThis.performance.now.bind(globalThis.performance);
class Ft {
  static create(e) {
    return new Ft(e);
  }
  constructor(e) {
    this._now = e === !1 ? Date.now : rr, this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(t) {
  ...
  function n(E) {
    return (h, p = null, b) => {
      ...
      return N = E((k) => {
        if (!y)
          return N ? N.dispose() : y = !0, h.call(p, k);
      }, null, b), y && N.dispose(), N;
    };
  }
  t.once = n;
  function i(E, h) {
    return t.once(t.filter(E, h));
  }
  t.onceIf = i;
  function s(E, h, p) {
    return g((b, y = null, N) => E((k) => b.call(y, h(k)), null, N), p);
  }
  t.map = s;
  function o(E, h, p) {
    return g((b, y = null, N) => E((k) => {
      h(k), b.call(y, k);
    }, null, N), p);
  }
  t.forEach = o;
  function a(E, h, p) {
    return g((b, y = null, N) => E((k) => h(k) && b.call(y, k), null, N), p);
  }
  t.filter = a;
  function l(E) {
    return E;
  ...
  function u(...E) {
    return (h, p = null, b) => {
      const y = nr(...E.map((N) => N((k) => h.call(p, k))));
      return f(y, b);
    };
  }
  t.any = u;
  ...
  function g(E, h) {
    ...
    return h?.add(y), y.event;
  }
  function f(E, h) {
    return h instanceof Array ? h.push(E) : h && h.add(E), E;
  }
  function x(E, h, p = 100, b = !1, y = !1, N, k) {
    let q, Q, Ie, _t = 0, ot;
    const rs = {
      leakWarningThreshold: N,
      onWillAddFirstListener() {
        q = E((os) => {
          _t++, Q = h(Q, os), b && !Ie && (gt.fire(Q), Q = void 0), ot = () => {
            const as = Q;
            Q = void 0, Ie = void 0, (!b || _t > 1) && gt.fire(as), _t = 0;
          }, typeof p == "number" ? (Ie && clearTimeout(Ie), Ie = setTimeout(ot, p)) : Ie === void 0 && (Ie = null, queueMicrotask(ot));
        });
      },
    ...
    return k?.add(gt), gt.event;
  }
  t.debounce = x;
  function F(E, h = 0, p) {
    return t.debounce(E, (b, y) => b ? (b.push(y), b) : [y], h, void 0, !0, void 0, p);
  }
  t.accumulate = F;
  function U(E, h = (b, y) => b === y, p) {
    let b = !0, y;
    return a(E, (N) => {
      const k = b || !h(N, y);
      return b = !1, y = N, k;
  ...
  t.split = ae;
  function be(E, h = !1, p = [], b) {
    let y = p.slice(), N = E((Q) => {
      y ? y.push(Q) : q.fire(Q);
    });
    b && b.add(N);
    const k = () => {
      y?.forEach((Q) => q.fire(Q)), y = null;
    }, q = new oe({
      onWillAddFirstListener() {
        N || (N = E((Q) => q.fire(Q)), b && b.add(N));
      },
  ...
  class J {
    ...
    forEach(h) {
      return this.steps.push((p) => (h(p), p)), this;
    }
    filter(h) {
      return this.steps.push((p) => h(p) ? p : le), this;
    }
    reduce(h, p) {
      let b = p;
      return this.steps.push((y) => (b = h(b, y), b)), this;
    }
    latch(h = (p, b) => p === b) {
      let p = !0, b;
      return this.steps.push((y) => {
        const N = p || !h(y, b);
        return p = !1, b = y, N ? y : le;
      }), this;
    }
    evaluate(h) {
  ...
  function Mt(E, h, p = (b) => b) {
    const b = (...q) => k.fire(p(...q)), y = () => E.on(h, b), N = () => E.removeListener(h, b), k = new oe(
      { onWillAddFirstListener: y, onDidRemoveLastListener: N }
    );
    return k.event;
  }
  t.fromNodeEventEmitter = Mt;
  function Pt(E, h, p = (b) => b) {
    const b = (...q) => k.fire(p(...q)), y = () => E.addEventListener(h, b), N = () => E.removeEventListener(h, b), k = new oe(
      { onWillAddFirstListener: y, onDidRemoveLastListener: N }
    );
    return k.event;
  }
  t.fromDOMEventEmitter = Pt;
  function Bt(E, h) {
    let p;
    const b = new Promise((y, N) => {
      const k = n(E)(y, null, h);
      p = () => k.dispose();
    });
    return b.cancel = p, b;
  }
  ...
  class X {
    constructor(h, p) {
      ...
      this.emitter = new oe(b), p && p.add(this.emitter);
    }
    beginUpdate(h) {
      this._counter++;
    }
  ...
  function $e(E, h) {
    return new X(E, h).emitter.event;
  }
  t.fromObservable = $e;
  function ht(E) {
    return (h, p, b) => {
      ...
      const k = {
        ...
        endUpdate() {
          y--, y === 0 && (E.reportChanges(), N && (N = !1, h.call(p)));
        },
      ...
      E.addObserver(k), E.reportChanges();
      const q = {
        dispose() {
          E.removeObserver(k);
        }
      };
      return b instanceof Ne ? b.add(q) : Array.isArray(b) && b.push(q), q;
    };
  }
  t.fromObservableLight = ht;
})(St || (St = {}));
const et = class et {
  constructor(e) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${e}_${et._idPool++}`, et.all.add(this);
  }
  start(e) {
    this._stopWatch = new Ft(), this.listenerCount = e;
  }
  stop() {
    if (this._stopWatch) {
...
let Ct = et, or = -1;
const Dt = class Dt {
  constructor(e, n, i = (Dt._idPool++).toString(16).padStart(3, "0")) {
...
class Gt {
  constructor(e) {
    this.value = e, this.id = ur++;
  }
}
const cr = 2;
class oe {
  constructor(e) {
    this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new en(
      e?.onListenerError ?? Ae,
      this._options?.leakWarningThreshold ?? or
    ) : void 0, this._perfMon = this._options?._profName ? new Ct(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (e, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new lr(
          `${l}. HINT: Stack shows most frequent listener (${u[1]}-times)`,
          u[0]
        );
        return (this._options?.onListenerError || Ae)(c), me.None;
      }
      if (this._disposed)
        return me.None;
      n && (e = e.bind(n));
      const s = new Gt(e);
      let o;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = _n.create(), o = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof Gt ? (this._deliveryQueue ??= new dr(), this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
      const a = qe(() => {
        o?.(), this._removeListener(s);
      });
      return i instanceof Ne ? i.add(a) : Array.isArray(i) && i.push(a), a;
    }, this._event;
  }
  _removeListener(e) {
    ...
    if (this._size * cr <= n.length) {
      let o = 0;
      for (let a = 0; a < n.length; a++)
        n[a] ? n[o++] = n[a] : s && o < this._deliveryQueue.end && (this._deliveryQueue.end--, o < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = o;
    }
  }
  _deliver(e, n) {
    if (!e)
      return;
    const i = this._options?.onListenerError || Ae;
    if (!i) {
      e.value(n);
      return;
    }
  ...
  fire(e) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Gt)
...
const $i = Object.freeze(function(t, e) {
...
(function(t) {
  function e(n) {
    return n === t.None || n === t.Cancelled || n instanceof fr ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class fr {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? $i : (this._emitter || (this._emitter = new oe()), this._emitter.event);
  }
  dispose() {
...
class _r {
  constructor(e, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = hr) : (this._fn = n, this._computeKey = e.getCacheKey);
  }
  get(e) {
...
function He(t) {
  return t < 0 ? 0 : t > Rt.MAX_UINT_32 ? Rt.MAX_UINT_32 : t | 0;
}
function gr(t) {
  return t.split(/\r\n|\r|\n/);
}
...
function br(t, e, n = 0, i = t.length, s = 0, o = e.length) {
  for (; n < i && s < o; n++, s++) {
    const u = t.charCodeAt(n), c = e.charCodeAt(s);
    if (u < c)
      return -1;
    if (u > c)
      return 1;
...
function Wi(t, e, n = 0, i = t.length, s = 0, o = e.length) {
  for (; n < i && s < o; n++, s++) {
    let u = t.charCodeAt(n), c = e.charCodeAt(s);
    if (u === c)
      continue;
    if (u >= 128 || c >= 128)
      return br(t.toLowerCase(), e.toLowerCase(), n, i, s, o);
    Fn(u) && (u -= 32), Fn(c) && (c -= 32);
    const g = u - c;
    if (g !== 0)
      return g;
...
function pr(t, e) {
  return t.length === e.length && Wi(t, e) === 0;
}
function Er(t, e) {
  const n = e.length;
  return e.length > t.length ? !1 : Wi(t, e, 0, n) === 0;
}
...
const he = class he {
  static getInstance(e) {
    return he.cache.get(Array.from(e));
  }
  static getLocales() {
...
he.ambiguousCharacterData = new Dn(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), he.cache = new _r({ getCacheKey: JSON.stringify }, (e) => {
  ...
  const o = he.ambiguousCharacterData.value;
  let a = e.filter((g) => !g.startsWith("_") && g in o);
  ...
  const u = n(o._common), c = i(u, l);
  return new he(c);
}), he._locales = new Dn(() => Object.keys(he.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")));
let Bn = he;
function Re(t) {
  return t === m.Slash || t === m.Backslash;
}
function ji(t) {
  return t.replace(/[\\/]/g, D.sep);
}
function xr(t) {
  return t.indexOf("/") === -1 && (t = ji(t)), /^[a-zA-Z]:(\/|$)/.test(t) && (t = "/" + t), t;
}
function zn(t, e = D.sep) {
  if (!t)
    return "";
  const n = t.length, i = t.charCodeAt(0);
  if (Re(i)) {
    if (Re(t.charCodeAt(1)) && !Re(t.charCodeAt(2))) {
      let o = 3;
      const a = o;
      for (; o < n && !Re(t.charCodeAt(o)); o++)
        ;
      if (a !== o && !Re(t.charCodeAt(o + 1))) {
        for (o += 1; o < n; o++)
          if (Re(t.charCodeAt(o)))
            return t.slice(0, o + 1).replace(/[\\/]/g, e);
      }
    }
    return e;
  } else if (vr(i) && t.charCodeAt(1) === m.Colon)
    return Re(t.charCodeAt(2)) ? t.slice(0, 2) + e : t.slice(0, 2);
  let s = t.indexOf("://");
  if (s !== -1) {
    for (s += 3; s < n; s++)
      if (Re(t.charCodeAt(s)))
        return t.slice(0, s + 1);
  }
  return "";
}
function Vn(t, e, n, i = vt) {
  if (t === e)
    return !0;
  ...
  if (n) {
    ...
    if (e.length === t.length)
      return !0;
    let o = e.length;
    return e.charAt(e.length - 1) === i && o--, t.charAt(o) === i;
  }
  return e.charAt(e.length - 1) !== i && (e += i), t.indexOf(e) === 0;
}
function vr(t) {
  return t >= m.A && t <= m.Z || t >= m.a && t <= m.z;
}
var Y;
(function(t) {
...
class wr {
  ...
  setServerRootPath(e, n) {
    this._serverRootPath = D.join(n ?? "/", Ar(e));
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return D.join(this._serverRootPath, Y.vscodeRemoteResource);
  }
  set(e, n, i) {
    this._hosts[e] = n, this._ports[e] = i;
  }
  ...
  rewrite(e) {
    ...
    const s = this._ports[n], o = this._connectionTokens[n];
    let a = `path=${encodeURIComponent(e.path)}`;
    return typeof o == "string" && (a += `&${Lr}=${encodeURIComponent(o)}`), H.from({
      scheme: ms ? this._preferredWebSchema : Y.vscodeRemoteResource,
      authority: `${i}:${s}`,
...
const Tr = "vscode-app", tt = class tt {
  constructor() {
    this.staticBrowserUris = new Zt(), this.appResourcePathUrls = /* @__PURE__ */ new Map();
  }
  ...
  toUrl(e) {
    ...
    return typeof n == "function" && (n = n()), new URL(n ?? e, globalThis.location?.href ?? import.meta.url).toString();
  }
  asBrowserUri(e) {
  ...
  uriToBrowserUri(e) {
    return e.scheme === Y.vscodeRemote ? yr.rewrite(e) : e.scheme === Y.file && (gs || ps === `${Y.vscodeFileResource}://${tt.FALLBACK_AUTHORITY}`) ? e.with({
  ...
  uriToFileUri(e) {
    return e.scheme === Y.vscodeFileResource ? e.with({
      scheme: Y.file,
  ...
  toUri(e) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(n))
        return H.joinPath(H.parse(n, !0), e);
      const i = Us(n, e);
      return H.file(i);
    }
    return H.parse(this.toUrl(e));
  }
  registerStaticBrowserUri(e, n) {
    return this.staticBrowserUris.set(e, n), qe(() => {
...
(function(t) {
  ...
  function i(o) {
    let a;
    typeof o == "string" ? a = new URL(o).searchParams : o instanceof URL ? a = o.searchParams : H.isUri(o) && (a = new URL(o.toString(!0)).searchParams);
    const l = a?.get(n);
    if (l)
      return e.get(l);
  }
...
class Nr {
  ...
  compare(e, n, i = !1) {
    return e === n ? 0 : mr(this.getComparisonKey(e, i), this.getComparisonKey(n, i));
  }
  isEqual(e, n, i = !1) {
    return e === n ? !0 : !e || !n ? !1 : this.getComparisonKey(e, i) === this.getComparisonKey(n, i);
  }
  ...
  isEqualOrParent(e, n, i = !1) {
    if (e.scheme === n.scheme) {
      if (e.scheme === Y.file)
        return Vn(xe(e), xe(n), this._ignorePathCasing(e)) && e.query === n.query && (i || e.fragment === n.fragment);
      if (qn(e.authority, n.authority))
        return Vn(e.path, n.path, this._ignorePathCasing(e), "/") && e.query === n.query && (i || e.fragment === n.fragment);
    }
    return !1;
  }
  joinPath(e, ...n) {
    return H.joinPath(e, ...n);
  }
  basenameOrAuthority(e) {
    return Sr(e) || e.authority;
  }
  basename(e) {
  ...
  dirname(e) {
    if (e.path.length === 0)
      return e;
    let n;
    return e.scheme === Y.file ? n = H.file(Fs(xe(e))).path : (n = D.dirname(e.path), e.authority && n.length && n.charCodeAt(0) !== m.Slash && (console.error(`dirname("${e.toString})) resulted in a relative path`), n = "/")), e.with({
      path: n
    });
  }
  normalizePath(e) {
    if (!e.path.length)
      return e;
    let n;
    return e.scheme === Y.file ? n = H.file(Os(xe(e))).path : n = D.normalize(e.path), e.with({
      path: n
    });
  }
  relativePath(e, n) {
    if (e.scheme !== n.scheme || !qn(e.authority, n.authority))
      return;
    if (e.scheme === Y.file) {
      const o = Ds(xe(e), xe(n));
      return it ? ji(o) : o;
    }
    let i = e.path || "/";
    const s = n.path || "/";
    if (this._ignorePathCasing(e)) {
      let o = 0;
      for (const a = Math.min(i.length, s.length); o < a && !(i.charCodeAt(o) !== s.charCodeAt(o) && i.charAt(o).toLowerCase() !== s.charAt(o).toLowerCase()); o++)
        ;
      i = s.substr(0, o) + i.substr(o);
    }
    return D.relative(i, s);
  }
  resolvePath(e, n) {
    if (e.scheme === Y.file) {
      const i = H.file(Is(xe(e), n));
      return e.with({
        authority: i.authority,
        path: i.path
      });
    }
    return n = xr(n), e.with({
      path: D.resolve(e.path, n)
    });
  }
  isAbsolutePath(e) {
  ...
  isEqualAuthority(e, n) {
    return e === n || e !== void 0 && n !== void 0 && pr(e, n);
  }
  hasTrailingPathSeparator(e, n = vt) {
    if (e.scheme === Y.file) {
      const i = xe(e);
      return i.length > zn(i).length && i[i.length - 1] === n;
    } else {
      const i = e.path;
      return i.length > 1 && i.charCodeAt(i.length - 1) === m.Slash && !/^[a-zA-Z]:(\/$|\\$)/.test(e.fsPath);
    }
  }
  removeTrailingPathSeparator(e, n = vt) {
    return $n(e, n) ? e.with({ path: e.path.substr(0, e.path.length - 1) }) : e;
  }
  addTrailingPathSeparator(e, n = vt) {
    let i = !1;
    if (e.scheme === Y.file) {
      const s = xe(e);
      i = s !== void 0 && s.length === zn(s).length && s[s.length - 1] === n;
    } else {
      n = "/";
      const s = e.path;
      i = s.length === 1 && s.charCodeAt(s.length - 1) === m.Slash;
    }
    return !i && !$n(e, n) ? e.with({ path: e.path + "/" }) : e;
  }
}
const R = new Nr(() => !1);
R.isEqual.bind(R);
R.isEqualOrParent.bind(R);
R.getComparisonKey.bind(R);
R.basenameOrAuthority.bind(R);
const Sr = R.basename.bind(R);
R.extname.bind(R);
R.dirname.bind(R);
R.joinPath.bind(R);
R.normalizePath.bind(R);
R.relativePath.bind(R);
R.resolvePath.bind(R);
R.isAbsolutePath.bind(R);
const qn = R.isEqualAuthority.bind(R), $n = R.hasTrailingPathSeparator.bind(R);
R.removeTrailingPathSeparator.bind(R);
R.addTrailingPathSeparator.bind(R);
var Wn;
(function(t) {
  ...
  function e(n) {
    ...
    const o = n.path.substring(0, n.path.indexOf(";"));
    return o && i.set(t.META_DATA_MIME, o), i;
  }
  t.parseMetaData = e;
})(Wn || (Wn = {}));
class Rr {
...
const C = class C {
  ...
  constructor(e, n) {
    this._state = ue.Initial, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new oe(), queueMicrotask(async () => {
      const i = {
  ...
  [Symbol.asyncIterator]() {
    ...
    return {
      next: async () => {
        do {
          if (this._state === ue.DoneError)
            throw this._error;
          if (e < this._results.length)
            return { done: !1, value: this._results[e++] };
          if (this._state === ue.DoneOK)
            return { done: !0, value: void 0 };
          await St.toPromise(this._onStateChanged.event);
        } while (!0);
      },
  ...
  filter(e) {
    return C.filter(this, e);
  }
  static coalesce(e) {
    return C.filter(e, (n) => !!n);
  }
  coalesce() {
    return C.coalesce(this);
  }
  ...
  toPromise() {
    return C.toPromise(this);
  }
  emitOne(e) {
    this._state === ue.Initial && (this._results.push(e), this._onStateChanged.fire());
  }
  emitMany(e) {
    this._state === ue.Initial && (this._results = this._results.concat(e), this._onStateChanged.fire());
  }
  resolve() {
    this._state === ue.Initial && (this._state = ue.DoneOK, this._onStateChanged.fire());
  }
  reject(e) {
    this._state === ue.Initial && (this._state = ue.DoneError, this._error = e, this._onStateChanged.fire());
  }
};
C.EMPTY = C.fromArray([]);
let Kn = C, Fe;
function Ki(t) {
  Fe ? Fe instanceof Yn ? Fe.loggers.push(t) : Fe = new Yn([Fe, t]) : Fe = t;
}
function G() {
  return Fe;
}
...
class Yn {
  ...
  handleObservableCreated(e) {
    for (const n of this.loggers)
      n.handleObservableCreated(e);
  }
  handleOnListenerCountChanged(e, n) {
    for (const i of this.loggers)
      i.handleOnListenerCountChanged(e, n);
  }
  handleObservableUpdated(e, n) {
    for (const i of this.loggers)
      i.handleObservableUpdated(e, n);
  }
  handleAutorunCreated(e) {
    for (const n of this.loggers)
      n.handleAutorunCreated(e);
  }
  handleAutorunDisposed(e) {
    for (const n of this.loggers)
      n.handleAutorunDisposed(e);
  }
  handleAutorunDependencyChanged(e, n, i) {
    for (const s of this.loggers)
      s.handleAutorunDependencyChanged(e, n, i);
  }
  ...
  handleDerivedDependencyChanged(e, n, i) {
    for (const s of this.loggers)
      s.handleDerivedDependencyChanged(e, n, i);
  }
...
class Xn {
  ...
  dispose() {
    if (!this._disposed) {
      ...
      this._dependencies.clear(), this._store !== void 0 && this._store.dispose(), this._delayedStore !== void 0 && this._delayedStore.dispose(), G()?.handleAutorunDisposed(this);
    }
  }
  _run() {
    const e = this._dependenciesToBeRemoved;
    this._dependenciesToBeRemoved = this._dependencies, this._dependencies = e, this._state = W.upToDate;
    try {
      if (!this._disposed) {
        G()?.handleAutorunStarted(this);
        const n = this._changeSummary, i = this._delayedStore;
        i !== void 0 && (this._delayedStore = void 0);
        try {
          ...
          this._isRunning = !1, i !== void 0 && i.dispose();
        }
      }
    } finally {
  ...
  beginUpdate(e) {
    this._state === W.upToDate && (this._state = W.dependenciesMightHaveChanged), this._updateCount++;
  }
  endUpdate(e) {
    try {
      if (this._updateCount === 1)
        do {
          if (this._state === W.dependenciesMightHaveChanged) {
            this._state = W.upToDate;
            for (const n of this._dependencies)
              if (n.reportChanges(), this._state === W.stale)
                break;
          }
          this._state !== W.upToDate && this._run();
        } while (this._state !== W.upToDate);
    } finally {
      this._updateCount--;
    }
    Gi(() => this._updateCount >= 0);
  }
  handlePossibleChange(e) {
    this._state === W.upToDate && this._isDependency(e) && (this._state = W.dependenciesMightHaveChanged);
  }
  handleChange(e, n) {
    if (this._isDependency(e)) {
      G()?.handleAutorunDependencyChanged(this, e, n);
      try {
        (this._changeTracker ? this._changeTracker.handleChange({
          changedObservable: e,
          change: n,
          didChange: (s) => s === e
        }, this._changeSummary) : !0) && (this._state = W.stale);
      } catch (i) {
        Nt(i);
      }
    }
  ...
  debugRerun() {
    this._isRunning ? this._state = W.stale : this._run();
  }
}
const gn = (t, e) => t === e;
class kt {
  constructor(e, n, i) {
    this.owner = e, this.debugNameSource = n, this.referenceFn = i;
  }
  getDebugName(e) {
    return Ur(e, this);
  }
}
const Qn = /* @__PURE__ */ new Map(), sn = /* @__PURE__ */ new WeakMap();
function Ur(t, e) {
  const n = sn.get(t);
  if (n)
    return n;
...
function Ir(t, e) {
  ...
  if (a !== void 0 && (s = mn(a), s !== void 0))
    return i + s;
  if (e.owner !== void 0) {
    const l = Dr(e.owner, t);
    if (l !== void 0)
      return i + l;
  }
}
...
const Zn = /* @__PURE__ */ new Map(), Jn = /* @__PURE__ */ new WeakMap();
function Fr(t) {
  const e = Jn.get(t);
  if (e)
    return e;
...
function mn(t) {
  const e = t.toString(), i = /\/\*\*\s*@description\s*([^*]*)\*\//.exec(e);
...
class zr {
  ...
  map(e, n) {
    const i = n === void 0 ? void 0 : e, s = n === void 0 ? e : n;
    return rn({
      owner: i,
      debugName: () => {
        const o = mn(s);
        if (o !== void 0)
          return o;
        const l = /^\s*\(?\s*([a-zA-Z_$][a-zA-Z_$0-9]*)\s*\)?\s*=>\s*\1(?:\??)\.([a-zA-Z_$][a-zA-Z_$0-9]*)\s*$/.exec(s.toString());
        if (l)
  ...
  recomputeInitiallyAndOnChange(e, n) {
    return e.add(Xi(this, n)), this;
  }
  keepObserved(e) {
    return e.add(Qi(this)), this;
  }
  get debugValue() {
    return this.get();
  }
...
class bn extends zr {
  constructor() {
    super(), this._observers = /* @__PURE__ */ new Set(), G()?.handleObservableCreated(this);
  }
  addObserver(e) {
    const n = this._observers.size;
    this._observers.add(e), n === 0 && this.onFirstObserverAdded(), n !== this._observers.size && G()?.handleOnListenerCountChanged(this, this._observers.size);
  }
  removeObserver(e) {
    const n = this._observers.delete(e);
    n && this._observers.size === 0 && this.onLastObserverRemoved(), n && G()?.handleOnListenerCountChanged(this, this._observers.size);
  }
  ...
  log() {
    const e = !!G();
    return Or(this), e || G()?.handleObservableCreated(this), this;
  }
  debugGetObservers() {
...
class _e extends bn {
  ...
  get() {
    if (this._observers.size === 0) {
      ...
      try {
        ...
        let n;
        this._changeTracker && (n = this._changeTracker.createChangeSummary(void 0), this._changeTracker.beforeUpdate?.(this, n)), e = this._computeFn(this, n);
      } finally {
      ...
      do {
        if (this._state === M.dependenciesMightHaveChanged) {
          for (const e of this._dependencies)
            if (e.reportChanges(), this._state === M.stale)
              break;
        }
        this._state === M.dependenciesMightHaveChanged && (this._state = M.upToDate), this._state !== M.upToDate && this._recompute();
      } while (this._state !== M.upToDate);
      return this._value;
    }
  }
  _recompute() {
    ...
    try {
      ...
      this._isReaderValid = !0, this._changeTracker && (this._isInBeforeUpdate = !0, this._changeTracker.beforeUpdate?.(this, i), this._isInBeforeUpdate = !1, this._changeSummary = this._changeTracker?.createChangeSummary(i));
      const s = this._state !== M.initial, o = this._value;
      this._state = M.upToDate;
      const a = this._delayedStore;
      a !== void 0 && (this._delayedStore = void 0);
      try {
        this._store !== void 0 && (this._store.dispose(), this._store = void 0), this._value = this._computeFn(this, i);
      } finally {
        this._isReaderValid = !1;
        for (const l of this._dependenciesToBeRemoved)
          l.removeObserver(this);
        this._dependenciesToBeRemoved.clear(), a !== void 0 && a.dispose();
      }
      e = this._didReportChange || s && !this._equalityComparator(o, this._value), G()?.handleObservableUpdated(this, {
        oldValue: o,
  ...
  beginUpdate(e) {
    ...
    try {
      ...
      if (this._state === M.upToDate && (this._state = M.dependenciesMightHaveChanged, !n))
        for (const i of this._observers)
  ...
  handlePossibleChange(e) {
    if (this._state === M.upToDate && this._dependencies.has(e) && !this._dependenciesToBeRemoved.has(e)) {
      this._state = M.dependenciesMightHaveChanged;
  ...
  handleChange(e, n) {
    if (this._dependencies.has(e) && !this._dependenciesToBeRemoved.has(e) || this._isInBeforeUpdate) {
      G()?.handleDerivedDependencyChanged(this, e, n);
      let i = !1;
      try {
        i = this._changeTracker ? this._changeTracker.handleChange({
          changedObservable: e,
          change: n,
          didChange: (o) => o === e
      ...
      const s = this._state === M.upToDate;
      if (i && (this._state === M.dependenciesMightHaveChanged || s) && (this._state = M.stale, s))
  ...
  debugRecompute() {
    this._isComputing ? this._state = M.stale : this._recompute();
  }
  setValue(e, n, i) {
    this._value = e;
    ...
    for (const o of s)
      o.handleChange(this, i);
  }
}
function Vr(t, e) {
  return new _e(new kt(t.owner, t.debugName, t.debugReferenceFn), e, void 0, t.onLastObserverRemoved, t.equalsFn ?? gn);
}
Mr(Vr);
function Cn(t) {
  const e = new Error("BugIndicatingErrorRecovery: " + t);
  Ae(e), console.error("recovered from an error that indicates a bug", e);
}
function Zi(t, e) {
  const n = new Ji(t, e);
  try {
...
class Ji {
  constructor(e, n) {
    this._fn = e, this._getDebugName = n, this._updatingObservers = [], G()?.handleBeginTransaction(this);
  }
  getDebugName() {
    return this._getDebugName ? this._getDebugName() : mn(this._fn);
  }
  updateObserver(e, n) {
    if (!this._updatingObservers) {
      Cn("Transaction already finished!"), Zi((i) => {
        i.updateObserver(e, n);
      });
      return;
    }
  ...
  finish() {
    ...
    for (let n = 0; n < e.length; n++) {
      const { observer: i, observable: s } = e[n];
      i.endUpdate(s);
    }
...
function qr(t, e) {
  let n;
  return typeof t == "string" ? n = new kt(void 0, t, void 0) : n = new kt(t, void 0, void 0), new on(n, e, gn);
}
class on extends bn {
  get debugName() {
  ...
  constructor(e, n, i) {
    super(), this._debugNameData = e, this._equalityComparator = i, this._value = n, G()?.handleObservableUpdated(this, { hadValue: !1, newValue: n, change: void 0, didChange: !0, oldValue: void 0 });
  }
  get() {
    return this._value;
  }
  set(e, n, i) {
    ...
    try {
      const o = this._value;
      this._setValue(e), G()?.handleObservableUpdated(this, { oldValue: o, newValue: e, change: i, didChange: !0, hadValue: !0 });
      for (const a of this._observers)
        n.updateObserver(a, this), a.handleChange(this, i);
    } finally {
      s && s.finish();
    }
  }
...
function ei(...t) {
  let e, n, i;
  return t.length === 3 ? [e, n, i] = t : [n, i] = t, new ze(new kt(e, void 0, i), n, i, () => ze.globalTransaction, gn);
}
class ze extends bn {
  constructor(e, n, i, s, o) {
    super(), this._debugNameData = e, this.event = n, this._getValue = i, this._getTransaction = s, this._equalityComparator = o, this._hasValue = !1, this.handleEvent = (a) => {
      const l = this._getValue(a), u = this._value, c = !this._hasValue || !this._equalityComparator(u, l);
      let g = !1;
      c && (this._value = l, this._hasValue && (g = !0, Gr(this._getTransaction(), (f) => {
        G()?.handleObservableUpdated(this, { oldValue: u, newValue: l, change: void 0, didChange: c, hadValue: this._hasValue });
        for (const x of this._observers)
          f.updateObserver(x, this), x.handleChange(this, void 0);
      }, () => {
        const f = this.getDebugName();
        return "Event fired" + (f ? `: ${f}` : "");
      })), this._hasValue = !0), g || G()?.handleObservableUpdated(this, { oldValue: u, newValue: l, change: void 0, didChange: c, hadValue: this._hasValue });
    };
  }
  getDebugName() {
...
(function(t) {
  ...
  function e(n, i) {
    let s = !1;
    ze.globalTransaction === void 0 && (ze.globalTransaction = n, s = !0);
    try {
      i();
    } finally {
      s && (ze.globalTransaction = void 0);
    }
  }
  t.batchEventsGlobally = e;
})(ei || (ei = {}));
function Ci(t) {
  const e = new es(!1, void 0);
  return t.addObserver(e), qe(() => {
    t.removeObserver(e);
  });
}
Br(Ci);
...
let pt;
function Wr(t) {
  pt || (pt = new Hr(), Ki(pt)), pt.addFilteredObj(t);
}
class Hr {
  constructor() {
  ...
  handleObservableCreated(e) {
    if (e instanceof _e) {
      const n = e;
      this.changedObservablesSets.set(n, /* @__PURE__ */ new Set());
    }
  }
  handleOnListenerCountChanged(e, n) {
  }
  handleObservableUpdated(e, n) {
    if (this._isIncluded(e)) {
      ...
      console.log(...this.textToConsoleArgs([
        Ke("observable value changed"),
        ie(e.debugName, { color: "BlueViolet" }),
        ...this.formatInfo(n)
      ]));
    }
  }
  formatChanges(e) {
    if (e.size !== 0)
      return ie(" (changed deps: " + [...e].map((n) => n.debugName).join(", ") + ")", { color: "gray" });
  }
  handleDerivedDependencyChanged(e, n, i) {
    this._isIncluded(e) && this.changedObservablesSets.get(e)?.add(n);
  }
  ...
  handleFromEventObservableTriggered(e, n) {
    this._isIncluded(e) && console.log(...this.textToConsoleArgs([
      Ke("observable from event triggered"),
      ie(e.debugName, { color: "BlueViolet" }),
      ...this.formatInfo(n),
      { data: [{ fn: e._getValue }] }
    ]));
  ...
  handleAutorunStarted(e) {
    ...
    ])), n.clear(), this.indentation++);
  }
  handleAutorunFinished(e) {
    this.indentation--;
  }
  handleBeginTransaction(e) {
    let n = e.getDebugName();
    n === void 0 && (n = ""), this._isIncluded(e) && console.log(...this.textToConsoleArgs([
      Ke("transaction"),
      ie(n, { color: "BlueViolet" }),
      { data: [{ fn: e._fn }] }
    ])), this.indentation++;
  }
...
function jr(t) {
  ...
  function s(a) {
    if ("length" in a)
      for (const l of a)
        l && s(l);
    else "text" in a ? (i += `%c${a.text}`, e.push(a.style), a.data && n.push(...a.data)) : "data" in a && n.push(...a.data);
  }
  s(t);
  const o = [i, ...e];
  return o.push(...n), o;
...
function je(t) {
  return ie(t, { color: "black" });
}
function Ke(t) {
  return ie(Qr(`${t}: `, 10), { color: "black", bold: !0 });
}
function ie(t, e = {
  color: "black"
}) {
...
function we(t, e) {
  switch (typeof t) {
    ...
    case "undefined":
      return "undefined";
    case "object":
      return t === null ? "null" : Array.isArray(t) ? Kr(t, e) : Yr(t, e);
    case "symbol":
      return t.toString();
    case "function":
  ...
  constructor(e, n) {
    this._channelFactory = e, this._getHandler = n, this._channel = this._channelFactory({
      handleNotification: (o) => {
        const a = o, l = this._getHandler().notifications[a[0]];
        if (!l)
          throw new Error(`Unknown notification "${a[0]}"!`);
        l(...a[1]);
      },
      handleRequest: (o) => {
        const a = o;
        try {
          return { type: "result", value: this._getHandler().requests[a[0]](...a[1]) };
        } catch (l) {
          return { type: "error", value: l };
        }
      }
    });
    const i = new Proxy({}, {
    ...
    this.api = { notifications: s, requests: i };
  }
}
function Zr(t, e) {
  const n = globalThis;
  let i = [], s;
  const { channel: o, handler: a } = Jr({
    sendNotification: (u) => {
...
`);
  for (let i = 1; i < n.length; i++) {
    ...
    if (e && e.test(s))
      continue;
    const o = s.match(/\$show(\d+)FramesUp/);
    if (o) {
...
function ts(t, e) {
  for (const n in e)
    t[n] && typeof t[n] == "object" && e[n] && typeof e[n] == "object" ? ts(t[n], e[n]) : t[n] = e[n];
}
function ns(t, e) {
  for (const n in e)
    e[n] === null ? delete t[n] : t[n] && typeof t[n] == "object" && e[n] && typeof e[n] == "object" ? ns(t[n], e[n]) : t[n] = e[n];
}
const Be = class Be {
  static getInstance() {
    return Be._instance === void 0 && (Be._instance = new Be()), Be._instance;
  }
  getTransactionState() {
    ...
    return { names: n.map((o) => o.getDebugName() ?? "tx"), affected: e };
  }
  _getObservableInfo(e) {
    const n = this._instanceInfos.get(e);
    if (!n) {
      Ae(new V("No info found"));
      return;
    }
    return n;
  }
  ...
  _getInfo(e, n) {
    if (e instanceof _e) {
      ...
      if (!s)
        return;
      const o = e.debugGetState(), a = { name: e.debugName, instanceId: s.instanceId, updateCount: o.updateCount }, l = [...s.changedObservables].map((u) => this._instanceInfos.get(u)?.instanceId).filter(at);
      if (o.isComputing)
        return { ...a, type: "observable/derived", state: "updating", changedDependencies: l, initialComputation: !1 };
      switch (o.state) {
        case M.initial:
          return { ...a, type: "observable/derived", state: "noValue" };
        case M.upToDate:
          return { ...a, type: "observable/derived", state: "upToDate" };
        case M.stale:
          return { ...a, type: "observable/derived", state: "stale", changedDependencies: l };
        case M.dependenciesMightHaveChanged:
          return { ...a, type: "observable/derived", state: "possiblyStale" };
      }
    } else if (e instanceof Xn) {
      const i = this._getAutorunInfo(e);
      if (!i)
        return;
      const s = { name: e.debugName, instanceId: i.instanceId, updateCount: i.updateCount }, o = [...i.changedObservables].map((a) => this._instanceInfos.get(a).instanceId);
      if (e.debugGetState().isRunning)
        return { ...s, type: "autorun", state: "updating", changedDependencies: o };
      switch (e.debugGetState().state) {
        case W.upToDate:
          return { ...s, type: "autorun", state: "upToDate" };
        case W.stale:
          return { ...s, type: "autorun", state: "stale", changedDependencies: o };
        case W.dependenciesMightHaveChanged:
          return { ...s, type: "autorun", state: "possiblyStale" };
      }
    }
  }
  _formatObservable(e) {
  ...
  constructor() {
    this._declarationId = 0, this._instanceId = 0, this._declarations = /* @__PURE__ */ new Map(), this._instanceInfos = /* @__PURE__ */ new WeakMap(), this._aliveInstances = /* @__PURE__ */ new Map(), this._activeTransactions = /* @__PURE__ */ new Set(), this._channel = Zr("observableDevTools", () => ({
      notifications: {
      ...
      requests: {
        ...
        getObservableValueInfo: (e) => ({
          observers: [...this._aliveInstances.get(e).debugGetObservers()].map((i) => this._formatObserver(i)).filter(at)
        }),
        getDerivedInfo: (e) => {
          const n = this._aliveInstances.get(e);
          return {
            dependencies: [...n.debugGetState().dependencies].map((i) => this._formatObservable(i)).filter(at),
            observers: [...n.debugGetObservers()].map((i) => this._formatObserver(i)).filter(at)
          };
        },
        getAutorunInfo: (e) => ({
          dependencies: [...this._aliveInstances.get(e).debugGetState().dependencies].map((i) => this._formatObservable(i)).filter(at)
        }),
        ...
        setValue: (e, n) => {
          ...
          if (i instanceof _e)
            i.debugSetValue(n);
          else if (i instanceof on)
            i.debugSetValue(n);
          else if (i instanceof ze)
            i.debugSetValue(n);
          else
            throw new V("Observable is not supported");
          const s = [...i.debugGetObservers()];
          for (const o of s)
            o.beginUpdate(i);
          for (const o of s)
            o.handleChange(i, void 0);
          for (const o of s)
            o.endUpdate(i);
        },
        getValue: (e) => {
          const n = this._aliveInstances.get(e);
          if (n instanceof _e)
            return we(n.debugGetState().value, 200);
          if (n instanceof on)
            return we(n.debugGetState().value, 200);
        },
        logValue: (e) => {
    ...
    })), this._pendingChanges = null, this._changeThrottler = new eo(), this._fullState = {}, this._flushUpdates = () => {
      this._pendingChanges !== null && (this._channel.api.notifications.handleChange(this._pendingChanges, !1), this._pendingChanges = null);
    };
  }
  _handleChange(e) {
    ns(this._fullState, e), this._pendingChanges === null ? this._pendingChanges = e : ts(this._pendingChanges, e), this._changeThrottler.throttle(this._flushUpdates, 10);
  }
  _getDeclarationId(e) {
    let n = !0, i;
    const s = Error;
    for (; ; ) {
      ...
      s.stackTraceLimit = n ? 6 : 20;
      const l = new Error().stack;
      s.stackTraceLimit = a;
      let u = ti(l, /[/\\]observableInternal[/\\]|\.observe|[/\\]util(s)?\./);
      if (!n && !u && (u = ti(l, /[/\\]observableInternal[/\\]|\.observe/)), u) {
        i = u;
        break;
      }
      if (!n) {
        console.error("Could not find location for declaration", new Error().stack), i = { fileName: "unknown", line: 0, column: 0, id: "unknown" };
        break;
      }
      n = !1;
    }
    let o = this._declarations.get(i.id);
    return o === void 0 && (o = {
      ...
      line: i.line,
      column: i.column
    }, this._declarations.set(i.id, o), this._handleChange({ decls: { [o.id]: o } })), o.id;
  }
  handleObservableCreated(e) {
    const i = {
  ...
  handleOnListenerCountChanged(e, n) {
    ...
    if (i) {
      if (i.listenerCount === 0 && n > 0) {
        const s = e instanceof _e ? "observable/derived" : "observable/value";
      ...
      } else i.listenerCount > 0 && n === 0 && (this._handleChange({
  ...
  handleObservableUpdated(e, n) {
    ...
    const i = this._getObservableInfo(e);
    i && n.didChange && (i.lastValue = we(n.newValue, 30), i.listenerCount > 0 && this._handleChange({
      instances: { [i.instanceId]: { formattedValue: i.lastValue } }
    }));
  }
  handleAutorunCreated(e) {
    const i = {
  ...
  _handleDerivedRecomputed(e, n) {
    ...
    if (!i)
      return;
    const s = we(n.newValue, 30);
    i.updateCount++, i.changedObservables.clear(), i.lastValue = s, i.listenerCount > 0 && this._handleChange({
      instances: { [i.instanceId]: { formattedValue: s, recomputationCount: i.updateCount } }
    });
  }
  handleDerivedCleared(e) {
    const n = this._getObservableInfo(e);
...
let an = Be;
kr(Wr);
Wt && Wt.VSCODE_DEV_DEBUG && Ki(an.getInstance());
class O {
  static fromTo(e, n) {
    return new O(e, n);
  }
  static addRange(e, n) {
    ...
    if (i === s)
      ...
      const o = Math.min(e.start, n[i].start), a = Math.max(e.endExclusive, n[s - 1].endExclusive);
      n.splice(i, s - i, new O(o, a));
    }
  }
  ...
  constructor(e, n) {
    if (this.start = e, this.endExclusive = n, e > n)
      throw new V(`Invalid range: ${this.toString()}`);
  }
  get isEmpty() {
  ...
  clip(e) {
    if (this.isEmpty)
      throw new V(`Invalid clipping range: ${this.toString()}`);
  ...
  joinRightTouching(e) {
    if (this.endExclusive !== e.start)
      throw new V(`Invalid join: ${this.toString()} and ${e.toString()}`);
...
class de {
  ...
  with(e = this.lineNumber, n = this.column) {
    return e === this.lineNumber && n === this.column ? this : new de(e, n);
  }
  delta(e = 0, n = 0) {
  ...
  isBefore(e) {
    return de.isBefore(this, e);
  }
  static isBefore(e, n) {
    return e.lineNumber < n.lineNumber ? !0 : n.lineNumber < e.lineNumber ? !1 : e.column < n.column;
  }
  isBeforeOrEqual(e) {
    return de.isBeforeOrEqual(this, e);
  }
  static isBeforeOrEqual(e, n) {
    return e.lineNumber < n.lineNumber ? !0 : n.lineNumber < e.lineNumber ? !1 : e.column <= n.column;
  }
  static compare(e, n) {
    const i = e.lineNumber | 0, s = n.lineNumber | 0;
    if (i === s) {
      const o = e.column | 0, a = n.column | 0;
      return o - a;
    }
    return i - s;
  }
  ...
  static lift(e) {
    return new de(e.lineNumber, e.column);
  }
...
class P {
  constructor(e, n, i, s) {
    e > i || e === i && n > s ? (this.startLineNumber = i, this.startColumn = s, this.endLineNumber = e, this.endColumn = n) : (this.startLineNumber = e, this.startColumn = n, this.endLineNumber = i, this.endColumn = s);
  }
  isEmpty() {
  ...
  containsPosition(e) {
    return P.containsPosition(this, e);
  }
  ...
  strictContainsRange(e) {
    return P.strictContainsRange(this, e);
  }
  static strictContainsRange(e, n) {
    return !(n.startLineNumber < e.startLineNumber || n.endLineNumber < e.startLineNumber || n.startLineNumber > e.endLineNumber || n.endLineNumber > e.endLineNumber || n.startLineNumber === e.startLineNumber && n.startColumn <= e.startColumn || n.endLineNumber === e.endLineNumber && n.endColumn >= e.endColumn);
  }
  plusRange(e) {
    return P.plusRange(this, e);
  }
  static plusRange(e, n) {
    let i, s, o, a;
    return n.startLineNumber < e.startLineNumber ? (i = n.startLineNumber, s = n.startColumn) : n.startLineNumber === e.startLineNumber ? (i = n.startLineNumber, s = Math.min(n.startColumn, e.startColumn)) : (i = e.startLineNumber, s = e.startColumn), n.endLineNumber > e.endLineNumber ? (o = n.endLineNumber, a = n.endColumn) : n.endLineNumber === e.endLineNumber ? (o = n.endLineNumber, a = Math.max(n.endColumn, e.endColumn)) : (o = e.endLineNumber, a = e.endColumn), new P(i, s, o, a);
  }
  intersectRanges(e) {
    return P.intersectRanges(this, e);
  }
  static intersectRanges(e, n) {
    let i = e.startLineNumber, s = e.startColumn, o = e.endLineNumber, a = e.endColumn;
    const l = n.startLineNumber, u = n.startColumn, c = n.endLineNumber, g = n.endColumn;
    return i < l ? (i = l, s = u) : i === l && (s = Math.max(s, u)), o > c ? (o = c, a = g) : o === c && (a = Math.min(a, g)), i > o || i === o && s > a ? null : new P(
      i,
      s,
      o,
      a
  ...
  setEndPosition(e, n) {
    return new P(this.startLineNumber, this.startColumn, e, n);
  }
  setStartPosition(e, n) {
    return new P(e, n, this.endLineNumber, this.endColumn);
  }
  collapseToStart() {
  ...
  static collapseToEnd(e) {
    return new P(e.endLineNumber, e.endColumn, e.endLineNumber, e.endColumn);
  }
  delta(e) {
    return new P(
  ...
  static fromPositions(e, n = e) {
    return new P(e.lineNumber, e.column, n.lineNumber, n.column);
  }
  static lift(e) {
    return e ? new P(
      e.startLineNumber,
  ...
  static compareRangesUsingStarts(e, n) {
    if (e && n) {
      const o = e.startLineNumber | 0, a = n.startLineNumber | 0;
      if (o === a) {
        const l = e.startColumn | 0, u = n.startColumn | 0;
        if (l === u) {
          const c = e.endLineNumber | 0, g = n.endLineNumber | 0;
          if (c === g) {
            const f = e.endColumn | 0, x = n.endColumn | 0;
            return f - x;
          }
          return c - g;
        }
...
const K = class K {
  ...
  static fromRange(e) {
    return new K(e.startLineNumber, e.endLineNumber);
  }
  static fromRangeInclusive(e) {
    return new K(e.startLineNumber, e.endLineNumber + 1);
  }
  static subtract(e, n) {
    return n ? e.startLineNumber < n.startLineNumber && n.endLineNumberExclusive < e.endLineNumberExclusive ? [
      new K(e.startLineNumber, n.startLineNumber),
      new K(n.endLineNumberExclusive, e.endLineNumberExclusive)
    ] : n.startLineNumber <= e.startLineNumber && e.endLineNumberExclusive <= n.endLineNumberExclusive ? [] : n.endLineNumberExclusive < e.endLineNumberExclusive ? [new K(
      Math.max(n.endLineNumberExclusive, e.startLineNumber),
      e.endLineNumberExclusive
    )] : [new K(e.startLineNumber, Math.min(n.startLineNumber, e.endLineNumberExclusive))] : [e];
  }
  static joinMany(e) {
    if (e.length === 0)
      return [];
    let n = new ke(e[0].slice());
    for (let i = 1; i < e.length; i++)
      n = n.getUnion(new ke(e[i].slice()));
    return n.ranges;
  }
  static join(e) {
    if (e.length === 0)
      throw new V("lineRanges cannot be empty");
  ...
  containsRange(e) {
    return this.startLineNumber <= e.startLineNumber && e.endLineNumberExclusive <= this.endLineNumberExclusive;
  }
  get isEmpty() {
    return this.startLineNumber === this.endLineNumberExclusive;
  }
  delta(e) {
    return new K(this.startLineNumber + e, this.endLineNumberExclusive + e);
  }
  deltaLength(e) {
    return new K(this.startLineNumber, this.endLineNumberExclusive + e);
  }
  get length() {
  ...
  toInclusiveRange() {
    return this.isEmpty ? null : new P(
...
K.compareByStart = Ks((e) => e.startLineNumber, Ys);
let Te = K;
class ke {
  constructor(e = []) {
  ...
  addRange(e) {
    if (e.length === 0)
      return;
    const n = Nn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= e.startLineNumber), i = Kt(this._normalizedRanges, (s) => s.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  contains(e) {
    const n = Tn(this._normalizedRanges, (i) => i.startLineNumber <= e);
    return !!n && n.endLineNumberExclusive > e;
  }
  intersects(e) {
    const n = Tn(this._normalizedRanges, (i) => i.startLineNumber < e.endLineNumberExclusive);
  ...
  getUnion(e) {
    ...
    for (; i < this._normalizedRanges.length || s < e._normalizedRanges.length; ) {
      ...
      if (i < this._normalizedRanges.length && s < e._normalizedRanges.length) {
        const l = this._normalizedRanges[i], u = e._normalizedRanges[s];
        l.startLineNumber < u.startLineNumber ? (a = l, i++) : (a = u, s++);
      } else i < this._normalizedRanges.length ? (a = this._normalizedRanges[i], i++) : (a = e._normalizedRanges[s], s++);
      o === null ? o = a : o.endLineNumberExclusive >= a.startLineNumber ? o = new Te(
        o.startLineNumber,
        Math.max(o.endLineNumberExclusive, a.endLineNumberExclusive)
      ) : (n.push(o), o = a);
    }
    return o !== null && n.push(o), new ke(n);
  }
  subtractFrom(e) {
    const n = Nn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= e.startLineNumber), i = Kt(this._normalizedRanges, (a) => a.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === i)
      return new ke([e]);
    const s = [];
    ...
    for (let a = n; a < i; a++) {
      ...
      l.startLineNumber > o && s.push(new Te(o, l.startLineNumber)), o = l.endLineNumberExclusive;
    }
    return o < e.endLineNumberExclusive && s.push(new Te(o, e.endLineNumberExclusive)), new ke(s);
  }
  toString() {
  ...
  getIntersection(e) {
    ...
    let i = 0, s = 0;
    for (; i < this._normalizedRanges.length && s < e._normalizedRanges.length; ) {
      const o = this._normalizedRanges[i], a = e._normalizedRanges[s], l = o.intersect(a);
      l && !l.isEmpty && n.push(l), o.endLineNumberExclusive < a.endLineNumberExclusive ? i++ : s++;
    }
    return new ke(n);
  }
  getWithDelta(e) {
    return new ke(this._normalizedRanges.map((n) => n.delta(e)));
  }
}
class to {
  constructor(e) {
  ...
  insertValues(e, n) {
    e = He(e);
    const i = this.values, s = this.prefixSum, o = n.length;
    return o === 0 ? !1 : (this.values = new Uint32Array(i.length + o), this.values.set(i.subarray(0, e), 0), this.values.set(i.subarray(e), e + o), this.values.set(n, e), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), this.prefixSum = new Uint32Array(this.values.length), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(s.subarray(0, this.prefixSumValidIndex[0] + 1)), !0);
  }
  setValue(e, n) {
    return e = He(e), n = He(n), this.values[e] === n ? !1 : (this.values[e] = n, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0);
  }
  removeValues(e, n) {
    e = He(e), n = He(n);
    ...
    if (e >= i.length)
      return !1;
    const o = i.length - e;
    return n >= o && (n = o), n === 0 ? !1 : (this.values = new Uint32Array(i.length - n), this.values.set(i.subarray(0, e), 0), this.values.set(i.subarray(e + n), e), this.prefixSum = new Uint32Array(this.values.length), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(s.subarray(0, this.prefixSumValidIndex[0] + 1)), !0);
  }
  getTotalSum() {
    return this.values.length === 0 ? 0 : this._getPrefixSum(this.values.length - 1);
  }
  getPrefixSum(e) {
    return e < 0 ? 0 : (e = He(e), this._getPrefixSum(e));
  }
  _getPrefixSum(e) {
  ...
  getIndexOf(e) {
    ...
    let n = 0, i = this.values.length - 1, s = 0, o = 0, a = 0;
    for (; n <= i; )
      if (s = n + (i - n) / 2 | 0, o = this.prefixSum[s], a = o - this.values[s], e < a)
        i = s - 1;
      else if (e >= o)
        n = s + 1;
      else
...
class io {
  constructor(e, n, i, s) {
    this._uri = e, this._lines = n, this._eol = i, this._versionId = s, this._lineStarts = null, this._cachedTextValue = null;
  }
  dispose() {
  ...
  _ensureLineStarts() {
    if (!this._lineStarts) {
      ...
      for (let s = 0; s < n; s++)
        i[s] = this._lines[s].length + e;
      this._lineStarts = new to(i);
    }
  }
  _setLineText(e, n) {
  ...
  _acceptInsertText(e, n) {
    ...
    for (let o = 1; o < i.length; o++)
      this._lines.splice(e.lineNumber + o - 1, 0, i[o]), s[o - 1] = i[o].length + this._eol.length;
...
function pn(t) {
  let e = 0, n = 0, i = 0, s = Xe.Unknown;
  for (let o = 0, a = t.length; o < a; o++) {
    const l = t.charCodeAt(o);
    l === m.CarriageReturn ? (e === 0 && (n = o), e++, o + 1 < a && t.charCodeAt(o + 1) === m.LineFeed ? (s |= Xe.CRLF, o++) : s |= Xe.Invalid, i = o + 1) : l === m.LineFeed && (s |= Xe.LF, e === 0 && (n = o), e++, i = o + 1);
  }
  return e === 0 && (n = t.length), [e, n, t.length - i, s];
}
var ni;
(function(t) {
...
class Me {
  ...
  static getClassNameFromMetadata(e) {
    ...
    return s & Z.Italic && (i += " mtki"), s & Z.Bold && (i += " mtkb"), s & Z.Underline && (i += " mtku"), s & Z.Strikethrough && (i += " mtks"), i;
  }
  static getInlineStyleFromMetadata(e, n) {
    const i = this.getForeground(e), s = this.getFontStyle(e);
    let o = `color: ${n[i]};`;
    s & Z.Italic && (o += "font-style: italic;"), s & Z.Bold && (o += "font-weight: bold;");
    let a = "";
    return s & Z.Underline && (a += " underline"), s & Z.Strikethrough && (a += " line-through"), a && (o += `text-decoration:${a};`), o;
  }
  static getPresentationFromMetadata(e) {
    ...
    return {
      ...
      italic: !!(i & Z.Italic),
      bold: !!(i & Z.Bold),
      underline: !!(i & Z.Underline),
      strikethrough: !!(i & Z.Strikethrough)
    };
  }
}
...
const so = {
  ...
  gitBranch: r("git-branch", 60008),
  gitBranchCreate: r("git-branch-create", 60008),
  gitBranchDelete: r("git-branch-delete", 60008),
...
class oo {
  constructor() {
    this._tokenizationSupports = /* @__PURE__ */ new Map(), this._factories = /* @__PURE__ */ new Map(), this._onDidChange = new oe(), this.onDidChange = this._onDidChange.event, this._colorMap = null;
  }
  handleChange(e) {
  ...
  register(e, n) {
    return this._tokenizationSupports.set(e, n), this.handleChange([e]), qe(() => {
  ...
  registerFactory(e, n) {
    ...
    const i = new ao(this, e, n);
    return this._factories.set(e, i), qe(() => {
  ...
  getDefaultBackground() {
    return this._colorMap && this._colorMap.length > Oe.DefaultBackground ? this._colorMap[Oe.DefaultBackground] : null;
  }
}
class ao extends me {
  get isResolved() {
...
class un {
  constructor(e, n) {
    this.tokens = e, this.endState = n, this._encodedTokenizationResultBrand = void 0;
  }
}
var si;
(function(t) {
...
(function(t) {
  const e = /* @__PURE__ */ new Map();
  e.set(d.Method, v.symbolMethod), e.set(d.Function, v.symbolFunction), e.set(d.Constructor, v.symbolConstructor), e.set(d.Field, v.symbolField), e.set(d.Variable, v.symbolVariable), e.set(d.Class, v.symbolClass), e.set(d.Struct, v.symbolStruct), e.set(d.Interface, v.symbolInterface), e.set(d.Module, v.symbolModule), e.set(d.Property, v.symbolProperty), e.set(d.Event, v.symbolEvent), e.set(d.Operator, v.symbolOperator), e.set(d.Unit, v.symbolUnit), e.set(d.Value, v.symbolValue), e.set(d.Enum, v.symbolEnum), e.set(d.Constant, v.symbolConstant), e.set(d.Enum, v.symbolEnum), e.set(d.EnumMember, v.symbolEnumMember), e.set(d.Keyword, v.symbolKeyword), e.set(d.Snippet, v.symbolSnippet), e.set(d.Text, v.symbolText), e.set(d.Color, v.symbolColor), e.set(d.File, v.symbolFile), e.set(d.Reference, v.symbolReference), e.set(d.Customcolor, v.symbolCustomColor), e.set(d.Folder, v.symbolFolder), e.set(d.TypeParameter, v.symbolTypeParameter), e.set(d.User, v.account), e.set(d.Issue, v.issues), e.set(d.Tool, v.tools);
  function n(a) {
    let l = e.get(a);
    return l || (console.info("No codicon found for CompletionItemKind " + a), l = v.symbolProperty), l;
  }
  t.toIcon = n;
  function i(a) {
    switch (a) {
      case d.Method:
        return L(786, "Method");
      case d.Function:
        return L(787, "Function");
      case d.Constructor:
        return L(788, "Constructor");
      case d.Field:
        return L(789, "Field");
      case d.Variable:
        return L(790, "Variable");
      case d.Class:
        return L(791, "Class");
      case d.Struct:
        return L(792, "Struct");
      case d.Interface:
        return L(793, "Interface");
      case d.Module:
        return L(794, "Module");
      case d.Property:
        return L(795, "Property");
      case d.Event:
        return L(796, "Event");
      case d.Operator:
        return L(797, "Operator");
      case d.Unit:
        return L(798, "Unit");
      case d.Value:
        return L(799, "Value");
      case d.Constant:
        return L(800, "Constant");
      case d.Enum:
        return L(801, "Enum");
      case d.EnumMember:
        return L(802, "Enum Member");
      case d.Keyword:
        return L(803, "Keyword");
      case d.Text:
        return L(804, "Text");
      case d.Color:
        return L(805, "Color");
      case d.File:
        return L(806, "File");
      case d.Reference:
        return L(807, "Reference");
      case d.Customcolor:
        return L(808, "Custom Color");
      case d.Folder:
        return L(809, "Folder");
      case d.TypeParameter:
        return L(810, "Type Parameter");
      case d.User:
        return L(811, "User");
      case d.Issue:
        return L(812, "Issue");
  ...
  s.set("method", d.Method), s.set("function", d.Function), s.set("constructor", d.Constructor), s.set("field", d.Field), s.set("variable", d.Variable), s.set("class", d.Class), s.set("struct", d.Struct), s.set("interface", d.Interface), s.set("module", d.Module), s.set("property", d.Property), s.set("event", d.Event), s.set("operator", d.Operator), s.set("unit", d.Unit), s.set("value", d.Value), s.set("constant", d.Constant), s.set("enum", d.Enum), s.set("enum-member", d.EnumMember), s.set("enumMember", d.EnumMember), s.set("keyword", d.Keyword), s.set("snippet", d.Snippet), s.set("text", d.Text), s.set("color", d.Color), s.set("file", d.File), s.set("reference", d.Reference), s.set("customcolor", d.Customcolor), s.set("folder", d.Folder), s.set("type-parameter", d.TypeParameter), s.set("typeParameter", d.TypeParameter), s.set("account", d.User), s.set("issue", d.Issue), s.set("tool", d.Tool);
  function o(a, l) {
    let u = s.get(a);
    return typeof u > "u" && !l && (u = d.Property), u;
  }
  t.fromString = o;
})(ri || (ri = {}));
var oi;
...
_.Array + "", L(815, "array"), _.Boolean + "", L(816, "boolean"), _.Class + "", L(817, "class"), _.Constant + "", L(818, "constant"), _.Constructor + "", L(819, "constructor"), _.Enum + "", L(820, "enumeration"), _.EnumMember + "", L(821, "enumeration member"), _.Event + "", L(822, "event"), _.Field + "", L(823, "field"), _.File + "", L(824, "file"), _.Function + "", L(825, "function"), _.Interface + "", L(826, "interface"), _.Key + "", L(827, "key"), _.Method + "", L(828, "method"), _.Module + "", L(829, "module"), _.Namespace + "", L(830, "namespace"), _.Null + "", L(831, "null"), _.Number + "", L(832, "number"), _.Object + "", L(833, "object"), _.Operator + "", L(834, "operator"), _.Package + "", L(835, "package"), _.Property + "", L(836, "property"), _.String + "", L(837, "string"), _.Struct + "", L(838, "struct"), _.TypeParameter + "", L(839, "type parameter"), _.Variable + "", L(840, "variable");
var mi;
(function(t) {
  t[t.Deprecated = 1] = "Deprecated";
})(mi || (mi = {}));
...
(function(t) {
  const e = /* @__PURE__ */ new Map();
  e.set(_.File, v.symbolFile), e.set(_.Module, v.symbolModule), e.set(_.Namespace, v.symbolNamespace), e.set(_.Package, v.symbolPackage), e.set(_.Class, v.symbolClass), e.set(_.Method, v.symbolMethod), e.set(_.Property, v.symbolProperty), e.set(_.Field, v.symbolField), e.set(_.Constructor, v.symbolConstructor), e.set(_.Enum, v.symbolEnum), e.set(_.Interface, v.symbolInterface), e.set(_.Function, v.symbolFunction), e.set(_.Variable, v.symbolVariable), e.set(_.Constant, v.symbolConstant), e.set(_.String, v.symbolString), e.set(_.Number, v.symbolNumber), e.set(_.Boolean, v.symbolBoolean), e.set(_.Array, v.symbolArray), e.set(_.Object, v.symbolObject), e.set(_.Key, v.symbolKey), e.set(_.Null, v.symbolNull), e.set(_.EnumMember, v.symbolEnumMember), e.set(_.Struct, v.symbolStruct), e.set(_.Event, v.symbolEvent), e.set(_.Operator, v.symbolOperator), e.set(_.TypeParameter, v.symbolTypeParameter);
  function n(o) {
    let a = e.get(o);
    return a || (console.info("No codicon found for SymbolKind " + o), a = v.symbolProperty), a;
  }
  t.toIcon = n;
  const i = /* @__PURE__ */ new Map();
  i.set(_.File, d.File), i.set(_.Module, d.Module), i.set(_.Namespace, d.Module), i.set(_.Package, d.Module), i.set(_.Class, d.Class), i.set(_.Method, d.Method), i.set(_.Property, d.Property), i.set(_.Field, d.Field), i.set(_.Constructor, d.Constructor), i.set(_.Enum, d.Enum), i.set(_.Interface, d.Interface), i.set(_.Function, d.Function), i.set(_.Variable, d.Variable), i.set(_.Constant, d.Constant), i.set(_.String, d.Text), i.set(_.Number, d.Value), i.set(_.Boolean, d.Value), i.set(_.Array, d.Value), i.set(_.Object, d.Value), i.set(_.Key, d.Keyword), i.set(_.Null, d.Value), i.set(_.EnumMember, d.EnumMember), i.set(_.Struct, d.Struct), i.set(_.Event, d.Event), i.set(_.Operator, d.Operator), i.set(_.TypeParameter, d.TypeParameter);
  function s(o) {
    let a = i.get(o);
    return a === void 0 && (console.info("No completion kind found for SymbolKind " + o), a = d.File), a;
  }
...
function uo(t, e) {
  ...
  return n[0] = 0, n[1] = (t << z.LANGUAGEID_OFFSET | ln.Other << z.TOKEN_TYPE_OFFSET | Z.None << z.FONT_STYLE_OFFSET | Oe.DefaultForeground << z.FOREGROUND_OFFSET | Oe.DefaultBackground << z.BACKGROUND_OFFSET) >>> 0, new un(n, e === null ? lo : e);
}
class co {
  constructor(e) {
  ...
  replace(e, n, i) {
    ...
    const s = this._store.slice(0, e), o = this._store.slice(e + n), a = fo(i, this._default);
    this._store = s.concat(a, o);
  }
  delete(e, n) {
    n === 0 || e >= this._store.length || this._store.splice(e, n);
  }
  insert(e, n) {
    if (n === 0 || e >= this._store.length)
      return;
    const i = [];
    for (let s = 0; s < n; s++)
      i[s] = this._default;
    this._store = Vi(this._store, e, i);
  }
}
function fo(t, e) {
  const n = [];
...
const Le = class Le {
  static createEmpty(e, n) {
    const i = Le.defaultTokenMetadata, s = new Uint32Array(2);
    return s[0] = e.length, s[1] = i, new Le(s, e, n);
  }
  static createFromTextAndMetadata(e, n) {
    let i = 0, s = "";
    const o = new Array();
    for (const { text: a, metadata: l } of e)
      o.push(i + a.length, l), i += a.length, s += a;
    return new Le(new Uint32Array(o), s, n);
  }
  static convertToEndOffset(e, n) {
    const s = (e.length >>> 1) - 1;
    for (let o = 0; o < s; o++)
      e[o << 1] = e[o + 1 << 1];
    e[s << 1] = n;
  }
  static findIndexInTokensArray(e, n) {
    if (e.length <= 2)
      return 0;
    let i = 0, s = (e.length >>> 1) - 1;
    for (; i < s; ) {
      const o = i + Math.floor((s - i) / 2), a = e[o << 1];
      if (a === n)
        return o + 1;
      a < n ? i = o + 1 : a > n && (s = o);
    }
  ...
  constructor(e, n, i) {
    this._lineTokensBrand = void 0, (e.length > 1 ? e[e.length - 2] : 0) !== n.length && Ae(new Error("Token length and text length do not match!")), this._tokens = e, this._tokensCount = this._tokens.length >>> 1, this._text = n, this.languageIdCodec = i;
  }
  getTextLength() {
    return this._text.length;
  }
  equals(e) {
    return e instanceof Le ? this.slicedEquals(e, 0, this._tokensCount) : !1;
  }
  slicedEquals(e, n, i) {
  ...
  getLanguageId(e) {
    const n = this._tokens[(e << 1) + 1], i = Me.getLanguageId(n);
    return this.languageIdCodec.decodeLanguageId(i);
  }
  getStandardTokenType(e) {
    const n = this._tokens[(e << 1) + 1];
    return Me.getTokenType(n);
  }
  getForeground(e) {
    const n = this._tokens[(e << 1) + 1];
    return Me.getForeground(n);
  }
  getClassName(e) {
    const n = this._tokens[(e << 1) + 1];
    return Me.getClassNameFromMetadata(n);
  }
  getInlineStyle(e, n) {
    const i = this._tokens[(e << 1) + 1];
    return Me.getInlineStyleFromMetadata(i, n);
  }
  getPresentation(e) {
    const n = this._tokens[(e << 1) + 1];
    return Me.getPresentationFromMetadata(n);
  }
  getEndOffset(e) {
    return this._tokens[e << 1];
  }
  findTokenIndexAtOffset(e) {
    return Le.findIndexInTokensArray(this._tokens, e);
  }
  inflate() {
    return this;
  }
  sliceAndInflate(e, n, i) {
    return new En(this, e, n, i);
  }
  sliceZeroCopy(e) {
  ...
  withInserted(e) {
    ...
    let a = 0;
    for (; ; ) {
      const l = n < this._tokensCount ? this._tokens[n << 1] : -1, u = i < e.length ? e[i] : null;
    ...
    return new Le(new Uint32Array(o), s, this.languageIdCodec);
  }
  getTokensInRange(e) {
    const n = new ho(), i = this.findTokenIndexAtOffset(e.start), s = this.findTokenIndexAtOffset(e.endExclusive);
    for (let o = i; o <= s; o++) {
      const l = new O(this.getStartOffset(o), this.getEndOffset(o)).intersectionLength(e);
      l > 0 && n.add(l, this.getMetadata(o));
    }
    return n.build();
  }
  getTokenText(e) {
    const n = this.getStartOffset(e), i = this.getEndOffset(e);
  ...
  toString() {
    ...
    return this.forEach((n) => {
      e += `[${this.getTokenText(n)}]{${this.getClassName(n)}}`;
    }), e;
  }
};
Le.defaultTokenMetadata = (Z.None << z.FONT_STYLE_OFFSET | Oe.DefaultForeground << z.FOREGROUND_OFFSET | Oe.DefaultBackground << z.BACKGROUND_OFFSET) >>> 0;
let rt = Le;
class En {
  constructor(e, n, i, s) {
    this._source = e, this._startOffset = n, this._endOffset = i, this._deltaOffset = s, this._firstTokenIndex = e.findTokenIndexAtOffset(n), this.languageIdCodec = e.languageIdCodec, this._tokensCount = 0;
    for (let o = this._firstTokenIndex, a = e.getCount(); o < a && !(e.getStartOffset(o) >= i); o++)
      this._tokensCount++;
  }
  getMetadata(e) {
  ...
  equals(e) {
    return e instanceof En ? this._startOffset === e._startOffset && this._endOffset === e._endOffset && this._deltaOffset === e._deltaOffset && this._source.slicedEquals(e._source, this._firstTokenIndex, this._tokensCount) : !1;
  }
  getCount() {
    return this._tokensCount;
  }
  ...
  getEndOffset(e) {
    const n = this._source.getEndOffset(this._firstTokenIndex + e);
  ...
  getInlineStyle(e, n) {
    return this._source.getInlineStyle(this._firstTokenIndex + e, n);
  }
  getPresentation(e) {
  ...
  getTokenText(e) {
    const n = this._firstTokenIndex + e, i = this._source.getStartOffset(n), s = this._source.getEndOffset(n);
...
class Qe {
  static fromLineTokens(e) {
    ...
    for (let i = 0; i < e.getCount(); i++)
      n.push(new cn(
        e.getEndOffset(i) - e.getStartOffset(i),
        e.getMetadata(i)
      ));
    return Qe.create(n);
  }
  ...
  toLineTokens(e, n) {
    return rt.createFromTextAndMetadata(this.map((i, s) => ({ text: i.substring(e), metadata: s.metadata })), n);
  }
  forEach(e) {
    let n = 0;
    for (const i of this._tokenInfo) {
      const s = new O(n, n + i.length);
      e(s, i), n += i.length;
    }
  }
  map(e) {
    ...
    for (const s of this._tokenInfo) {
      const o = new O(i, i + s.length);
      n.push(e(o, s)), i += s.length;
    }
    return n;
  }
  slice(e) {
    ...
    for (const s of this._tokenInfo) {
      ...
      if (a > e.start) {
        if (o >= e.endExclusive)
          break;
        const l = Math.max(0, e.start - o), u = Math.max(0, a - e.endExclusive);
        n.push(new cn(s.length - l - u, s.metadata));
      }
      i += s.length;
    }
    return Qe.create(n);
  ...
  append(e) {
    const n = this._tokenInfo.concat(e._tokenInfo);
    return Qe.create(n);
  }
}
class cn {
  constructor(e, n) {
    this.length = e, this.metadata = n;
  }
}
class ho {
  constructor() {
  ...
  add(e, n) {
    this._tokens.push(new cn(e, n));
  }
  build() {
    return Qe.create(this._tokens);
  }
}
const De = new Uint32Array(0).buffer;
class re {
  static deleteBeginning(e, n) {
    return e === null || e === De ? e : re.delete(e, 0, n);
  }
  static deleteEnding(e, n) {
    if (e === null || e === De)
      return e;
    const i = lt(e), s = i[i.length - 2];
    return re.delete(e, n, s);
  }
  static delete(e, n, i) {
    if (e === null || e === De || n === i)
      return e;
    const s = lt(e), o = s.length >>> 1;
    if (n === 0 && s[s.length - 2] === i)
      return De;
    const a = rt.findIndexInTokensArray(s, n), l = a > 0 ? s[a - 1 << 1] : 0, u = s[a << 1];
    if (i < u) {
      const F = i - n;
      for (let U = a; U < o; U++)
        s[U << 1] -= F;
    ...
    let c, g;
    l !== n ? (s[a << 1] = n, c = a + 1 << 1, g = n) : (c = a << 1, g = l);
    const f = i - n;
    for (let F = a + 1; F < o; F++) {
      const U = s[F << 1] - f;
      U > g && (s[c++] = U, s[c++] = s[(F << 1) + 1], g = U);
    }
    if (c === s.length)
      return e;
    const x = new Uint32Array(c);
    return x.set(s.subarray(0, c), 0), x.buffer;
  }
  static append(e, n) {
    if (n === De)
      return e;
    ...
    if (n === null)
      return null;
    const i = lt(e), s = lt(n), o = s.length >>> 1, a = new Uint32Array(i.length + s.length);
    a.set(i, 0);
    let l = i.length;
    const u = i[i.length - 2];
    for (let c = 0; c < o; c++)
      a[l++] = s[c << 1] + u, a[l++] = s[(c << 1) + 1];
    return a.buffer;
  }
  static insert(e, n, i) {
    if (e === null || e === De)
      return e;
    const s = lt(e), o = s.length >>> 1;
    let a = rt.findIndexInTokensArray(s, n);
    a > 0 && s[a - 1 << 1] === n && a--;
    for (let l = a; l < o; l++)
      s[l << 1] += i;
    return e;
...
class Ut {
  static deserialize(e, n, i) {
    const s = new Uint32Array(e.buffer), o = Lt(e, n);
    n += 4;
    const a = Lt(e, n);
    n += 4;
    const l = [];
  ...
  constructor(e, n) {
    this._startLineNumber = e, this._tokens = n;
  }
  getLineRange() {
    return new Te(this._startLineNumber, this._startLineNumber + this._tokens.length);
  }
  getLineTokens(e) {
  ...
  serialize(e, n) {
    wt(e, this._startLineNumber, n), n += 4, wt(e, this._tokens.length, n), n += 4;
    for (let i = 0; i < this._tokens.length; i++) {
      const s = this._tokens[i];
      if (!(s instanceof Uint32Array))
        throw new Error("Not supported!");
      wt(e, s.byteLength, n), n += 4, e.set(new Uint8Array(s.buffer), n), n += s.byteLength;
    }
    return n;
  }
  applyEdit(e, n) {
    const [i, s] = pn(n);
    this._acceptDeleteRange(e), this._acceptInsertText(new de(e.startLineNumber, e.startColumn), i, s);
  }
  _acceptDeleteRange(e) {
    if (e.startLineNumber === e.endLineNumber && e.startColumn === e.endColumn)
      return;
    const n = e.startLineNumber - this._startLineNumber, i = e.endLineNumber - this._startLineNumber;
    if (i < 0) {
      const s = i - n;
    ...
    if (!(n >= this._tokens.length)) {
      ...
      if (n === i) {
        this._tokens[n] = re.delete(this._tokens[n], e.startColumn - 1, e.endColumn - 1);
        return;
      }
      if (n >= 0)
        if (this._tokens[n] = re.deleteEnding(this._tokens[n], e.startColumn - 1), i < this._tokens.length) {
          const s = re.deleteBeginning(this._tokens[i], e.endColumn - 1);
          this._tokens[n] = re.append(this._tokens[n], s), this._tokens.splice(n + 1, i - n);
        } else
          this._tokens[n] = re.append(this._tokens[n], null), this._tokens = this._tokens.slice(0, n + 1);
      else {
        const s = -n;
        this._startLineNumber -= s, this._tokens[i] = re.deleteBeginning(this._tokens[i], e.endColumn - 1), this._tokens = this._tokens.slice(i);
      }
    }
  }
  _acceptInsertText(e, n, i) {
    if (n === 0 && i === 0)
      return;
    const s = e.lineNumber - this._startLineNumber;
    if (s < 0) {
    ...
    if (!(s >= this._tokens.length)) {
      if (n === 0) {
        this._tokens[s] = re.insert(this._tokens[s], e.column - 1, i);
        return;
      }
      this._tokens[s] = re.deleteEnding(this._tokens[s], e.column - 1), this._tokens[s] = re.insert(this._tokens[s], e.column - 1, i), this._insertLines(e.lineNumber, n);
    }
  }
  _insertLines(e, n) {
    if (n === 0)
    ...
    for (let s = 0; s < n; s++)
      i[s] = null;
    this._tokens = Vi(this._tokens, e, i);
  }
}
class _o {
  static deserialize(e) {
  ...
  add(e, n) {
    if (this._tokens.length > 0) {
      ...
      if (i.endLineNumber + 1 === e) {
        i.appendLineTokens(n);
        return;
      }
    }
    this._tokens.push(new Ut(e, [n]));
  }
  finalize() {
    return this._tokens;
  }
  serialize() {
    const e = this._serializeSize(), n = new Uint8Array(e);
    return this._serialize(n), n;
  }
  _serializeSize() {
    let e = 0;
    e += 4;
    for (let n = 0; n < this._tokens.length; n++)
      e += this._tokens[n].serializeSize();
    return e;
  }
  _serialize(e) {
    let n = 0;
    wt(e, this._tokens.length, n), n += 4;
    for (let i = 0; i < this._tokens.length; i++)
      n = this._tokens[i].serialize(e, n);
  }
}
var Ri;
(function(t) {
  t[t.CHEAP_TOKENIZATION_LENGTH_LIMIT = 2048] = "CHEAP_TOKENIZATION_LENGTH_LIMIT";
})(Ri || (Ri = {}));
class go {
  constructor(e, n) {
    this.tokenizationSupport = n, this.initialState = this.tokenizationSupport.getInitialState(), this.store = new mo(e);
  }
  getStartState(e) {
...
class mo {
  constructor(e) {
    this.lineCount = e, this._tokenizationStateStore = new bo(), this._invalidEndStatesLineNumbers = new po(), this._invalidEndStatesLineNumbers.addRange(new O(1, e + 1));
  }
  getEndState(e) {
  ...
  setEndState(e, n) {
    if (!n)
      throw new V("Cannot set null/undefined state");
    this._invalidEndStatesLineNumbers.delete(e);
    const i = this._tokenizationStateStore.setEndState(e, n);
    return i && e < this.lineCount && this._invalidEndStatesLineNumbers.addRange(new O(e + 1, e + 2)), i;
  }
  acceptChange(e, n) {
    this.lineCount += n - e.length, this._tokenizationStateStore.acceptChange(e, n), this._invalidEndStatesLineNumbers.addRangeAndResize(new O(e.startLineNumber, e.endLineNumberExclusive), n);
  }
  acceptChanges(e) {
    for (const n of e) {
      const [i] = pn(n.text);
      this.acceptChange(new Te(n.range.startLineNumber, n.range.endLineNumber + 1), i + 1);
    }
  }
  invalidateEndStateRange(e) {
    this._invalidEndStatesLineNumbers.addRange(new O(e.startLineNumber, e.endLineNumberExclusive));
  }
  ...
  getStartState(e, n) {
    return e === 1 ? n : this.getEndState(e - 1);
  }
  getFirstInvalidLine(e) {
    const n = this.getFirstInvalidEndStateLineNumber();
    if (n === null)
      return null;
    const i = this.getStartState(n, e);
    if (!i)
      throw new V("Start state must be defined");
    return { lineNumber: n, startState: i };
  }
}
class bo {
  constructor() {
    this._lineEndStates = new co(null);
  }
  getEndState(e) {
  ...
  setEndState(e, n) {
    ...
    return i && i.equals(n) ? !1 : (this._lineEndStates.set(e, n), !0);
  }
  acceptChange(e, n) {
    let i = e.length;
    n > 0 && i > 0 && (i--, n--), this._lineEndStates.replace(e.startLineNumber, i, n);
  }
  acceptChanges(e) {
    for (const n of e) {
      const [i] = pn(n.text);
...
class po {
  ...
  removeMin() {
    ...
    return e.start + 1 === e.endExclusive ? this._ranges.shift() : this._ranges[0] = new O(e.start + 1, e.endExclusive), e.start;
  }
  delete(e) {
    const n = this._ranges.findIndex((i) => i.contains(e));
    if (n !== -1) {
      const i = this._ranges[n];
      i.start === e ? i.endExclusive === e + 1 ? this._ranges.splice(n, 1) : this._ranges[n] = new O(e + 1, i.endExclusive) : i.endExclusive === e + 1 ? this._ranges[n] = new O(i.start, e) : this._ranges.splice(n, 1, new O(i.start, e), new O(e + 1, i.endExclusive));
    }
  }
  addRange(e) {
    O.addRange(e, this._ranges);
  }
  addRangeAndResize(e, n) {
    let i = 0;
    for (; !(i >= this._ranges.length || e.start <= this._ranges[i].endExclusive); )
      i++;
    let s = i;
    for (; !(s >= this._ranges.length || e.endExclusive < this._ranges[s].start); )
      s++;
    const o = n - e.length;
    for (let a = s; a < this._ranges.length; a++)
      this._ranges[a] = this._ranges[a].delta(o);
    if (i === s) {
      const a = new O(e.start, e.start + n);
      a.isEmpty || this._ranges.splice(i, 0, a);
    } else {
      const a = Math.min(e.start, this._ranges[i].start), l = Math.max(e.endExclusive, this._ranges[s - 1].endExclusive), u = new O(a, l + o);
      u.isEmpty ? this._ranges.splice(i, s - i) : this._ranges.splice(i, s - i, u);
    }
  }
  toString() {
...
class Eo extends me {
  constructor(e, n, i, s, o, a, l) {
    super(), this._grammar = e, this._initialState = n, this._containsEmbeddedLanguages = i, this._createBackgroundTokenizer = s, this._backgroundTokenizerShouldOnlyVerifyTokens = o, this._reportTokenizationTime = a, this._reportSlowTokenization = l, this._seenLanguages = [], this._onDidEncounterLanguage = this._register(new oe()), this.onDidEncounterLanguage = this._onDidEncounterLanguage.event;
  }
  ...
  createBackgroundTokenizer(e, n) {
    if (this._createBackgroundTokenizer)
      return this._createBackgroundTokenizer(e, n);
  }
  tokenizeEncoded(e, n, i) {
    const s = Math.random() * 1e4 < 1, o = this._reportSlowTokenization || s, a = o ? new Ft(!0) : void 0, l = this._grammar.tokenizeLine2(e, i, 500);
    if (o) {
      const c = a.elapsed();
      (s || c > 32) && this._reportTokenizationTime(c, e.length, s);
    }
    if (l.stoppedEarly)
      return console.warn(`Time limit reached when tokenizing line: ${e.substring(0, 100)}`), new un(l.tokens, i);
    if (this._containsEmbeddedLanguages) {
      const c = this._seenLanguages, g = l.tokens;
      for (let f = 0, x = g.length >>> 1; f < x; f++) {
        const F = g[(f << 1) + 1], U = Me.getLanguageId(F);
        c[U] || (c[U] = !0, this._onDidEncounterLanguage.fire(U));
      }
    }
    let u;
    return i.equals(l.ruleStack) ? u = i : u = l.ruleStack, new un(l.tokens, u);
  }
}
class xo extends me {
  get backgroundTokenizerShouldOnlyVerifyTokens() {
  ...
  constructor(e, n, i, s) {
    super(), this._encodedLanguageId = e, this._actual = n, this._maxTokenizationLineLength = s, this._register(Ci(this._maxTokenizationLineLength)), this._register(i);
  }
  getInitialState() {
  ...
  tokenizeEncoded(e, n, i) {
    return e.length >= this._maxTokenizationLineLength.get() ? uo(this._encodedLanguageId, i) : this._actual.tokenizeEncoded(e, n, i);
  }
  createBackgroundTokenizer(e, n) {
    if (this._actual.createBackgroundTokenizer)
      return this._actual.createBackgroundTokenizer(e, n);
  }
}
class vo extends io {
  constructor(e, n, i, s, o, a, l, u) {
    super(e, n, i, s), this._host = o, this._languageId = a, this._encodedLanguageId = l, this._tokenizerWithStateStore = null, this._isDisposed = !1, this._maxTokenizationLineLength = qr(this, -1), this._tokenizeDebouncer = new Rr(() => this._tokenize(), 10), this._maxTokenizationLineLength.set(u, void 0), this._resetTokenization();
  }
  dispose() {
    this._isDisposed = !0, super.dispose();
  }
  onLanguageId(e, n) {
    this._languageId = e, this._encodedLanguageId = n, this._resetTokenization();
  }
  onEvents(e) {
  ...
  retokenize(e, n) {
    this._tokenizerWithStateStore && (this._tokenizerWithStateStore.store.invalidateEndStateRange(new Te(e, n)), this._tokenizeDebouncer.schedule());
  }
  async _resetTokenization() {
    this._tokenizerWithStateStore = null;
    const e = this._languageId, n = this._encodedLanguageId, i = await this._host.getOrCreateGrammar(e, n);
    if (!(this._isDisposed || e !== this._languageId || n !== this._encodedLanguageId || !i)) {
      if (i.grammar) {
        const s = new xo(this._encodedLanguageId, new Eo(
          i.grammar,
          i.initialState,
          !1,
          void 0,
          () => !1,
          (o, a, l) => {
            this._host.reportTokenizationTime(o, e, i.sourceExtensionId, a, l);
          },
          !1
        ), me.None, this._maxTokenizationLineLength);
        this._tokenizerWithStateStore = new go(this._lines.length, s);
      } else
        this._tokenizerWithStateStore = null;
      this._tokenize();
    }
  ...
  async _tokenize() {
    ...
    if (!this._diffStateStacksRefEqFn) {
      const { diffStateStacksRefEq: n } = await import("./main-BezBZl7P.js").then(function(i) {
        return i.m;
      }).then((i) => i.default ?? i);
      this._diffStateStacksRefEqFn = n;
    }
    const e = (/* @__PURE__ */ new Date()).getTime();
    for (; ; ) {
      let n = 0;
      const i = new _o(), s = new Lo();
      for (; ; ) {
        ...
        if (this._tokenizerWithStateStore.store.setEndState(l.lineNumber, c.endState)) {
          ...
          s.setState(l.lineNumber, f);
        } else
          s.setState(l.lineNumber, null);
        if (rt.convertToEndOffset(c.tokens, u.length), i.add(l.lineNumber, c.tokens), (/* @__PURE__ */ new Date()).getTime() - e > 20)
          break;
      }
      if (n === 0)
        break;
      const o = s.getStateDeltas();
      if (this._host.setTokensAndStates(this._versionId, i.serialize(), o), (/* @__PURE__ */ new Date()).getTime() - e > 20) {
        xs(() => this._tokenize());
        return;
      }
    }
...
class Lo {
  ...
  setState(e, n) {
    e === this._lastStartLineNumber + 1 ? this._stateDeltas[this._stateDeltas.length - 1].stateDeltas.push(n) : this._stateDeltas.push({ startLineNumber: e, stateDeltas: [n] }), this._lastStartLineNumber = e;
  }
  getStateDeltas() {
...
ct.CHANNEL_NAME = "textMateWorkerHost";
let dn = ct;
function wo(t) {
  return new yo(t);
}
class yo {
  constructor(e) {
    this._models = /* @__PURE__ */ new Map(), this._grammarCache = [], this._grammarFactory = Promise.resolve(null), this._host = dn.getChannel(e);
  }
  async $init(e) {
    const n = e.grammarDefinitions.map((i) => ({
      location: H.revive(i.location),
      language: i.language,
      scopeName: i.scopeName,
      embeddedLanguages: i.embeddedLanguages,
    ...
    this._grammarFactory = this._loadTMGrammarFactory(n, e.onigurumaWASMUri);
  }
  async _loadTMGrammarFactory(e, n) {
    const i = await import("./main-BezBZl7P.js").then(function(u) {
      return u.m;
    }).then((u) => u.default ?? u), s = await import("./main-Be0xG8JJ.js").then(function(u) {
      return u.m;
    }).then((u) => u.default ?? u), a = await (await fetch(n)).arrayBuffer();
    await s.loadWASM(a);
    const l = Promise.resolve({
      createOnigScanner: (u) => s.createOnigScanner(u),
      createOnigString: (u) => s.createOnigString(u)
    });
    return new sr({
      logTrace: (u) => {
      },
      logError: (u, c) => console.error(u, c),
      readFile: (u) => this._host.$readFile(u)
    }, e, i, l);
  }
  $acceptNewModel(e) {
    const n = H.revive(e.uri), i = this;
    this._models.set(e.controllerId, new vo(n, e.lines, e.EOL, e.versionId, {
      async getOrCreateGrammar(s, o) {
        const a = await i._grammarFactory;
        return a ? (i._grammarCache[o] || (i._grammarCache[o] = a.createGrammar(s, o)), i._grammarCache[o]) : Promise.resolve(null);
      },
      setTokensAndStates(s, o, a) {
        i._host.$setTokensAndStates(e.controllerId, s, o, a);
      },
      reportTokenizationTime(s, o, a, l, u) {
        i._host.$reportTokenizationTime(s, o, a, l, u);
      }
    }, e.languageId, e.encodedLanguageId, e.maxTokenizationLineLength));
  }
  $acceptModelChanged(e, n) {
    this._models.get(e).onEvents(n);
  }
  $retokenize(e, n, i) {
    this._models.get(e).retokenize(n, i);
  }
  $acceptModelLanguageChanged(e, n, i) {
    this._models.get(e).onLanguageId(n, i);
  }
  $acceptRemovedModel(e) {
    const n = this._models.get(e);
    n && (n.dispose(), this._models.delete(e));
  }
  async $acceptTheme(e, n) {
    (await this._grammarFactory)?.setTheme(e, n);
  }
  $acceptMaxTokenizationLineLength(e, n) {
    this._models.get(e).acceptMaxTokenizationLineLength(n);
  }
}
const qt = "default", Ao = "$initialize";
var ne;
(function(t) {
  t[t.Request = 0] = "Request", t[t.Reply = 1] = "Reply", t[t.SubscribeEvent = 2] = "SubscribeEvent", t[t.Event = 3] = "Event", t[t.UnsubscribeEvent = 4] = "UnsubscribeEvent";
})(ne || (ne = {}));
class To {
  constructor(e, n, i, s, o) {
    this.vsWorker = e, this.req = n, this.channel = i, this.method = s, this.args = o, this.type = ne.Request;
  }
}
class ki {
  constructor(e, n, i, s) {
    this.vsWorker = e, this.seq = n, this.res = i, this.err = s, this.type = ne.Reply;
  }
}
class No {
  constructor(e, n, i, s, o) {
    this.vsWorker = e, this.req = n, this.channel = i, this.eventName = s, this.arg = o, this.type = ne.SubscribeEvent;
  }
}
class So {
  constructor(e, n, i) {
    this.vsWorker = e, this.req = n, this.event = i, this.type = ne.Event;
  }
}
class Ro {
  constructor(e, n) {
    this.vsWorker = e, this.req = n, this.type = ne.UnsubscribeEvent;
  }
}
class ko {
  constructor(e) {
  ...
  sendMessage(e, n, i) {
    ...
    return new Promise((o, a) => {
      this._pendingReplies[s] = {
        resolve: o,
        reject: a
      }, this._send(new To(this._workerId, s, e, n, i));
    });
  }
  listen(e, n, i) {
    let s = null;
    const o = new oe({
      onWillAddFirstListener: () => {
        s = String(++this._lastSentReq), this._pendingEmitters.set(s, o), this._send(new No(this._workerId, s, e, n, i));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(s), this._send(new Ro(this._workerId, s)), s = null;
      }
    });
    return o.event;
  }
  ...
  createProxyToRemoteChannel(e, n) {
    const i = {
      get: (s, o) => (typeof o == "string" && !s[o] && (ss(o) ? s[o] = (a) => this.listen(e, o, a) : is(o) ? s[o] = this.listen(e, o, void 0) : o.charCodeAt(0) === m.DollarSign && (s[o] = async (...a) => (await n?.(), this.sendMessage(e, o, a)))), s[o])
    };
  ...
  _handleRequestMessage(e) {
    ...
    this._handler.handleMessage(e.channel, e.method, e.args).then((s) => {
      this._send(new ki(this._workerId, n, s, void 0));
    }, (s) => {
      s.detail instanceof Error && (s.detail = Yt(s.detail)), this._send(new ki(this._workerId, n, void 0, Yt(s)));
    });
  }
  _handleSubscribeEventMessage(e) {
    const n = e.req, i = this._handler.handleEvent(e.channel, e.eventName, e.arg)((s) => {
      this._send(new So(this._workerId, n, s));
    });
  ...
  _send(e) {
    const n = [];
    if (e.type === ne.Request)
      for (let i = 0; i < e.args.length; i++)
        e.args[i] instanceof ArrayBuffer && n.push(e.args[i]);
    else e.type === ne.Reply && e.res instanceof ArrayBuffer && n.push(e.res);
    this._handler.sendMessage(e, n);
  }
}
function is(t) {
  return t[0] === "o" && t[1] === "n" && Hi(t.charCodeAt(2));
}
function ss(t) {
  return /^onDynamic/.test(t) && Hi(t.charCodeAt(9));
}
class Oo {
  constructor(e, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new ko({
      ...
      handleMessage: (i, s, o) => this._handleMessage(i, s, o),
      handleEvent: (i, s, o) => this._handleEvent(i, s, o)
  ...
  _handleMessage(e, n, i) {
    ...
    const s = e === qt ? this.requestHandler : this._localChannels.get(e);
    if (!s)
    ...
    try {
      return Promise.resolve(s[n].apply(s, i));
    } catch (o) {
