...
class Ma {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(t) {
      setTimeout(() => {
        throw t.stack ? Ut.isErrorNoTelemetry(t) ? new Ut(t.message + `
...
function qn(e) {
  if (e instanceof Error) {
    ...
    return {
      ...
      message: n,
      stack: r,
      noTelemetry: Ut.isErrorNoTelemetry(e),
      cause: i ? qn(i) : void 0,
      code: e.code
    };
  }
...
const Hn = "Canceled";
function Da(e) {
  return e instanceof ka ? !0 : e instanceof Error && e.name === Hn && e.message === Hn;
}
...
const Nt = class Nt extends Error {
  static is(t) {
    return t instanceof Nt || t instanceof Error && t.name === Nt._name;
  }
  constructor(t) {
    super(t), this.name = Nt._name;
  }
};
Nt._name = "PendingMigrationError";
let Ei = Nt;
...
const xt = class xt {
  ...
  filter(t) {
    return new xt((n) => this.iterate((i) => t(i) ? n(i) : !0));
  }
  map(t) {
    return new xt((n) => this.iterate((i) => n(t(i))));
  }
  some(t) {
    let n = !1;
...
const at = class at {
  constructor(t, n) {
    if (this[vi] = "ResourceMap", t instanceof at)
  ...
  set(t, n) {
    return this.map.set(this.toKey(t), new Ha(t, n)), this;
  }
  get(t) {
...
class Ga {
  ...
  get(t, n = pe.None) {
    ...
    if (i)
      return n !== pe.None && this.touch(i, n), i.value;
  }
  set(t, n, i = pe.None) {
    let r = this._map.get(t);
    if (r)
      r.value = n, i !== pe.None && this.touch(r, i);
    else {
...
class $a extends Ga {
  ...
  peek(t) {
    return super.get(t, pe.None);
  }
  set(t, n) {
    return super.set(t, n, pe.AsNew), this;
  }
  checkTrim() {
...
function Ya(e, t = "unexpected state") {
  if (!e)
...
(function(e) {
  ...
  e.length = R;
  function* v(E, A, U = E.length) {
    for (A < -E.length && (A = 0), A < 0 && (A += E.length), U < 0 ? U += E.length : U > E.length && (U = E.length); A < U; A++)
      yield E[A];
  }
  e.slice = v;
  function k(E, A = Number.POSITIVE_INFINITY) {
    const U = [];
    if (A === 0)
      return [U, E];
...
const Ca = globalThis.performance.now.bind(globalThis.performance);
class Sn {
  static create(t) {
    return new Sn(t);
  }
  constructor(t) {
    this._now = t === !1 ? Date.now : Ca, this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(F) {
    return (T, P = null, S) => {
      ...
      return Y = F((K) => {
        if (!H)
          return Y ? Y.dispose() : H = !0, T.call(P, K);
      }, null, S), H && Y.dispose(), Y;
    };
  }
  e.once = n;
  function i(F, T) {
  ...
  e.onceIf = i;
  function r(F, T, P) {
    return m((S, H = null, Y) => F((K) => S.call(H, T(K)), null, Y), P);
  }
  e.map = r;
  function s(F, T, P) {
    return m((S, H = null, Y) => F((K) => {
      T(K), S.call(H, K);
    }, null, Y), P);
  }
  e.forEach = s;
  function a(F, T, P) {
    return m((S, H = null, Y) => F((K) => T(K) && S.call(H, K), null, Y), P);
  }
  e.filter = a;
  function u(F) {
    return F;
  ...
  function o(...F) {
    return (T, P = null, S) => {
      const H = Za(...F.map((Y) => Y((K) => T.call(P, K))));
      return h(H, S);
    };
  }
  e.any = o;
  ...
  function m(F, T) {
    ...
    return T?.add(H), H.event;
  }
  function h(F, T) {
    return T instanceof Array ? T.push(F) : T && T.add(F), F;
  }
  function _(F, T, P = 100, S = !1, H = !1, Y, K) {
    let ue, _e, st, rn = 0, Bt;
    const va = {
      leakWarningThreshold: Y,
      onWillAddFirstListener() {
        ue = F((ya) => {
          rn++, _e = T(_e, ya), S && !st && (sn.fire(_e), _e = void 0), Bt = () => {
            const Ta = _e;
            _e = void 0, st = void 0, (!S || rn > 1) && sn.fire(Ta), rn = 0;
          }, typeof P == "number" ? (st && clearTimeout(st), st = setTimeout(Bt, P)) : st === void 0 && (st = null, queueMicrotask(Bt));
        });
      },
      ...
      onDidRemoveLastListener() {
        Bt = void 0, ue.dispose();
      }
    }, sn = new ye(va);
    return K?.add(sn), sn.event;
  }
  e.debounce = _;
  function L(F, T = 0, P) {
    return e.debounce(F, (S, H) => S ? (S.push(H), S) : [H], T, void 0, !0, void 0, P);
  }
  e.accumulate = L;
  function d(F, T = (S, H) => S === H, P) {
    let S = !0, H;
    return a(F, (Y) => {
      const K = S || !T(Y, H);
      return S = !1, H = Y, K;
  ...
  e.split = p;
  function x(F, T = !1, P = [], S) {
    let H = P.slice(), Y = F((_e) => {
      H ? H.push(_e) : ue.fire(_e);
    });
    S && S.add(Y);
    const K = () => {
      H?.forEach((_e) => ue.fire(_e)), H = null;
    }, ue = new ye({
      onWillAddFirstListener() {
        Y || (Y = F((_e) => ue.fire(_e)), S && S.add(Y));
      },
  ...
  class v {
    ...
    forEach(T) {
      return this.steps.push((P) => (T(P), P)), this;
    }
    filter(T) {
      return this.steps.push((P) => T(P) ? P : R), this;
    }
    reduce(T, P) {
      let S = P;
      return this.steps.push((H) => (S = T(S, H), S)), this;
    }
    latch(T = (P, S) => P === S) {
      let P = !0, S;
      return this.steps.push((H) => {
        const Y = P || !T(H, S);
        return P = !1, S = H, Y ? H : R;
      }), this;
    }
    evaluate(T) {
  ...
  function k(F, T, P = (S) => S) {
    const S = (...ue) => K.fire(P(...ue)), H = () => F.on(T, S), Y = () => F.removeListener(T, S), K = new ye(
      { onWillAddFirstListener: H, onDidRemoveLastListener: Y }
    );
    return K.event;
  }
  e.fromNodeEventEmitter = k;
  function B(F, T, P = (S) => S) {
    const S = (...ue) => K.fire(P(...ue)), H = () => F.addEventListener(T, S), Y = () => F.removeEventListener(T, S), K = new ye(
      { onWillAddFirstListener: H, onDidRemoveLastListener: Y }
    );
    return K.event;
  }
  ...
  function X(F, T) {
    let P;
    const S = new Promise((H, Y) => {
      const K = n(F)(H, null, T);
      P = () => K.dispose();
    });
    return S.cancel = P, S;
  }
  ...
  class W {
    constructor(T, P) {
      ...
      this.emitter = new ye(S), P && P.add(this.emitter);
    }
    beginUpdate(T) {
      this._counter++;
    }
  ...
  function z(F, T) {
    return new W(F, T).emitter.event;
  }
  e.fromObservable = z;
  function G(F) {
    return (T, P, S) => {
      ...
      const K = {
        ...
        endUpdate() {
          H--, H === 0 && (F.reportChanges(), Y && (Y = !1, T.call(P)));
        },
      ...
      F.addObserver(K), F.reportChanges();
      const ue = {
        dispose() {
          F.removeObserver(K);
        }
...
class In {
  constructor(t) {
    this.value = t, this.id = il++;
  }
}
const rl = 2;
class ye {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new jn(
      t?.onListenerError ?? Wt,
      this._options?.leakWarningThreshold ?? el
    ) : void 0, this._perfMon = this._options?._profName ? new zn(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(u);
        const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new nl(
          `${u}. HINT: Stack shows most frequent listener (${o[1]}-times)`,
          o[0]
        );
        return (this._options?.onListenerError || Wt)(c), Ft.None;
      }
      if (this._disposed)
        return Ft.None;
      n && (t = t.bind(n));
      const r = new In(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = _i.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof In ? (this._deliveryQueue ??= new sl(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
      const a = Jt(() => {
  ...
  _removeListener(t) {
    ...
    if (this._size * rl <= n.length) {
      let s = 0;
      for (let a = 0; a < n.length; a++)
        n[a] ? n[s++] = n[a] : r && s < this._deliveryQueue.end && (this._deliveryQueue.end--, s < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = s;
    }
  }
  _deliver(t, n) {
    if (!t)
      return;
    const i = this._options?.onListenerError || Wt;
    if (!i) {
      t.value(n);
      return;
    }
  ...
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof In)
...
const ll = Cs() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function Ti(e, t) {
  let n;
  ...
  }), ll && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function q(e, t, ...n) {
  return Ti(typeof e == "number" ? ul(e, t) : t, n);
}
function ul(e, t) {
  const n = al()?.[e];
  if (typeof n != "string") {
...
const dt = "en";
let Kt = !1, Ct = !1, cn = !1, ea = !1, pi = !1, ta = !1, an, mn = dt, Mi = dt, ol, ze;
const Qe = globalThis;
let Re;
typeof Qe.vscode < "u" && typeof Qe.vscode.process < "u" ? Re = Qe.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (Re = process);
const cl = typeof Re?.versions?.electron == "string", ml = cl && Re?.type === "renderer";
if (typeof Re == "object") {
  Kt = Re.platform === "win32", Ct = Re.platform === "darwin", cn = Re.platform === "linux", cn && Re.env.SNAP && Re.env.SNAP_REVISION, Re.env.CI || Re.env.BUILD_ARTIFACTSTAGINGDIRECTORY || Re.env.GITHUB_WORKSPACE, an = dt, mn = dt;
  const e = Re.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      an = t.userLocale, Mi = t.osLocale, mn = t.resolvedLanguage || dt, ol = t.languagePack?.translationsConfigFile;
    } catch {
    }
  ea = !0;
} else typeof navigator == "object" && !ml ? (ze = navigator.userAgent, Kt = ze.indexOf("Windows") >= 0, Ct = ze.indexOf("Macintosh") >= 0, ta = (ze.indexOf("Macintosh") >= 0 || ze.indexOf("iPad") >= 0 || ze.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, cn = ze.indexOf("Linux") >= 0, ze?.indexOf("Mobi") >= 0, pi = !0, mn = Cs() || dt, an = navigator.language.toLowerCase(), Mi = an) : console.error("Unable to resolve platform.");
var Tt;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(Tt || (Tt = {}));
Tt.Web;
Ct ? Tt.Mac : Kt ? Tt.Windows : cn && Tt.Linux;
const St = Kt, hl = Ct, fl = ea, gl = pi, _l = pi && typeof Qe.importScripts == "function", pl = _l ? Qe.origin : void 0, He = ze, Ze = mn;
var Ui;
(function(e) {
  function t() {
    return Ze;
...
const bl = typeof Qe.postMessage == "function" && !Qe.importScripts;
(() => {
  if (bl) {
    const e = [];
...
Ct || ta ? $t.Macintosh : Kt ? $t.Windows : $t.Linux;
const dl = !!(He && He.indexOf("Chrome") >= 0);
He && He.indexOf("Firefox") >= 0;
!dl && He && He.indexOf("Safari") >= 0;
He && He.indexOf("Edg/") >= 0;
...
class hn {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? na : (this._emitter || (this._emitter = new ye()), this._emitter.event);
  }
  dispose() {
...
class wl {
  ...
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof hn && this._token.dispose() : this._token = wn.None;
  }
}
function Ll(e) {
  return e;
...
class Nl {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = Ll) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
function yl(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
...
function ra(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
    let o = e.charCodeAt(n), c = t.charCodeAt(r);
    if (o === c)
      continue;
    if (o >= 128 || c >= 128)
      return yl(e.toLowerCase(), t.toLowerCase(), n, i, r, s);
    Fi(o) && (o -= 32), Fi(c) && (c -= 32);
    const m = o - c;
    if (m !== 0)
      return m;
...
function Tl(e, t) {
  return e.length === t.length && ra(e, t) === 0;
}
function Ml(e, t) {
  const n = t.length;
  return t.length > e.length ? !1 : ra(e, t, 0, n) === 0;
}
function Ln(e, t) {
...
Pe.ambiguousCharacterData = new Di(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), Pe.cache = new Nl({ getCacheKey: JSON.stringify }, (t) => {
  ...
  return new Pe(c);
}), Pe._locales = new Di(() => Object.keys(Pe.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let en = Pe;
const lt = class lt {
  static getRawData() {
  ...
  static getData() {
    return this._data || (this._data = new Set([...Object.values(lt.getRawData())].flat())), this._data;
  }
  ...
  static containsInvisibleCharacter(t) {
    for (let n = 0; n < t.length; n++) {
      const i = t.codePointAt(n);
      if (typeof i == "number" && (lt.isInvisibleCharacter(i) || i === Yn.space))
        return !0;
    }
    return !1;
  }
...
lt._data = void 0;
let zt = lt;
const Pn = "default", Il = "$initialize";
var Ee;
(function(e) {
...
class ql {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new Pl(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new ye({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new Bl(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(r), this._send(new Vl(this._workerId, r)), r = null;
      }
    });
    return s.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (la(s) ? r[s] = (a) => this.listen(t, s, a) : aa(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === w.DollarSign && (r[s] = async (...a) => (await n?.(), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new Ol(this._workerId, n, r));
    });
...
class Hl {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new ql({
      sendMessage: (i, r) => {
        t(i, r);
      },
...
class nt {
  ...
  ComputeDiffRecursive(t, n, i, r, s) {
    ...
    if (t > n || i > r) {
      let h;
      return i <= r ? (ft.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), h = [
        new Ce(t, 0, i, r - i + 1)
      ]) : t <= n ? (ft.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), h = [
        new Ce(t, n - t + 1, i, 0)
      ]) : (ft.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), ft.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), h = []), h;
    }
  ...
  WALKTRACE(t, n, i, r, s, a, u, o, c, m, h, _, L, d, p, x, y, R) {
    let v = null, k = null, B = new Vi(), X = n, E = i, A = L[0] - x[0] - r, U = Ue.MIN_SAFE_SMALL_INTEGER, W = this.m_forwardHistory.length - 1;
    do {
      const z = A + t;
      z === X || z < E && c[z - 1] < c[z + 1] ? (h = c[z + 1], d = h - A - r, h < U && B.MarkNextChange(), U = h, B.AddModifiedElement(h + 1, d), A = z + 1 - t) : (h = c[z - 1] + 1, d = h - A - r, h < U && B.MarkNextChange(), U = h - 1, B.AddOriginalElement(h, d + 1), A = z - 1 - t), W >= 0 && (c = this.m_forwardHistory[W], t = c[0], X = 1, E = c.length - 1);
    } while (--W >= -1);
    if (v = B.getReverseChanges(), R[0]) {
      let z = L[0] + 1, G = x[0] + 1;
      if (v !== null && v.length > 0) {
        const F = v[v.length - 1];
        z = Math.max(z, F.getOriginalEnd()), G = Math.max(G, F.getModifiedEnd());
      }
      k = [
        new Ce(
          z,
      ...
      B = new Vi(), X = a, E = u, A = L[0] - x[0] - o, U = Ue.MAX_SAFE_SMALL_INTEGER, W = y ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const z = A + s;
        z === X || z < E && m[z - 1] >= m[z + 1] ? (h = m[z + 1] - 1, d = h - A - o, h > U && B.MarkNextChange(), U = h + 1, B.AddOriginalElement(h + 1, d + 1), A = z + 1 - s) : (h = m[z - 1], d = h - A - o, h > U && B.MarkNextChange(), U = h, B.AddModifiedElement(h + 1, d + 1), A = z - 1 - s), W >= 0 && (m = this.m_reverseHistory[W], s = m[0], X = 1, E = m.length - 1);
      } while (--W >= -1);
      k = B.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, i, r, s, a, u) {
    ...
    const d = n - t + (r - i), p = d + 1, x = new Int32Array(p), y = new Int32Array(p), R = r - i, v = n - t, k = t - i, B = n - r, E = (v - R) % 2 === 0;
    x[R] = t, y[v] = n, u[0] = !1;
    for (let A = 1; A <= d / 2 + 1; A++) {
      let U = 0, W = 0;
      m = this.ClipDiagonalBound(R - A, A, R, p), h = this.ClipDiagonalBound(R + A, A, R, p);
      for (let G = m; G <= h; G += 2) {
        G === m || G < h && x[G - 1] < x[G + 1] ? o = x[G + 1] : o = x[G - 1] + 1, c = o - (G - R) - k;
        const F = o;
        for (; o < n && c < r && this.ElementsAreEqual(o + 1, c + 1); )
          o++, c++;
        if (x[G] = o, o + c > U + W && (U = o, W = c), !E && Math.abs(G - v) <= A - 1 && o >= y[G])
          return s[0] = o, a[0] = c, F <= y[G] && je.MaxDifferencesHistory > 0 && A <= je.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, m, h, k, v, _, L, B, x, y, o, n, s, c, r, a, E, u) : null;
      }
      const z = (U - t + (W - i) - A) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(U, z))
        return u[0] = !0, s[0] = U, a[0] = W, z > 0 && je.MaxDifferencesHistory > 0 && A <= je.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, m, h, k, v, _, L, B, x, y, o, n, s, c, r, a, E, u) : (t++, i++, [
          new Ce(
            t,
            n - t + 1,
            i,
      ...
      for (let G = _; G <= L; G += 2) {
        ...
        for (; o > t && c > i && this.ElementsAreEqual(o, c); )
          o--, c--;
        if (y[G] = o, E && Math.abs(G - R) <= A && o <= x[G])
          return s[0] = o, a[0] = c, F >= x[G] && je.MaxDifferencesHistory > 0 && A <= je.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, m, h, k, v, _, L, B, x, y, o, n, s, c, r, a, E, u) : null;
      }
      if (A <= je.MaxDifferencesHistory) {
        let G = new Int32Array(h - m + 2);
        G[0] = R - m + 1, gt.Copy2(x, m, G, 1, h - m + 1), this.m_forwardHistory.push(G), G = new Int32Array(L - _ + 2), G[0] = v - _ + 1, gt.Copy2(y, _, G, 1, L - _ + 1), this.m_reverseHistory.push(G);
      }
    }
    return this.WALKTRACE(R, m, h, k, v, _, L, B, x, y, o, n, s, c, r, a, E, u);
  }
  PrettifyChanges(t) {
    for (let n = 0; n < t.length; n++) {
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        ...
        if (a < 5 && c < 20 && _ < 20) {
          ...
          if (L) {
            const [d, p] = L;
            (d !== r.originalStart + r.originalLength || p !== r.modifiedStart + r.modifiedLength) && (r.originalLength = d - r.originalStart, r.modifiedLength = p - r.modifiedStart, s.originalStart = d + a, s.modifiedStart = p + a, s.originalLength = o - s.originalStart, s.modifiedLength = h - s.modifiedStart);
          }
        }
      }
    return t;
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], i)) {
      ...
      return gt.Copy(t, 0, r, 0, t.length - 1), r[t.length - 1] = i[0], gt.Copy(n, 1, r, t.length, n.length - 1), r;
    } else {
      const r = new Array(t.length + n.length);
      return gt.Copy(t, 0, r, 0, t.length), gt.Copy(n, 0, r, t.length, n.length), r;
    }
  }
...
class Xl {
  ...
  nextState(t, n) {
    return n < 0 || n >= this._maxCharCode ? V.Invalid : this._states.get(t, n);
  }
}
let Bn = null;
function Yl() {
  return Bn === null && (Bn = new Xl([
    [V.Start, w.h, V.H],
    [V.Start, w.H, V.H],
    [V.Start, w.f, V.F],
    [V.Start, w.F, V.F],
    ...
    [V.HTT, w.p, V.HTTP],
    [V.HTT, w.P, V.HTTP],
    [V.HTTP, w.s, V.BeforeColon],
    [V.HTTP, w.S, V.BeforeColon],
    [V.HTTP, w.Colon, V.AfterColon],
    [V.F, w.i, V.FI],
    [V.F, w.I, V.FI],
    [V.FI, w.l, V.FIL],
    [V.FI, w.L, V.FIL],
    [V.FIL, w.e, V.BeforeColon],
    [V.FIL, w.E, V.BeforeColon],
    [V.BeforeColon, w.Colon, V.AfterColon],
    [V.AfterColon, w.Slash, V.AlmostThere],
    [V.AlmostThere, w.Slash, V.End]
  ])), Bn;
}
var ne;
(function(e) {
        ...
        if (_ === V.Accept) {
          ...
          switch (R) {
            ...
            case w.CloseSquareBracket:
              p = !1, v = d ? ne.None : ne.ForceTermination;
              break;
            case w.OpenCurlyBrace:
              x = !0, v = ne.None;
              break;
            case w.CloseCurlyBrace:
              v = x ? ne.None : ne.ForceTermination;
              break;
            case w.SingleQuote:
            case w.DoubleQuote:
            case w.BackTick:
          ...
          let v;
          R === w.OpenSquareBracket ? (d = !0, v = ne.None) : v = i.get(R), v === ne.ForceTermination ? y = !0 : _ = V.Accept;
        } else
          _ = n.nextState(_, R), _ === V.Invalid && (y = !0);
        y && (_ = V.Start, L = !1, d = !1, x = !1, m = c + 1, h = R), c++;
      }
      _ === V.Accept && r.push(xn._createLink(i, u, s, m, o));
    }
    return r;
  }
}
...
const fn = new di(), Zn = new di(), Kn = new di(), Zl = new Array(230), Kl = /* @__PURE__ */ Object.create(null), Cl = /* @__PURE__ */ Object.create(null), Cn = [];
...
(function() {
  ...
  for (const r of t) {
    ...
    if (i[a] || (i[a] = !0, Kl[u] = a, Cl[u.toLowerCase()] = a, s && o !== f.Unknown && o !== f.Enter && o !== f.Ctrl && o !== f.Shift && o !== f.Alt && o !== f.Meta && (Cn[o] = a)), !n[o]) {
      if (n[o] = !0, !c)
        throw new Error(
...
if (typeof On < "u" && typeof On.process < "u") {
  ...
  get platform() {
    return St ? "win32" : hl ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
const Rn = ct.cwd, tu = ct.env, nu = ct.platform;
ct.arch;
const iu = 65, ru = 97, su = 90, au = 122, mt = 46, oe = 47, Ne = 92, We = 58, lu = 63;
...
function uu(e, t) {
  if (e === null || typeof e != "object")
    throw new ua(t, "Object", e);
}
function se(e, t) {
  if (typeof e != "string")
    throw new ua(t, "string", e);
}
const Ie = nu === "win32";
function j(e) {
  return e === oe || e === Ne;
...
function oa(e, t) {
  uu(t, "pathObject");
  const n = t.dir || t.root, i = t.base || `${t.name || ""}${ou(t.ext)}`;
...
const me = {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (r >= 0) {
        if (s = e[r], se(s, `paths[${r}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = Rn() : (s = tu[`=${t}`] || Rn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === Ne) && (s = `${t}\\`));
      const a = s.length;
      let u = 0, o = "", c = !1;
      ...
      if (a === 1)
        ...
        if (c = !0, j(s.charCodeAt(1))) {
          let h = 2, _ = h;
          for (; h < a && !j(s.charCodeAt(h)); )
            h++;
          if (h < a && h !== _) {
            const L = s.slice(_, h);
            for (_ = h; h < a && j(s.charCodeAt(h)); )
              h++;
            if (h < a && h !== _) {
              for (_ = h; h < a && !j(s.charCodeAt(h)); )
                h++;
          ...
          u = 1;
      else Ge(m) && s.charCodeAt(1) === We && (o = s.slice(0, 2), u = 2, a > 2 && j(s.charCodeAt(2)) && (c = !0, u = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (j(s))
      if (r = !0, j(e.charCodeAt(1))) {
        ...
        n = 1;
    else Ge(s) && e.charCodeAt(1) === We && (i = e.slice(0, 2), n = 2, t > 2 && j(e.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < t ? En(e.slice(n), !r, "\\", j) : "";
    if (a.length === 0 && !r && (a = "."), a.length > 0 && j(e.charCodeAt(t - 1)) && (a += "\\"), !r && i === void 0 && e.includes(":")) {
      if (a.length >= 2 && Ge(a.charCodeAt(0)) && a.charCodeAt(1) === We)
        return `.\\${a}`;
      let u = e.indexOf(":");
      do
        if (u === t - 1 || j(e.charCodeAt(u + 1)))
          return `.\\${a}`;
  ...
  isAbsolute(e) {
    ...
    return j(n) || t > 2 && Ge(n) && e.charCodeAt(1) === We && j(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    if (typeof n == "string" && j(n.charCodeAt(0))) {
      ++r;
      const s = n.length;
      s > 1 && j(n.charCodeAt(1)) && (++r, s > 2 && (j(n.charCodeAt(2)) ? ++r : i = !1));
    }
    if (i) {
  ...
  relative(e, t) {
    ...
    if (n.length !== e.length || i.length !== t.length) {
      const d = n.split("\\"), p = i.split("\\");
      d[d.length - 1] === "" && d.pop(), p[p.length - 1] === "" && p.pop();
      const x = d.length, y = p.length, R = x < y ? x : y;
      let v;
      for (v = 0; v < R && d[v].toLowerCase() === p[v].toLowerCase(); v++)
        ;
      return v === 0 ? i : v === R ? y > R ? p.slice(v).join("\\") : x > R ? "..\\".repeat(x - 1 - v) + ".." : "" : "..\\".repeat(x - v) + p.slice(v).join("\\");
    }
    let r = 0;
    for (; r < e.length && e.charCodeAt(r) === Ne; )
      r++;
    let s = e.length;
    for (; s - 1 > r && e.charCodeAt(s - 1) === Ne; )
      s--;
    const a = s - r;
    let u = 0;
    for (; u < t.length && t.charCodeAt(u) === Ne; )
      u++;
    let o = t.length;
    for (; o - 1 > u && t.charCodeAt(o - 1) === Ne; )
      o--;
    ...
    if (_ !== m) {
      ...
      if (c > m) {
        if (t.charCodeAt(u + _) === Ne)
          return i.slice(u + _ + 1);
        if (_ === 2)
          return i.slice(u + _);
      }
      a > m && (e.charCodeAt(r + _) === Ne ? h = _ : _ === 2 && (h = 3)), h === -1 && (h = 0);
    }
    let L = "";
    for (_ = r + h + 1; _ <= s; ++_)
      (_ === s || e.charCodeAt(_) === Ne) && (L += L.length === 0 ? ".." : "\\..");
    return u += h, L.length > 0 ? `${L}${i.slice(u, o)}` : (i.charCodeAt(u) === Ne && ++u, i.slice(u, o));
  },
  toNamespacedPath(e) {
    ...
    if (t.length <= 2)
      return e;
    if (t.charCodeAt(0) === Ne) {
      if (t.charCodeAt(1) === Ne) {
        const n = t.charCodeAt(2);
        if (n !== lu && n !== mt)
          return `\\\\?\\UNC\\${t.slice(2)}`;
      }
    } else if (Ge(t.charCodeAt(0)) && t.charCodeAt(1) === We && t.charCodeAt(2) === Ne)
      return `\\\\?\\${t}`;
    return t;
  },
  dirname(e) {
    ...
    } else Ge(r) && e.charCodeAt(1) === We && (n = t > 2 && j(e.charCodeAt(2)) ? 3 : 2, i = n);
    let s = -1, a = !0;
    for (let u = t - 1; u >= i; --u)
      if (j(e.charCodeAt(u))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, i = -1, r = !0, s;
    if (e.length >= 2 && Ge(e.charCodeAt(0)) && e.charCodeAt(1) === We && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === We && Ge(e.charCodeAt(0)) && (t = i = 2);
    for (let u = e.length - 1; u >= t; --u) {
      ...
      r === -1 && (s = !1, r = u + 1), o === mt ? n === -1 ? n = u : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
  ...
  parse(e) {
    ...
    } else if (Ge(r) && e.charCodeAt(1) === We) {
      if (n <= 2)
    ...
    for (; c >= i; --c) {
      ...
      u === -1 && (o = !1, u = c + 1), r === mt ? s === -1 ? s = c : m !== 1 && (m = 1) : s !== -1 && (m = -1);
    }
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (u = !1, a = o + 1), m === mt ? r === -1 ? r = o : c !== 1 && (c = 1) : r !== -1 && (c = -1);
    }
    if (a !== -1) {
      const m = s === 0 && n ? 1 : s;
...
ee.win32 = me.win32 = me;
ee.posix = me.posix = ee;
const mu = Ie ? me.normalize : ee.normalize;
Ie ? me.isAbsolute : ee.isAbsolute;
const hu = Ie ? me.join : ee.join, fu = Ie ? me.resolve : ee.resolve, gu = Ie ? me.relative : ee.relative, _u = Ie ? me.dirname : ee.dirname;
Ie ? me.basename : ee.basename;
Ie ? me.extname : ee.extname;
Ie ? me.parse : ee.parse;
const gn = Ie ? me.sep : ee.sep, pu = /^\w[\w\d+.-]*$/, bu = /^\//, du = /^\/\//;
function wu(e, t) {
  if (!e.scheme && t)
    throw new Error(
      `[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`
    );
  if (e.scheme && !pu.test(e.scheme))
...
class ce {
  static isUri(t) {
    return t instanceof ce ? !0 : !t || typeof t != "object" ? !1 : typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function";
  }
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || C, this.authority = t.authority || C, this.path = t.path || C, this.query = t.query || C, this.fragment = t.fragment || C) : (this.scheme = Lu(t, a), this.authority = n || C, this.path = Nu(this.scheme, i || C), this.query = r || C, this.fragment = s || C, wu(this, a));
  }
  get fsPath() {
    return An(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = C), i === void 0 ? i = this.authority : i === null && (i = C), r === void 0 ? r = this.path : r === null && (r = C), s === void 0 ? s = this.query : s === null && (s = C), a === void 0 ? a = this.fragment : a === null && (a = C), n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new _t(n, i, r, s, a);
  }
  static parse(t, n = !1) {
    const i = xu.exec(t);
    return i ? new _t(
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return St && t.scheme === "file" ? i = ce.file(me.join(An(t, !0), ...n)).path : i = ee.join(t.path, ...n), t.with({ path: i });
  }
  toString(t = !1) {
    return ni(this, t);
  }
...
function Ru(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === w.Hash || i === w.QuestionMark ? (t === void 0 && (t = e.substr(0, n)), t += ma[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function An(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === w.Slash && (e.path.charCodeAt(1) >= w.A && e.path.charCodeAt(1) <= w.Z || e.path.charCodeAt(1) >= w.a && e.path.charCodeAt(1) <= w.z) && e.path.charCodeAt(2) === w.Colon ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, St && (n = n.replace(/\//g, "\\")), n;
}
function ni(e, t) {
  const n = t ? Ru : Wi;
...
function ha(e) {
  try {
    ...
    return e.length > 3 ? e.substr(0, 3) + ha(e.substr(3)) : e;
  }
}
const Gi = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function ln(e) {
  return e.match(Gi) ? e.replace(Gi, (t) => ha(t)) : e;
}
var et;
(function(e) {
...
(function(e) {
  ...
  t.set(N.Method, O.symbolMethod), t.set(N.Function, O.symbolFunction), t.set(N.Constructor, O.symbolConstructor), t.set(N.Field, O.symbolField), t.set(N.Variable, O.symbolVariable), t.set(N.Class, O.symbolClass), t.set(N.Struct, O.symbolStruct), t.set(N.Interface, O.symbolInterface), t.set(N.Module, O.symbolModule), t.set(N.Property, O.symbolProperty), t.set(N.Event, O.symbolEvent), t.set(N.Operator, O.symbolOperator), t.set(N.Unit, O.symbolUnit), t.set(N.Value, O.symbolValue), t.set(N.Enum, O.symbolEnum), t.set(N.Constant, O.symbolConstant), t.set(N.Enum, O.symbolEnum), t.set(N.EnumMember, O.symbolEnumMember), t.set(N.Keyword, O.symbolKeyword), t.set(N.Snippet, O.symbolSnippet), t.set(N.Text, O.symbolText), t.set(N.Color, O.symbolColor), t.set(N.File, O.symbolFile), t.set(N.Reference, O.symbolReference), t.set(N.Customcolor, O.symbolCustomColor), t.set(N.Folder, O.symbolFolder), t.set(N.TypeParameter, O.symbolTypeParameter), t.set(N.User, O.account), t.set(N.Issue, O.issues), t.set(N.Tool, O.tools);
  function n(a) {
    let u = t.get(a);
  ...
  r.set("method", N.Method), r.set("function", N.Function), r.set("constructor", N.Constructor), r.set("field", N.Field), r.set("variable", N.Variable), r.set("class", N.Class), r.set("struct", N.Struct), r.set("interface", N.Interface), r.set("module", N.Module), r.set("property", N.Property), r.set("event", N.Event), r.set("operator", N.Operator), r.set("unit", N.Unit), r.set("value", N.Value), r.set("constant", N.Constant), r.set("enum", N.Enum), r.set("enum-member", N.EnumMember), r.set("enumMember", N.EnumMember), r.set("keyword", N.Keyword), r.set("snippet", N.Snippet), r.set("text", N.Text), r.set("color", N.Color), r.set("file", N.File), r.set("reference", N.Reference), r.set("customcolor", N.Customcolor), r.set("folder", N.Folder), r.set("type-parameter", N.TypeParameter), r.set("typeParameter", N.TypeParameter), r.set("account", N.User), r.set("issue", N.Issue), r.set("tool", N.Tool);
  function s(a, u) {
    let o = r.get(a);
    return typeof o > "u" && !u && (o = N.Property), o;
  }
  e.fromString = s;
})(Ji || (Ji = {}));
var Zi;
...
M.Array + "", q(815, "array"), M.Boolean + "", q(816, "boolean"), M.Class + "", q(817, "class"), M.Constant + "", q(818, "constant"), M.Constructor + "", q(819, "constructor"), M.Enum + "", q(820, "enumeration"), M.EnumMember + "", q(821, "enumeration member"), M.Event + "", q(822, "event"), M.Field + "", q(823, "field"), M.File + "", q(824, "file"), M.Function + "", q(825, "function"), M.Interface + "", q(826, "interface"), M.Key + "", q(827, "key"), M.Method + "", q(828, "method"), M.Module + "", q(829, "module"), M.Namespace + "", q(830, "namespace"), M.Null + "", q(831, "null"), M.Number + "", q(832, "number"), M.Object + "", q(833, "object"), M.Operator + "", q(834, "operator"), M.Package + "", q(835, "package"), M.Property + "", q(836, "property"), M.String + "", q(837, "string"), M.Struct + "", q(838, "struct"), M.TypeParameter + "", q(839, "type parameter"), M.Variable + "", q(840, "variable");
var lr;
(function(e) {
  e[e.Deprecated = 1] = "Deprecated";
})(lr || (lr = {}));
...
(function(e) {
  const t = /* @__PURE__ */ new Map();
  t.set(M.File, O.symbolFile), t.set(M.Module, O.symbolModule), t.set(M.Namespace, O.symbolNamespace), t.set(M.Package, O.symbolPackage), t.set(M.Class, O.symbolClass), t.set(M.Method, O.symbolMethod), t.set(M.Property, O.symbolProperty), t.set(M.Field, O.symbolField), t.set(M.Constructor, O.symbolConstructor), t.set(M.Enum, O.symbolEnum), t.set(M.Interface, O.symbolInterface), t.set(M.Function, O.symbolFunction), t.set(M.Variable, O.symbolVariable), t.set(M.Constant, O.symbolConstant), t.set(M.String, O.symbolString), t.set(M.Number, O.symbolNumber), t.set(M.Boolean, O.symbolBoolean), t.set(M.Array, O.symbolArray), t.set(M.Object, O.symbolObject), t.set(M.Key, O.symbolKey), t.set(M.Null, O.symbolNull), t.set(M.EnumMember, O.symbolEnumMember), t.set(M.Struct, O.symbolStruct), t.set(M.Event, O.symbolEvent), t.set(M.Operator, O.symbolOperator), t.set(M.TypeParameter, O.symbolTypeParameter);
  function n(s) {
    let a = t.get(s);
  ...
  i.set(M.File, N.File), i.set(M.Module, N.Module), i.set(M.Namespace, N.Module), i.set(M.Package, N.Module), i.set(M.Class, N.Class), i.set(M.Method, N.Method), i.set(M.Property, N.Property), i.set(M.Field, N.Field), i.set(M.Constructor, N.Constructor), i.set(M.Enum, N.Enum), i.set(M.Interface, N.Interface), i.set(M.Function, N.Function), i.set(M.Variable, N.Variable), i.set(M.Constant, N.Constant), i.set(M.String, N.Text), i.set(M.Number, N.Value), i.set(M.Boolean, N.Value), i.set(M.Array, N.Value), i.set(M.Object, N.Value), i.set(M.Key, N.Keyword), i.set(M.Null, N.Value), i.set(M.EnumMember, N.EnumMember), i.set(M.Struct, N.Struct), i.set(M.Event, N.Event), i.set(M.Operator, N.Operator), i.set(M.TypeParameter, N.TypeParameter);
  function r(s) {
    let a = i.get(s);
...
At.CtrlCmd = wt.CtrlCmd, At.Shift = wt.Shift, At.Alt = wt.Alt, At.WinCtrl = wt.WinCtrl;
let li = At;
function Mu() {
  return {
    editor: void 0,
    languages: void 0,
    CancellationTokenSource: wl,
    Emitter: ye,
    KeyCode: ii,
    KeyMod: li,
    Position: $,
...
function Du(e, t, n, i, r) {
  ...
  if (e.get(s) !== It.Regular || s === w.CarriageReturn || s === w.LineFeed)
    return !0;
  if (r > 0) {
    const a = t.charCodeAt(i);
    if (e.get(a) !== It.Regular)
      return !0;
  }
  return !1;
}
...
function Fu(e, t, n, i, r) {
  return Du(e, t, n, i, r) && ku(e, t, n, i, r);
}
class Su {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          kl(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || Fu(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
...
function wi(e, t, n, i, r) {
  if (t = ga(t), r || (r = bn.first(_a)), n.length > r.maxLen) {
    let c = e - r.maxLen / 2;
...
class Ou {
  static computeUnicodeHighlights(t, n, i) {
    ...
    let o;
    u === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${Vu(Array.from(u))}`, "g");
    const c = new Su(null, o), m = [];
    let h = !1, _, L = 0, d = 0, p = 0;
    e: for (let x = r, y = s; x <= y; x++) {
      const R = t.getLineContent(x), v = R.length;
      c.reset(0);
      do
        if (_ = c.next(R), _) {
          let k = _.index, B = _.index + _[0].length;
          if (k > 0) {
            const U = R.charCodeAt(k - 1);
            Xn(U) && k--;
          }
          if (B + 1 < v) {
          ...
          const X = R.substring(k, B);
          let E = wi(k + 1, fa, R, 0);
          E && E.endColumn <= k + 1 && (E = null);
          const A = a.shouldHighlightNonBasicASCII(X, E ? E.word : null);
          if (A !== be.None) {
            if (A === be.Ambiguous ? L++ : A === be.Invisible ? d++ : A === be.NonBasicASCII ? p++ : Xa(), m.length >= 1e3) {
              h = !0;
              break e;
            }
            m.push(new D(x, k + 1, x, B + 1));
          }
        }
      while (_);
    }
...
class Ns {
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (this.allowedCodePoints.has(i))
      return be.None;
    if (this.options.nonBasicASCII)
      return be.NonBasicASCII;
    let r = !1, s = !1;
    if (n)
      for (const a of n) {
        const u = a.codePointAt(0), o = Sl(a);
        r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(u) && !zt.isInvisibleCharacter(u) && (s = !0);
      }
    return !r && s ? be.None : this.options.invisibleCharacters && !xs(t) && zt.isInvisibleCharacter(i) ? be.Invisible : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? be.Ambiguous : be.None;
  }
}
function xs(e) {
  return e === " " || e === `
...
class I {
  ...
  delta(t) {
    return new I(this.start + t, this.endExclusive + t);
  }
  deltaStart(t) {
    return new I(this.start + t, this.endExclusive);
  }
  deltaEnd(t) {
    return new I(this.start, this.endExclusive + t);
  }
  get length() {
  ...
  joinRightTouching(t) {
    ...
    return new I(this.start, t.endExclusive);
  }
}
const he = class he {
  static ofLength(t, n) {
  ...
  static fromRangeInclusive(t) {
    return new he(t.startLineNumber, t.endLineNumber + 1);
  }
  static subtract(t, n) {
    return n ? t.startLineNumber < n.startLineNumber && n.endLineNumberExclusive < t.endLineNumberExclusive ? [
      new he(t.startLineNumber, n.startLineNumber),
      new he(n.endLineNumberExclusive, t.endLineNumberExclusive)
    ] : n.startLineNumber <= t.startLineNumber && t.endLineNumberExclusive <= n.endLineNumberExclusive ? [] : n.endLineNumberExclusive < t.endLineNumberExclusive ? [new he(
      Math.max(n.endLineNumberExclusive, t.startLineNumber),
      t.endLineNumberExclusive
    )] : [new he(t.startLineNumber, Math.min(n.startLineNumber, t.endLineNumberExclusive))] : [t];
  }
  static joinMany(t) {
    if (t.length === 0)
      return [];
    let n = new Be(t[0].slice());
    for (let i = 1; i < t.length; i++)
      n = n.getUnion(new Be(t[i].slice()));
    return n.ranges;
  }
  static join(t) {
    if (t.length === 0)
  ...
  deltaLength(t) {
    return new he(this.startLineNumber, this.endLineNumberExclusive + t);
  }
  get length() {
...
he.compareByStart = yt((t) => t.startLineNumber, Gt);
let J = he;
class Be {
  constructor(t = []) {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = Wn(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = kt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  contains(t) {
    const n = Dt(this._normalizedRanges, (i) => i.startLineNumber <= t);
    return !!n && n.endLineNumberExclusive > t;
  }
  intersects(t) {
    const n = Dt(this._normalizedRanges, (i) => i.startLineNumber < t.endLineNumberExclusive);
  ...
  subtractFrom(t) {
    const n = Wn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = kt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Be([t]);
    const r = [];
    ...
    return s < t.endLineNumberExclusive && r.push(new J(s, t.endLineNumberExclusive)), new Be(r);
  }
  toString() {
  ...
  getWithDelta(t) {
    return new Be(this._normalizedRanges.map((n) => n.delta(t)));
  }
}
const xe = class xe {
  static lengthDiffNonNegative(t, n) {
    return n.isLessThan(t) ? xe.zero : t.lineCount === n.lineCount ? new xe(0, n.columnCount - t.columnCount) : new xe(n.lineCount - t.lineCount, n.columnCount);
  }
  static betweenPositions(t, n) {
    return t.lineNumber === n.lineNumber ? new xe(0, n.column - t.column) : new xe(n.lineNumber - t.lineNumber, n.column - 1);
  }
  static fromPosition(t) {
    return new xe(t.lineNumber - 1, t.column - 1);
  }
  static ofRange(t) {
    return xe.betweenPositions(t.getStartPosition(), t.getEndPosition());
  }
  static ofText(t) {
    let n = 0, i = 0;
    for (const r of t)
...
` ? (n++, i = 0) : i++;
  ...
  add(t) {
    return t.lineCount === 0 ? new xe(this.lineCount, this.columnCount + t.columnCount) : new xe(this.lineCount + t.lineCount, t.columnCount);
  }
  createRange(t) {
...
` && (this.lineStartOffsetByLineIdx.push(n + 1), n > 0 && t.charAt(n - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(n - 1) : this.lineEndOffsetByLineIdx.push(n));
  ...
  _validatePosition(t) {
    ...
    if (t.column < 1)
      return new $(t.lineNumber, 1);
    const i = this.getLineLength(t.lineNumber);
    return t.column - 1 > i ? new $(t.lineNumber, i + 1) : t;
  }
  getPosition(t) {
...
class ba {
  ...
  get endPositionExclusive() {
    return this.length.addToPosition(new $(1, 1));
  }
  get lineRange() {
  ...
  getTransformer() {
    return this._transformer || (this._transformer = new pa(this.getValue())), this._transformer;
  }
  getLineAt(t) {
...
class Wu extends ba {
  constructor(t, n) {
    Ya(n >= 1), super(), this._getLineContent = t, this._lineCount = n;
  }
  getValueOfRange(t) {
...
class tn extends ba {
  constructor(t) {
    super(), this.value = t, this._t = new pa(this.value);
  }
  getValueOfRange(t) {
...
class Fe {
  static fromStringEdit(t, n) {
    const i = t.replacements.map((r) => fe.fromStringReplacement(r, n));
    return new Fe(i);
  }
  static replace(t, n) {
    return new Fe([new fe(t, n)]);
  }
  static delete(t) {
    return new Fe([new fe(t, "")]);
  }
  static insert(t, n) {
    return new Fe([new fe(D.fromPositions(t, t), n)]);
  }
  static fromParallelReplacementsUnsorted(t) {
    const n = t.slice().sort(yt((i) => i.range, D.compareRangesUsingStarts));
    return new Fe(n);
  }
  constructor(t) {
  ...
  normalize() {
    ...
    for (const n of this.replacements)
      if (t.length > 0 && t[t.length - 1].range.getEndPosition().equals(n.range.getStartPosition())) {
        ...
        t[t.length - 1] = new fe(i.range.plusRange(n.range), i.text + n.text);
  ...
  mapRange(t) {
    function n(a) {
      return a instanceof $ ? a : a.getStartPosition();
    }
    function i(a) {
      return a instanceof $ ? a : a.getEndPosition();
    }
  ...
  inverse(t) {
    ...
    return new Fe(this.replacements.map((i, r) => new fe(n[r], t.getValueOfRange(i.range))));
  }
  getNewRanges() {
    const t = [];
    let n = 0, i = 0, r = 0;
    for (const s of this.replacements) {
      const a = rt.ofText(s.text), u = $.lift({
  ...
  toReplacement(t) {
    ...
    return new fe(D.fromPositions(n, i), r);
  }
  equals(t) {
    return Zs(this.replacements, t.replacements, (n, i) => n.equals(i));
  }
  toString(t) {
...
`) : typeof t == "string" ? this.toString(new tn(t)) : this.replacements.length === 0 ? "" : this.replacements.map((n) => {
      const r = t.getValueOfRange(n.range), s = D.fromPositions(new $(Math.max(1, n.range.startLineNumber - 1), 1), n.range.getStartPosition());
      let a = t.getValueOfRange(s);
      a.length > 10 && (a = "..." + a.substring(a.length - 10));
      const u = D.fromPositions(n.range.getEndPosition(), new $(n.range.endLineNumber + 1, 1));
...
class fe {
  static joinReplacements(t, n) {
    ...
    return new fe(D.fromPositions(i, r), s);
  }
...
class Me {
  ...
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new Le(new D(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new D(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new Le(new D(
  ...
  toRangeMapping2(t, n) {
    ...
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new Le(D.fromPositions(new $(this.original.startLineNumber, 1), pt(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), D.fromPositions(new $(this.modified.startLineNumber, 1), pt(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new Le(D.fromPositions(pt(new $(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), pt(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), D.fromPositions(pt(new $(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), pt(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ae();
  }
}
function pt(e, t) {
...
class qe extends Me {
  ...
  flip() {
    return new qe(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
...
class Le {
  static fromEdit(t) {
    ...
    return t.replacements.map((r, s) => new Le(r.range, n[s]));
  }
  static fromEditJoin(t) {
    const n = t.getNewRanges(), i = t.replacements.map((r, s) => new Le(r.range, n[s]));
    return Le.join(i);
  }
  static join(t) {
    if (t.length === 0)
  ...
  toTextEdit(t) {
    ...
    return new fe(this.originalRange, n);
  }
  join(t) {
    return new Le(
...
function Es(e, t, n, i = !1) {
  const r = [];
  for (const s of Ia(e.map((a) => Gu(a, t, n)), (a, u) => a.original.intersectsOrTouches(u.original) || a.modified.intersectsOrTouches(u.modified))) {
...
class zu {
  computeDiff(t, n, i) {
    ...
    for (const o of s.changes) {
      let c;
      o.originalEndLineNumber === 0 ? c = new J(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : c = new J(o.originalStartLineNumber, o.originalEndLineNumber + 1);
      let m;
      o.modifiedEndLineNumber === 0 ? m = new J(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : m = new J(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
      let h = new qe(c, m, o.charChanges?.map((_) => new Le(new D(
        _.originalStartLineNumber,
        _.originalStartColumn,
        _.originalEndLineNumber,
        _.originalEndColumn
      ), new D(
        _.modifiedStartLineNumber,
        _.modifiedStartColumn,
        _.modifiedEndLineNumber,
        _.modifiedEndColumn
      ))));
      u && (u.modified.endLineNumberExclusive === h.modified.startLineNumber || u.original.endLineNumberExclusive === h.original.startLineNumber) && (h = new qe(
        u.original.join(h.original),
        u.modified.join(h.modified),
        u.innerChanges && h.innerChanges ? u.innerChanges.concat(h.innerChanges) : void 0
      ), a.pop()), a.push(h), u = h;
    }
    return Qt(() => gi(a, (o, c) => c.original.startLineNumber - o.original.endLineNumberExclusive === c.modified.startLineNumber - o.modified.endLineNumberExclusive && o.original.endLineNumberExclusive < c.original.startLineNumber && o.modified.endLineNumberExclusive < c.modified.startLineNumber)), new _n(a, [], s.quitEarly);
  }
}
function da(e, t, n, i) {
...
function Xu(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    ...
    Math.min(a, u) < $u ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class Xt {
  ...
  static createFromDiffResult(t, n, i, r, s, a, u) {
    ...
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, c = 0) : (o = i.getStartLineNumber(n.originalStart), c = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (m = r.getStartLineNumber(n.modifiedStart) - 1, h = 0) : (m = r.getStartLineNumber(n.modifiedStart), h = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      const L = i.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1), d = r.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
      if (L.getElements().length > 0 && d.getElements().length > 0) {
        let p = da(L, d, s, !0).changes;
        u && (p = Xu(p)), _ = [];
        for (let x = 0, y = p.length; x < y; x++)
          _.push(Mt.createFromDiffChange(p[x], L, d));
      }
    }
    return new Xt(
      o,
...
class wa {
  ...
  computeDiff() {
    ...
    const t = da(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    ...
    for (let u = -1, o = n.length; u < o; u++) {
      ...
      for (; s < m && a < h; ) {
        ...
        if (_ !== L) {
          {
            let d = ui(_, 1), p = ui(L, 1);
            for (; d > 1 && p > 1; ) {
              const x = _.charCodeAt(d - 2), y = L.charCodeAt(p - 2);
              if (x !== y)
                break;
              d--, p--;
            }
          ...
          {
            let d = oi(_, 1), p = oi(L, 1);
            const x = _.length + 1, y = L.length + 1;
            for (; d < x && p < y; ) {
              const R = _.charCodeAt(d - 1), v = _.charCodeAt(p - 1);
              if (R !== v)
                break;
              d++, p++;
            }
            (d < x || p < y) && this._pushTrimWhitespaceCharChange(r, s + 1, d, x, a + 1, p, y);
          }
        }
        s++, a++;
      }
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, u))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new Mt(
      n,
      i,
      n,
      r,
  ...
  _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
    ...
    if (o === 0)
      return !1;
    const c = t[o - 1];
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0 ? !1 : c.originalEndLineNumber === n && c.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new Mt(
      n,
      i,
      n,
      r,
      ...
      s,
      u
    )), !0) : c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === s ? (c.originalEndLineNumber = n, c.modifiedEndLineNumber = s, this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new Mt(
      n,
      i,
      n,
      r,
...
class Je {
  static trivial(t, n) {
    return new Je([new re(I.ofLength(t.length), I.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new Je([new re(I.ofLength(t.length), I.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class re {
  ...
  static fromOffsetPairs(t, n) {
    return new re(new I(t.offset1, n.offset1), new I(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const i of t) {
  ...
  compute(t, n, i = nn.instance, r) {
    ...
    for (let d = 0; d < t.length; d++)
      for (let p = 0; p < n.length; p++) {
        ...
        const x = d === 0 ? 0 : s.get(d - 1, p), y = p === 0 ? 0 : s.get(d, p - 1);
        let R;
        t.getElement(d) === n.getElement(p) ? (d === 0 || p === 0 ? R = 0 : R = s.get(d - 1, p - 1), d > 0 && p > 0 && a.get(d - 1, p - 1) === 3 && (R += u.get(d - 1, p - 1)), R += r ? r(d, p) : 1) : R = -1;
        const v = Math.max(x, y, R);
        if (v === R) {
          const k = d > 0 && p > 0 ? u.get(d - 1, p - 1) : 0;
          u.set(d, p, k + 1), a.set(d, p, 3);
        } else v === x ? (u.set(d, p, 0), a.set(d, p, 1)) : v === y && (u.set(d, p, 0), a.set(d, p, 2));
        s.set(d, p, v);
      }
    const o = [];
    let c = t.length, m = n.length;
    function h(d, p) {
      (d + 1 !== c || p + 1 !== m) && o.push(new re(new I(d + 1, c), new I(p + 1, m))), c = d, m = p;
    }
...
class La {
  compute(t, n, i = nn.instance) {
    ...
    const r = t, s = n;
    function a(p, x) {
      for (; p < r.length && x < s.length && r.getElement(p) === s.getElement(x); )
        p++, x++;
      return p;
    }
    let u = 0;
    ...
    e: for (; ; ) {
      ...
      const p = -Math.min(u, s.length + u % 2), x = Math.min(u, r.length + u % 2);
      for (m = p; m <= x; m += 2) {
        const y = m === x ? -1 : o.get(m + 1), R = m === p ? -1 : o.get(m - 1) + 1, v = Math.min(Math.max(y, R), r.length), k = v - m;
        if (v > r.length || k > s.length)
          continue;
        const B = a(v, k);
        o.set(m, B);
        const X = v === y ? c.get(m + 1) : c.get(m - 1);
        if (c.set(m, B !== v ? new ys(X, v, k, B - v) : X), o.get(m) === r.length && o.get(m) - m === s.length)
          break e;
      }
    }
    let h = c.get(m);
    const _ = [];
    let L = r.length, d = s.length;
    for (; ; ) {
      const p = h ? h.x + h.length : 0, x = h ? h.y + h.length : 0;
      if ((p !== L || x !== d) && _.push(new re(new I(p, L), new I(x, d))), !h)
        break;
      L = h.x, d = h.y, h = h.prev;
    }
...
class Tn {
  ...
  findWordContaining(t) {
    ...
    for (; n > 0 && bt(this.elements[n - 1]); )
      n--;
    let i = t;
    for (; i < this.elements.length && bt(this.elements[i]); )
      i++;
    return new I(n, i);
  }
  findSubWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !bt(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && bt(this.elements[n - 1]) && !Ts(this.elements[n]); )
      n--;
    let i = t;
    for (; i < this.elements.length && bt(this.elements[i]) && !Ts(this.elements[i]); )
      i++;
    return new I(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = Dt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = Sa(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new I(n, i);
  }
}
function bt(e) {
...
function Cu(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: u } = to(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((m) => !u.has(m)), c = no(o, i, r, t, n, s);
  return Oa(a, c), a = io(a), a = a.filter((m) => {
    const h = m.original.toOffsetRange().slice(t).map((L) => L.trim());
    return h.join(`
`).length >= 15 && eo(h, (L) => L.length >= 2) >= 2;
  }), a = ro(e, a), a;
}
function eo(e, t) {
  let n = 0;
...
function no(e, t, n, i, r, s) {
  ...
  for (const _ of e)
    for (let L = _.original.startLineNumber; L < _.original.endLineNumberExclusive - 2; L++) {
      const d = `${t[L - 1]}:${t[L + 1 - 1]}:${t[L + 2 - 1]}`;
      u.add(d, { range: new J(L, L + 3) });
    }
  const o = [];
  e.sort(yt((_) => _.modified.startLineNumber, Gt));
  for (const _ of e) {
    let L = [];
    for (let d = _.modified.startLineNumber; d < _.modified.endLineNumberExclusive - 2; d++) {
      const p = `${n[d - 1]}:${n[d + 1 - 1]}:${n[d + 2 - 1]}`, x = new J(d, d + 3), y = [];
      u.forEach(p, ({ range: R }) => {
        for (const k of L)
          if (k.originalLineRange.endLineNumberExclusive + 1 === R.endLineNumberExclusive && k.modifiedLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive) {
  ...
  o.sort(Va(yt((_) => _.modifiedLineRange.length, Gt)));
  const c = new Be(), m = new Be();
  for (const _ of o) {
    const L = _.modifiedLineRange.startLineNumber - _.originalLineRange.startLineNumber, d = c.subtractFrom(_.modifiedLineRange), p = m.subtractFrom(_.originalLineRange).getWithDelta(L), x = d.getIntersection(p);
  ...
  a.sort(yt((_) => _.original.startLineNumber, Gt));
  const h = new pn(e);
  for (let _ = 0; _ < a.length; _++) {
    const L = a[_], d = h.findLastMonotonous((X) => X.original.startLineNumber <= L.original.startLineNumber), p = Dt(e, (X) => X.modified.startLineNumber <= L.modified.startLineNumber), x = Math.max(L.original.startLineNumber - d.original.startLineNumber, L.modified.startLineNumber - p.modified.startLineNumber), y = h.findLastMonotonous((X) => X.original.startLineNumber < L.original.endLineNumberExclusive), R = Dt(e, (X) => X.modified.startLineNumber < L.modified.endLineNumberExclusive), v = Math.max(y.original.endLineNumberExclusive - L.original.endLineNumberExclusive, R.modified.endLineNumberExclusive - L.modified.endLineNumberExclusive);
    let k;
    for (k = 0; k < x; k++) {
      const X = L.original.startLineNumber - k - 1, E = L.modified.startLineNumber - k - 1;
      if (X > i.length || E > r.length || c.contains(E) || m.contains(X) || !Ds(i[X - 1], r[E - 1], s))
        break;
    }
    ...
    let B;
    for (B = 0; B < v; B++) {
      const X = L.original.endLineNumberExclusive + B, E = L.modified.endLineNumberExclusive + B;
      if (X > i.length || E > r.length || c.contains(E) || m.contains(X) || !Ds(i[X - 1], r[E - 1], s))
        break;
    }
...
function Ds(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new La().compute(new Tn([e], new D(1, 1, 1, e.length), !1), new Tn([t], new D(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function io(e) {
  if (e.length === 0)
    return e;
  e.sort(yt((n) => n.original.startLineNumber, Gt));
  const t = [e[0]];
...
function ro(e, t) {
  const n = new pn(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((u) => u.original.startLineNumber < i.original.endLineNumberExclusive) || new Me(new J(1, 1), new J(1, 1)), s = Dt(e, (u) => u.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function ks(e, t, n) {
  let i = n;
  return i = Fs(e, t, i), i = Fs(e, t, i), i = so(e, t, i), i;
}
function Fs(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= o && !(e.getElement(u.seq1Range.start - c) !== e.getElement(u.seq1Range.endExclusive - c) || t.getElement(u.seq2Range.start - c) !== t.getElement(u.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === o) {
        i[i.length - 1] = new re(new I(a.seq1Range.start, u.seq1Range.endExclusive - o), new I(a.seq2Range.start, u.seq2Range.endExclusive - o));
        continue;
      }
      u = u.delta(-c);
    }
  ...
  for (let s = 0; s < i.length - 1; s++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 0; c < o && !(!e.isStronglyEqual(u.seq1Range.start + c, u.seq1Range.endExclusive + c) || !t.isStronglyEqual(u.seq2Range.start + c, u.seq2Range.endExclusive + c)); c++)
        ;
      if (c === o) {
        i[s + 1] = new re(new I(u.seq1Range.start + o, a.seq1Range.endExclusive), new I(u.seq2Range.start + o, a.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (u = u.delta(c));
    }
...
function so(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r = i > 0 ? n[i - 1] : void 0, s = n[i], a = i + 1 < n.length ? n[i + 1] : void 0, u = new I(
...
function Ss(e, t, n, i, r) {
  ...
  let o = 0, c = -1;
  for (let m = -a; m <= u; m++) {
    const h = e.seq2Range.start + m, _ = e.seq2Range.endExclusive + m, L = e.seq1Range.start + m, d = t.getBoundaryScore(L) + n.getBoundaryScore(h) + n.getBoundaryScore(_);
    d > c && (c = d, o = m);
  }
  return e.delta(o);
}
...
function Is(e, t, n, i, r = !1) {
  ...
  function o(m, h) {
    ...
    if (!_ || !L)
      return;
    let d = new re(_, L);
    const p = d.intersect(h);
    let x = p.seq1Range.length, y = p.seq2Range.length;
    for (; s.length > 0; ) {
      const R = s[0];
      if (!(R.seq1Range.intersects(d.seq1Range) || R.seq2Range.intersects(d.seq2Range)))
        break;
      const k = i(e, R.seq1Range.start), B = i(t, R.seq2Range.start), X = new re(k, B), E = X.intersect(R);
      if (x += E.seq1Range.length, y += E.seq2Range.length, d = d.join(X), d.seq1Range.endExclusive >= R.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
    (r && x + y < d.seq1Range.length + d.seq2Range.length || x + y < (d.seq1Range.length + d.seq2Range.length) * 2 / 3) && a.push(d), u = d.getEndExclusives();
  }
  for (; s.length > 0; ) {
    const m = s.shift();
...
function uo(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < i.length; u++) {
      let m = function(_, L) {
        const d = new I(c.seq1Range.endExclusive, o.seq1Range.start);
        return e.getText(d).replace(/\s/g, "").length <= 4 && (_.seq1Range.length + _.seq2Range.length > 5 || L.seq1Range.length + L.seq2Range.length > 5);
      };
...
function oo(e, t, n) {
  ...
  do {
    ...
    for (let o = 1; o < i.length; o++) {
      let h = function(L, d) {
        const p = new I(m.seq1Range.endExclusive, c.seq1Range.start);
        if (e.countLinesIn(p) > 5 || p.length > 500)
          return !1;
        const y = e.getText(p).trim();
        if (y.length > 20 || y.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const R = e.countLinesIn(L.seq1Range), v = L.seq1Range.length, k = t.countLinesIn(L.seq2Range), B = L.seq2Range.length, X = e.countLinesIn(d.seq1Range), E = d.seq1Range.length, A = t.countLinesIn(d.seq2Range), U = d.seq2Range.length, W = 130;
        function z(G) {
          return Math.min(G, W);
        }
        return Math.pow(Math.pow(z(R * 40 + v), 1.5) + Math.pow(z(k * 40 + B), 1.5), 1.5) + Math.pow(Math.pow(z(X * 40 + E), 1.5) + Math.pow(z(A * 40 + U), 1.5), 1.5) > (W ** 1.5) ** 1.5 * 1.3;
      };
  ...
  return Ba(i, (u, o, c) => {
    ...
    const _ = e.extendToFullLines(o.seq1Range), L = e.getText(new I(_.start, o.seq1Range.start));
    h(L) && (m = m.deltaStart(-L.length));
    const d = e.getText(new I(o.seq1Range.endExclusive, _.endExclusive));
    h(d) && (m = m.deltaEnd(d.length));
    const p = re.fromOffsetPairs(u ? u.getEndExclusives() : Ye.zero, c ? c.getStarts() : Ye.max), x = m.intersect(p);
...
class co {
  constructor() {
    this.dynamicProgrammingDiffing = new Qu(), this.myersDiffingAlgorithm = new La();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && Zs(t, n, (E, A) => E === A))
      return new _n([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new _n([
        new qe(new J(1, t.length + 1), new J(1, n.length + 1), [
          new Le(new D(
            1,
            1,
            t.length,
    ...
    const r = i.maxComputationTimeMs === 0 ? nn.instance : new Yu(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function u(E) {
      let A = a.get(E);
      return A === void 0 && (A = a.size, a.set(E, A)), A;
    }
    const o = t.map((E) => u(E.trim())), c = n.map((E) => u(E.trim())), m = new Ps(o, t), h = new Ps(c, n), _ = m.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(m, h, r, (E, A) => t[E] === n[A] ? n[A].length === 0 ? 0.1 : 1 + Math.log(1 + n[A].length) : 0.99) : this.myersDiffingAlgorithm.compute(m, h, r);
    let L = _.diffs, d = _.hitTimeout;
    L = ks(m, h, L), L = uo(m, h, L);
    const p = [], x = (E) => {
      if (s)
        for (let A = 0; A < E; A++) {
          const U = y + A, W = R + A;
          if (t[U] !== n[W]) {
            const z = this.refineDiff(t, n, new re(new I(U, U + 1), new I(W, W + 1)), r, s, i);
            for (const G of z.mappings)
              p.push(G);
            z.hitTimeout && (d = !0);
          }
        }
    ...
    let y = 0, R = 0;
    for (const E of L) {
      Qt(() => E.seq1Range.start - y === E.seq2Range.start - R);
      const A = E.seq1Range.start - y;
      x(A), y = E.seq1Range.endExclusive, R = E.seq2Range.endExclusive;
      const U = this.refineDiff(t, n, E, r, s, i);
      U.hitTimeout && (d = !0);
    ...
    let X = [];
    return i.computeMoves && (X = this.computeMoves(B, t, n, o, c, r, s, i)), Qt(() => {
      function E(U, W) {
        if (U.lineNumber < 1 || U.lineNumber > W.length)
          return !1;
        const z = W[U.lineNumber - 1];
        return !(U.column < 1 || U.column > z.length + 1);
      }
      function A(U, W) {
      ...
      for (const U of B) {
        ...
        for (const W of U.innerChanges)
          if (!(E(W.modifiedRange.getStartPosition(), n) && E(W.modifiedRange.getEndPosition(), n) && E(W.originalRange.getStartPosition(), t) && E(W.originalRange.getEndPosition(), t)))
            return !1;
  ...
  refineDiff(t, n, i, r, s, a) {
    const o = mo(i).toRangeMapping2(t, n), c = new Tn(t, o.originalRange, s), m = new Tn(n, o.modifiedRange, s), h = c.length + m.length < 500 ? this.dynamicProgrammingDiffing.compute(c, m, r) : this.myersDiffingAlgorithm.compute(c, m, r);
    let _ = h.diffs;
    return _ = ks(c, m, _), _ = Is(c, m, _, (d, p) => d.findWordContaining(p)), a.extendToSubwords && (_ = Is(c, m, _, (d, p) => d.findSubWordContaining(p), !0)), _ = ao(c, m, _), _ = oo(c, m, _), {
      mappings: _.map((d) => new Le(c.translateRange(d.seq1Range), m.translateRange(d.seq2Range))),
...
class Te {
  ...
  static toRGBA(t) {
    ...
    return new b(Math.round(a * 255), Math.round(u * 255), Math.round(o * 255), s);
  }
}
class Lt {
  constructor(t, n, i, r) {
  ...
  static fromRGBA(t) {
    ...
    let c;
    return u === 0 ? c = 0 : s === n ? c = ((i - r) / u % 6 + 6) % 6 : s === i ? c = (r - n) / u + 2 : c = (n - i) / u + 4, new Lt(Math.round(c * 60), o, s, t.a);
  }
  static toRGBA(t) {
    const { h: n, s: i, v: r, a: s } = t, a = r * i, u = a * (1 - Math.abs(n / 60 % 2 - 1)), o = r - a;
    let [c, m, h] = [0, 0, 0];
    return n < 60 ? (c = a, m = u) : n < 120 ? (c = u, m = a) : n < 180 ? (m = a, h = u) : n < 240 ? (m = u, h = a) : n < 300 ? (c = u, h = a) : n <= 360 && (c = a, h = u), c = Math.round((c + o) * 255), m = Math.round((m + o) * 255), h = Math.round((h + o) * 255), new b(c, m, h, s);
  }
}
const Q = class Q {
  static fromHex(t) {
  ...
  equals(t) {
    return !!t && b.equals(this.rgba, t.rgba) && Te.equals(this.hsla, t.hsla) && Lt.equals(this.hsva, t.hsva);
  }
  ...
  reduceRelativeLuminace(t, n) {
    ...
    for (; a < n && (i > 0 || r > 0 || s > 0); )
      i -= Math.max(0, Math.ceil(i * 0.1)), r -= Math.max(0, Math.ceil(r * 0.1)), s -= Math.max(0, Math.ceil(s * 0.1)), a = this.getContrastRatio(new Q(new b(i, r, s)));
    return new Q(new b(i, r, s));
  }
  increaseRelativeLuminace(t, n) {
    let { r: i, g: r, b: s } = t.rgba, a = this.getContrastRatio(t);
    for (; a < n && (i < 255 || r < 255 || s < 255); )
      i = Math.min(255, i + Math.ceil((255 - i) * 0.1)), r = Math.min(255, r + Math.ceil((255 - r) * 0.1)), s = Math.min(255, s + Math.ceil((255 - s) * 0.1)), a = this.getContrastRatio(new Q(new b(i, r, s)));
    return new Q(new b(i, r, s));
  }
  ...
  opposite() {
    return new Q(new b(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  blend(t) {
...
Q.white = new Q(new b(255, 255, 255, 1)), Q.black = new Q(new b(0, 0, 0, 1)), Q.red = new Q(new b(255, 0, 0, 1)), Q.blue = new Q(new b(0, 0, 255, 1)), Q.green = new Q(new b(0, 255, 0, 1)), Q.cyan = new Q(new b(0, 255, 255, 1)), Q.lightgrey = new Q(new b(211, 211, 211, 1)), Q.transparent = new Q(new b(0, 0, 0, 0));
let Pt = Q;
(function(e) {
  (function(t) {
    (function(n) {
      ...
      n.formatHex = o;
      function c(p, x = !1) {
        return x && p.rgba.a === 1 ? e.Format.CSS.formatHex(p) : `#${u(p.rgba.r)}${u(p.rgba.g)}${u(p.rgba.b)}${u(Math.round(p.rgba.a * 255))}`;
      }
      n.formatHexA = c;
      function m(p) {
      ...
      function h(p) {
        ...
        if (p.startsWith("rgba(")) {
          const x = p.match(/rgba\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+), *(?<a>(?:\+|-)?\d+(\.\d+)?)\)/);
          if (!x)
            throw new Error("Invalid color format " + p);
          const y = parseInt(x.groups?.r ?? "0"), R = parseInt(x.groups?.g ?? "0"), v = parseInt(x.groups?.b ?? "0"), k = parseFloat(x.groups?.a ?? "0");
          return new e(new b(y, R, v, k));
        }
        if (p.startsWith("rgb(")) {
          const x = p.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!x)
            throw new Error("Invalid color format " + p);
          const y = parseInt(x.groups?.r ?? "0"), R = parseInt(x.groups?.g ?? "0"), v = parseInt(x.groups?.b ?? "0");
          return new e(new b(y, R, v));
        }
        return _(p);
      }
      n.parse = h;
      function _(p) {
        switch (p) {
          case "aliceblue":
            return new e(new b(240, 248, 255, 1));
          case "antiquewhite":
            return new e(new b(250, 235, 215, 1));
          case "aqua":
            return new e(new b(0, 255, 255, 1));
          case "aquamarine":
            return new e(new b(127, 255, 212, 1));
          case "azure":
            return new e(new b(240, 255, 255, 1));
          case "beige":
            return new e(new b(245, 245, 220, 1));
          case "bisque":
            return new e(new b(255, 228, 196, 1));
          case "black":
            return new e(new b(0, 0, 0, 1));
          case "blanchedalmond":
            return new e(new b(255, 235, 205, 1));
          case "blue":
            return new e(new b(0, 0, 255, 1));
          case "blueviolet":
            return new e(new b(138, 43, 226, 1));
          case "brown":
            return new e(new b(165, 42, 42, 1));
          case "burlywood":
            return new e(new b(222, 184, 135, 1));
          case "cadetblue":
            return new e(new b(95, 158, 160, 1));
          case "chartreuse":
            return new e(new b(127, 255, 0, 1));
          case "chocolate":
            return new e(new b(210, 105, 30, 1));
          case "coral":
            return new e(new b(255, 127, 80, 1));
          case "cornflowerblue":
            return new e(new b(100, 149, 237, 1));
          case "cornsilk":
            return new e(new b(255, 248, 220, 1));
          case "crimson":
            return new e(new b(220, 20, 60, 1));
          case "cyan":
            return new e(new b(0, 255, 255, 1));
          case "darkblue":
            return new e(new b(0, 0, 139, 1));
          case "darkcyan":
            return new e(new b(0, 139, 139, 1));
          case "darkgoldenrod":
            return new e(new b(184, 134, 11, 1));
          case "darkgray":
            return new e(new b(169, 169, 169, 1));
          case "darkgreen":
            return new e(new b(0, 100, 0, 1));
          case "darkgrey":
            return new e(new b(169, 169, 169, 1));
          case "darkkhaki":
            return new e(new b(189, 183, 107, 1));
          case "darkmagenta":
            return new e(new b(139, 0, 139, 1));
          case "darkolivegreen":
            return new e(new b(85, 107, 47, 1));
          case "darkorange":
            return new e(new b(255, 140, 0, 1));
          case "darkorchid":
            return new e(new b(153, 50, 204, 1));
          case "darkred":
            return new e(new b(139, 0, 0, 1));
          case "darksalmon":
            return new e(new b(233, 150, 122, 1));
          case "darkseagreen":
            return new e(new b(143, 188, 143, 1));
          case "darkslateblue":
            return new e(new b(72, 61, 139, 1));
          case "darkslategray":
            return new e(new b(47, 79, 79, 1));
          case "darkslategrey":
            return new e(new b(47, 79, 79, 1));
          case "darkturquoise":
            return new e(new b(0, 206, 209, 1));
          case "darkviolet":
            return new e(new b(148, 0, 211, 1));
          case "deeppink":
            return new e(new b(255, 20, 147, 1));
          case "deepskyblue":
            return new e(new b(0, 191, 255, 1));
          case "dimgray":
            return new e(new b(105, 105, 105, 1));
          case "dimgrey":
            return new e(new b(105, 105, 105, 1));
          case "dodgerblue":
            return new e(new b(30, 144, 255, 1));
          case "firebrick":
            return new e(new b(178, 34, 34, 1));
          case "floralwhite":
            return new e(new b(255, 250, 240, 1));
          case "forestgreen":
            return new e(new b(34, 139, 34, 1));
          case "fuchsia":
            return new e(new b(255, 0, 255, 1));
          case "gainsboro":
            return new e(new b(220, 220, 220, 1));
          case "ghostwhite":
            return new e(new b(248, 248, 255, 1));
          case "gold":
            return new e(new b(255, 215, 0, 1));
          case "goldenrod":
            return new e(new b(218, 165, 32, 1));
          case "gray":
            return new e(new b(128, 128, 128, 1));
          case "green":
            return new e(new b(0, 128, 0, 1));
          case "greenyellow":
            return new e(new b(173, 255, 47, 1));
          case "grey":
            return new e(new b(128, 128, 128, 1));
          case "honeydew":
            return new e(new b(240, 255, 240, 1));
          case "hotpink":
            return new e(new b(255, 105, 180, 1));
          case "indianred":
            return new e(new b(205, 92, 92, 1));
          case "indigo":
            return new e(new b(75, 0, 130, 1));
          case "ivory":
            return new e(new b(255, 255, 240, 1));
          case "khaki":
            return new e(new b(240, 230, 140, 1));
          case "lavender":
            return new e(new b(230, 230, 250, 1));
          case "lavenderblush":
            return new e(new b(255, 240, 245, 1));
          case "lawngreen":
            return new e(new b(124, 252, 0, 1));
          case "lemonchiffon":
            return new e(new b(255, 250, 205, 1));
          case "lightblue":
            return new e(new b(173, 216, 230, 1));
          case "lightcoral":
            return new e(new b(240, 128, 128, 1));
          case "lightcyan":
            return new e(new b(224, 255, 255, 1));
          case "lightgoldenrodyellow":
            return new e(new b(250, 250, 210, 1));
          case "lightgray":
            return new e(new b(211, 211, 211, 1));
          case "lightgreen":
            return new e(new b(144, 238, 144, 1));
          case "lightgrey":
            return new e(new b(211, 211, 211, 1));
          case "lightpink":
            return new e(new b(255, 182, 193, 1));
          case "lightsalmon":
            return new e(new b(255, 160, 122, 1));
          case "lightseagreen":
            return new e(new b(32, 178, 170, 1));
          case "lightskyblue":
            return new e(new b(135, 206, 250, 1));
          case "lightslategray":
            return new e(new b(119, 136, 153, 1));
          case "lightslategrey":
            return new e(new b(119, 136, 153, 1));
          case "lightsteelblue":
            return new e(new b(176, 196, 222, 1));
          case "lightyellow":
            return new e(new b(255, 255, 224, 1));
          case "lime":
            return new e(new b(0, 255, 0, 1));
          case "limegreen":
            return new e(new b(50, 205, 50, 1));
          case "linen":
            return new e(new b(250, 240, 230, 1));
          case "magenta":
            return new e(new b(255, 0, 255, 1));
          case "maroon":
            return new e(new b(128, 0, 0, 1));
          case "mediumaquamarine":
            return new e(new b(102, 205, 170, 1));
          case "mediumblue":
            return new e(new b(0, 0, 205, 1));
          case "mediumorchid":
            return new e(new b(186, 85, 211, 1));
          case "mediumpurple":
            return new e(new b(147, 112, 219, 1));
          case "mediumseagreen":
            return new e(new b(60, 179, 113, 1));
          case "mediumslateblue":
            return new e(new b(123, 104, 238, 1));
          case "mediumspringgreen":
            return new e(new b(0, 250, 154, 1));
          case "mediumturquoise":
            return new e(new b(72, 209, 204, 1));
          case "mediumvioletred":
            return new e(new b(199, 21, 133, 1));
          case "midnightblue":
            return new e(new b(25, 25, 112, 1));
          case "mintcream":
            return new e(new b(245, 255, 250, 1));
          case "mistyrose":
            return new e(new b(255, 228, 225, 1));
          case "moccasin":
            return new e(new b(255, 228, 181, 1));
          case "navajowhite":
            return new e(new b(255, 222, 173, 1));
          case "navy":
            return new e(new b(0, 0, 128, 1));
          case "oldlace":
            return new e(new b(253, 245, 230, 1));
          case "olive":
            return new e(new b(128, 128, 0, 1));
          case "olivedrab":
            return new e(new b(107, 142, 35, 1));
          case "orange":
            return new e(new b(255, 165, 0, 1));
          case "orangered":
            return new e(new b(255, 69, 0, 1));
          case "orchid":
            return new e(new b(218, 112, 214, 1));
          case "palegoldenrod":
            return new e(new b(238, 232, 170, 1));
          case "palegreen":
            return new e(new b(152, 251, 152, 1));
          case "paleturquoise":
            return new e(new b(175, 238, 238, 1));
          case "palevioletred":
            return new e(new b(219, 112, 147, 1));
          case "papayawhip":
            return new e(new b(255, 239, 213, 1));
          case "peachpuff":
            return new e(new b(255, 218, 185, 1));
          case "peru":
            return new e(new b(205, 133, 63, 1));
          case "pink":
            return new e(new b(255, 192, 203, 1));
          case "plum":
            return new e(new b(221, 160, 221, 1));
          case "powderblue":
            return new e(new b(176, 224, 230, 1));
          case "purple":
            return new e(new b(128, 0, 128, 1));
          case "rebeccapurple":
            return new e(new b(102, 51, 153, 1));
          case "red":
            return new e(new b(255, 0, 0, 1));
          case "rosybrown":
            return new e(new b(188, 143, 143, 1));
          case "royalblue":
            return new e(new b(65, 105, 225, 1));
          case "saddlebrown":
            return new e(new b(139, 69, 19, 1));
          case "salmon":
            return new e(new b(250, 128, 114, 1));
          case "sandybrown":
            return new e(new b(244, 164, 96, 1));
          case "seagreen":
            return new e(new b(46, 139, 87, 1));
          case "seashell":
            return new e(new b(255, 245, 238, 1));
          case "sienna":
            return new e(new b(160, 82, 45, 1));
          case "silver":
            return new e(new b(192, 192, 192, 1));
          case "skyblue":
            return new e(new b(135, 206, 235, 1));
          case "slateblue":
            return new e(new b(106, 90, 205, 1));
          case "slategray":
            return new e(new b(112, 128, 144, 1));
          case "slategrey":
            return new e(new b(112, 128, 144, 1));
          case "snow":
            return new e(new b(255, 250, 250, 1));
          case "springgreen":
            return new e(new b(0, 255, 127, 1));
          case "steelblue":
            return new e(new b(70, 130, 180, 1));
          case "tan":
            return new e(new b(210, 180, 140, 1));
          case "teal":
            return new e(new b(0, 128, 128, 1));
          case "thistle":
            return new e(new b(216, 191, 216, 1));
          case "tomato":
            return new e(new b(255, 99, 71, 1));
          case "turquoise":
            return new e(new b(64, 224, 208, 1));
          case "violet":
            return new e(new b(238, 130, 238, 1));
          case "wheat":
            return new e(new b(245, 222, 179, 1));
          case "white":
            return new e(new b(255, 255, 255, 1));
          case "whitesmoke":
            return new e(new b(245, 245, 245, 1));
          case "yellow":
            return new e(new b(255, 255, 0, 1));
          case "yellowgreen":
            return new e(new b(154, 205, 50, 1));
          default:
            return null;
        }
      }
      function L(p) {
        const x = p.length;
        if (x === 0 || p.charCodeAt(0) !== w.Hash)
          return null;
        if (x === 7) {
          const y = 16 * d(p.charCodeAt(1)) + d(p.charCodeAt(2)), R = 16 * d(p.charCodeAt(3)) + d(p.charCodeAt(4)), v = 16 * d(p.charCodeAt(5)) + d(p.charCodeAt(6));
          return new e(new b(y, R, v, 1));
        }
        if (x === 9) {
          const y = 16 * d(p.charCodeAt(1)) + d(p.charCodeAt(2)), R = 16 * d(p.charCodeAt(3)) + d(p.charCodeAt(4)), v = 16 * d(p.charCodeAt(5)) + d(p.charCodeAt(6)), k = 16 * d(p.charCodeAt(7)) + d(p.charCodeAt(8));
          return new e(new b(y, R, v, k / 255));
        }
        if (x === 4) {
          const y = d(p.charCodeAt(1)), R = d(p.charCodeAt(2)), v = d(p.charCodeAt(3));
          return new e(new b(16 * y + y, 16 * R + R, 16 * v + v));
        }
        if (x === 5) {
          const y = d(p.charCodeAt(1)), R = d(p.charCodeAt(2)), v = d(p.charCodeAt(3)), k = d(p.charCodeAt(4));
          return new e(new b(16 * y + y, 16 * R + R, 16 * v + v, (16 * k + k) / 255));
        }
        return null;
      }
      n.parseHex = L;
...
function ho(e, t) {
  if (!e)
    return;
  const n = Pt.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function Vs(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Na(r), a = new Pt(new Te(
    s[0],
    s[1] / 100,
    s[2] / 100,
    n ? s[3] : 1
...
function Lo(e, t) {
  ...
  if (!t.markSectionHeaderRegex || t.markSectionHeaderRegex.trim() === "")
    return n;
  const r = Uu(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${r ? "s" : ""}`);
  if (Rl(s))
    return n;
  for (let a = 1; a <= i; a += qs - po) {
...
`);
    ...
    let m;
    for (; (m = s.exec(c)) !== null; ) {
      const h = c.substring(0, m.index), _ = (h.match(/\n/g) || []).length, L = a + _, d = m[0].split(`
`), p = d.length, x = L + p - 1, y = h.lastIndexOf(`
`) + 1, R = m.index - y + 1, v = d[d.length - 1], k = p === 1 ? R + m[0].length : v.length + 1, B = {
        startLineNumber: L,
        startColumn: R,
        endLineNumber: x,
        endColumn: k
      }, X = (m.groups ?? {}).label ?? "", E = ((m.groups ?? {}).separator ?? "") !== "", A = {
        range: B,
        text: X,
        hasSeparatorLine: E,
...
function No(e) {
  ...
  return e = e.replace(_o, ""), { text: e, hasSeparatorLine: t };
}
function Ke(e) {
...
function xo(e) {
  return e.indexOf("/") === -1 && (e = xa(e)), /^[a-zA-Z]:(\/|$)/.test(e) && (e = "/" + e), e;
}
function Hs(e, t = ee.sep) {
  ...
  if (Ke(i)) {
    ...
    return t;
  } else if (Ro(i) && e.charCodeAt(1) === w.Colon)
...
class Ao {
  ...
  setServerRootPath(t, n) {
    this._serverRootPath = ee.join(n ?? "/", yo(t));
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return ee.join(this._serverRootPath, ge.vscodeRemoteResource);
  }
  set(t, n, i) {
  ...
  rewrite(t) {
    ...
    return typeof s == "string" && (a += `&${Eo}=${encodeURIComponent(s)}`), ce.from({
      scheme: gl ? this._preferredWebSchema : ge.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
const To = "vscode-app", vt = class vt {
  constructor() {
  ...
  uriToBrowserUri(t) {
    return t.scheme === ge.vscodeRemote ? vo.rewrite(t) : t.scheme === ge.file && (fl || pl === `${ge.vscodeFileResource}://${vt.FALLBACK_AUTHORITY}`) ? t.with({
      scheme: ge.vscodeFileResource,
      authority: t.authority || vt.FALLBACK_AUTHORITY,
      query: null,
      fragment: null
  ...
  uriToFileUri(t) {
    return t.scheme === ge.vscodeFileResource ? t.with({
      scheme: ge.file,
      authority: t.authority !== vt.FALLBACK_AUTHORITY ? t.authority : null,
      query: null,
      fragment: null
    }) : t;
  }
  toUri(t) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(n))
        return ce.joinPath(ce.parse(n, !0), t);
      const i = hu(n, t);
      return ce.file(i);
    }
    return ce.parse(this.toUrl(t));
  }
...
(function(e) {
  ...
  function i(s) {
    let a;
    typeof s == "string" ? a = new URL(s).searchParams : s instanceof URL ? a = s.searchParams : ce.isUri(s) && (a = new URL(s.toString(!0)).searchParams);
    const u = a?.get(n);
    if (u)
      return t.get(u);
  }
...
class Mo {
  ...
  compare(t, n, i = !1) {
    return t === n ? 0 : vl(this.getComparisonKey(t, i), this.getComparisonKey(n, i));
  }
  isEqual(t, n, i = !1) {
  ...
  isEqualOrParent(t, n, i = !1) {
    if (t.scheme === n.scheme) {
      if (t.scheme === ge.file)
        return Ws($e(t), $e(n), this._ignorePathCasing(t)) && t.query === n.query && (i || t.fragment === n.fragment);
  ...
  joinPath(t, ...n) {
    return ce.joinPath(t, ...n);
  }
  basenameOrAuthority(t) {
    return Uo(t) || t.authority;
  }
  basename(t) {
  ...
  dirname(t) {
    if (t.path.length === 0)
      return t;
    let n;
    return t.scheme === ge.file ? n = ce.file(_u($e(t))).path : (n = ee.dirname(t.path), t.authority && n.length && n.charCodeAt(0) !== w.Slash && (console.error(`dirname("${t.toString})) resulted in a relative path`), n = "/")), t.with({
      path: n
    });
  }
  normalizePath(t) {
    if (!t.path.length)
      return t;
    let n;
    return t.scheme === ge.file ? n = ce.file(mu($e(t))).path : n = ee.normalize(t.path), t.with({
      path: n
    });
  }
  relativePath(t, n) {
  ...
  resolvePath(t, n) {
    if (t.scheme === ge.file) {
      const i = ce.file(fu($e(t), n));
      return t.with({
        authority: i.authority,
        path: i.path
      });
    }
    return n = xo(n), t.with({
  ...
  isEqualAuthority(t, n) {
    return t === n || t !== void 0 && n !== void 0 && Tl(t, n);
  }
...
const $s = Z.isEqualAuthority.bind(Z), zs = Z.hasTrailingPathSeparator.bind(Z);
...
const de = class de {
  ...
  constructor(t, n) {
    this._state = De.Initial, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new ye(), queueMicrotask(async () => {
      const i = {
...
class Fo {
  ...
  onEvents(t) {
    ...
    const n = t.changes;
    for (const i of n)
      this._acceptDeleteRange(i.range), this._acceptInsertText(new $(i.range.startLineNumber, i.range.startColumn), i.text);
...
const So = "workerTextModelSync";
class Io {
  constructor() {
    this._models = /* @__PURE__ */ Object.create(null);
  }
  bindToServer(t) {
    t.setChannel(So, this);
  }
  getModel(t) {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new Po(ce.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class Po extends Fo {
  ...
  findMatches(t) {
    ...
    for (let i = 0; i < this._lines.length; i++) {
      const r = this._lines[i], s = this.offsetAt(new $(i + 1, 1)), a = r.matchAll(t);
      for (const u of a)
  ...
  getWordAtPosition(t, n) {
    const i = wi(t.column, ga(n), this._lines[t.lineNumber - 1], 0);
    return i ? new D(
      t.lineNumber,
      i.startColumn,
      t.lineNumber,
...
class Ra {
  ...
  compose(t) {
    ...
    for (const u of i.replacements) {
      ...
      if (!c)
        ...
        if (_ > 0) {
          const x = c.slice(I.emptyAt(h), new I(0, _));
          s.push(x);
        }
        if (!m)
        ...
        if (L > 0) {
          const x = m.slice(I.ofStartAndLength(m.replaceRange.endExclusive, 0), new I(
            m.getNewLength() - L,
            m.getNewLength()
          ));
          r.unshift(x), a -= x.getNewLength() - x.replaceRange.length;
        }
        const d = new I(h, u.replaceRange.endExclusive - a), p = u.slice(d, new I(0, u.getNewLength()));
        s.push(p);
      }
    }
    for (; ; ) {
  ...
  decomposeSplit(t) {
    ...
    let r = 0;
    for (const s of this.replacements)
      t(s) ? (n.push(s), r += s.getNewLength() - s.replaceRange.length) : i.push(s.slice(s.replaceRange.delta(r), new I(0, s.getNewLength())));
  ...
  getNewRanges() {
    ...
    let n = 0;
    for (const i of this.replacements)
      t.push(I.ofStartAndLength(i.replaceRange.start + n, i.getNewLength())), n += i.getLengthDelta();
    return t;
  }
  ...
  getLengthDelta() {
    return qa(this.replacements, (t) => t.getLengthDelta());
  }
  getNewDataLength(t) {
...
class Bo {
  ...
  delta(t) {
    return this.slice(this.replaceRange.delta(t), new I(0, this.getNewLength()));
  }
  getLengthDelta() {
...
class Ea extends Ra {
  ...
  inverseOnSlice(t) {
    ...
    let i = 0;
    for (const r of this.replacements)
      n.push(le.replace(I.ofStartAndLength(r.replaceRange.start + i, r.newText.length), t(r.replaceRange.start, r.replaceRange.endExclusive))), i += r.newText.length - r.replaceRange.length;
    return new Oe(n);
  }
  inverse(t) {
  ...
  normalizeEOL(t) {
    return new Oe(this.replacements.map((n) => n.normalizeEOL(t)));
  }
  normalizeOnSource(t) {
    const n = this.apply(t), r = le.replace(I.ofLength(t.length), n).removeCommonSuffixAndPrefix(t);
    return r.isEmpty ? Oe.empty : r.toEdit();
  }
  ...
  mapData(t) {
    return new hi(this.replacements.map((n) => new Ve(n.replaceRange, n.newText, t(n))));
  }
}
class Aa extends Bo {
  constructor(t, n) {
  ...
  removeCommonSuffixPrefix(t) {
    const n = t.substring(this.replaceRange.start, this.replaceRange.endExclusive), i = Ln(n, this.newText), r = Math.min(n.length - i, this.newText.length - i, Nn(n, this.newText)), s = new I(
  ...
  removeCommonPrefix(t) {
    ...
    return i === 0 ? this : this.slice(this.replaceRange.deltaStart(i), new I(i, this.newText.length));
  }
  removeCommonSuffix(t) {
    const n = this.replaceRange.substring(t), i = Nn(n, this.newText);
    return i === 0 ? this : this.slice(this.replaceRange.deltaEnd(-i), new I(0, this.newText.length - i));
  }
  toEdit() {
    return new Oe([this]);
  }
...
const we = class we extends Ea {
  ...
  static replace(t, n) {
    return new we([new le(t, n)]);
  }
  static insert(t, n) {
    return new we([new le(I.emptyAt(t), n)]);
  }
  static delete(t) {
    return new we([new le(t, "")]);
  }
  static fromJson(t) {
    return new we(t.map(le.fromJson));
  }
  static compose(t) {
    if (t.length === 0)
      return we.empty;
  ...
  static composeSequentialReplacements(t) {
    ...
    for (const r of t) {
      const s = i.at(-1);
      !s || r.replaceRange.isBefore(s.replaceRange) ? i.push(r) : (n = n.compose(we.create(i.reverse())), i = [r]);
    }
    return n = n.compose(we.create(i.reverse())), n;
  }
  constructor(t) {
    super(t);
  }
...
class le extends Aa {
  ...
  static fromJson(t) {
    return new le(I.ofStartAndLength(t.pos, t.len), t.txt);
  }
  equals(t) {
...
const ke = class ke extends Ea {
  ...
  static replace(t, n, i) {
    return new ke([new Ve(t, n, i)]);
  }
  static insert(t, n, i) {
    return new ke([new Ve(I.emptyAt(t), n, i)]);
  }
  static delete(t, n) {
    return new ke([new Ve(t, "", n)]);
  }
  static compose(t) {
    if (t.length === 0)
      return ke.empty;
  ...
  toStringEdit() {
    return new Oe(this.replacements.map((t) => new le(t.replaceRange, t.newText)));
  }
};
ke.empty = new ke([]);
let hi = ke;
...
const tt = class tt {
  constructor(t = null) {
    this._foreignModule = t, this._workerTextModelSyncServer = new Io();
  }
  dispose() {
  }
  async $ping() {
  ...
  async $computeUnicodeHighlights(t, n, i) {
    ...
    return r ? Ou.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  static computeDiff(t, n, i, r) {
    ...
    function m(h) {
      return h.map(
        (_) => [_.original.startLineNumber, _.original.endLineNumberExclusive, _.modified.startLineNumber, _.modified.endLineNumberExclusive, _.innerChanges?.map((L) => [
  ...
  $computeStringDiff(t, n, i, r) {
    const s = r === "advanced" ? Vt.getDefault() : Vt.getLegacy(), a = new tn(t), u = a.getLines(), o = new tn(n), c = o.getLines(), m = s.computeDiff(u, c, { ignoreTrimWhitespace: !1, maxComputationTimeMs: i.maxComputationTimeMs, computeMoves: !1, extendToSubwords: !1 }), h = qe.toTextEdit(m.changes, o);
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    for (let { range: o, text: c, eol: m } of n) {
      ...
      const _ = zl(h, c, i), L = r.offsetAt(D.lift(o).getStartPosition());
      for (const d of _) {
        const p = r.positionAt(L + d.originalStart), x = r.positionAt(L + d.originalStart + d.originalLength), y = {
  ...
  $computeHumanReadableDiff(t, n, i) {
    ...
    for (let { range: u, text: o, eol: c } of n) {
      ...
      const h = m.split(/\r\n|\n|\r/), _ = o.split(/\r\n|\n|\r/), L = Vt.getDefault().computeDiff(h, _, i), d = D.lift(u).getStartPosition();
      for (const y of L.changes)
        if (y.innerChanges)
          for (const R of y.innerChanges)
            s.push({
              range: D.fromPositions(p(d, R.originalRange.getStartPosition()), p(d, R.originalRange.getEndPosition())),
              text: x(_, R.modifiedRange).join(r.eol)
            });
        else
